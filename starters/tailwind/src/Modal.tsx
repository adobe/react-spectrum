  ...
  return (
    ...
    `}>
      <RACModal
        {...props}
        className={({ isEntering, isExiting }) => `
        w-full max-w-md max-h-full overflow-auto rounded-2xl bg-white dark:bg-zinc-800/90 dark:backdrop-blur-2xl dark:backdrop-saturate-200 forced-colors:!bg-[Canvas] p-6 text-left align-middle text-slate-700 dark:text-zinc-300 shadow-2xl bg-clip-padding border border-black/10 dark:border-white/10
