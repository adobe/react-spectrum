  ...
  return (
    ...
    `}>
      <RACModal
        {...props}
        className={({ isEntering, isExiting }) => `
        w-full max-w-md max-h-full overflow-auto rounded-2xl bg-white dark:bg-zinc-800/90 backdrop-blur-2xl backdrop-saturate-200 p-6 text-left align-middle text-slate-700 dark:text-zinc-300 shadow-2xl ring-1 ring-black/10 dark:ring-white/10
