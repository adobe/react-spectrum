...
const patterns = [
  ...
  [/^--spectrum-((?:gray|red|orange|yellow|chartreuse|celery|green|seafoam|cyan|blue|indigo|purple|fuchsia|magenta)-.*)$/, 'ColorValueV6'],
  [/^--spectrum-semantic-(.*?)-color-default$/, 'SemanticColorValue', false],
  [/^--spectrum-semantic-(.*?)-color-border$/, 'BorderColorAlias', false],
  [/^--spectrum-alias-border-color-(.*)$/, 'BorderColorAlias', false],
  [/^--spectrum-alias-background-color-(?!.*overlay|quickactions)(.*)$/, 'BackgroundColorAlias', false],
...
const baseTypes = {
  ...
  ColorValue: ['SemanticColorValue'],
  ColorValueV6: ['SemanticColorValue'],
  BorderColorValue: ['BorderColorAlias', 'ColorValue'],
  BorderColorValueV6: ['BorderColorAlias', 'ColorValueV6'],
  BackgroundColorValue: ['BackgroundColorAlias', 'ColorValue'],
  BackgroundColorValueV6: ['BackgroundColorAlias', 'ColorValueV6']
};
...
let types = {};
let shouldExport = {};
for (let [pattern, type, exp] of patterns) {
  types[type] = [];
  shouldExport[type] = exp;
}

types.BorderColorValue = [];
types.BorderColorValueV6 = [];
types.BackgroundColorValue = [];
types.BackgroundColorValueV6 = [];
