...
const patterns = [
  ...
  [
    /^--spectrum-((?:gray|red|orange|yellow|chartreuse|celery|green|seafoam|cyan|blue|indigo|purple|fuchsia|magenta)-.*)$/,
    'ColorValueV6'
  ],
  ...
  [
    /^--spectrum-alias-background-color-(?!.*overlay|quickactions)(.*)$/,
