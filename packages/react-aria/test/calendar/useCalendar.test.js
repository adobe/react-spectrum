...
describe('useCalendar', () => {
  ...
  async function testKeyboard(
    ...
    let {getByRole, getByLabelText, getAllByLabelText, unmount} = render(
      <Example defaultValue={defaultValue} autoFocus {...props} />
    );
  ...
  async function testFirstDayOfWeek(
    defaultValue,
    firstDayOfWeek,
    expectedFirstDay,
    locale = 'en-US'
  ...
  async function testPagination(
    ...
    let {getByTestId, getByLabelText, unmount} = render(
      <Example
  ...
  describe('pagination', () => {
    ...
    `(
      'should use visible as default value $Name',
      async ({defaultValue, rangeBefore, rangeAfter, rel, count, visibleDuration}) => {
    ...
    `(
      'should use pageBehavior single $Name',
      async ({
        defaultValue,
        rangeBefore,
        rangeAfter,
    ...
    `(
      'should use visible as default $Name',
      async ({
        defaultValue,
        rangeBefore,
        rangeAfter,
  ...
  describe('firstDayOfWeek', () => {
    ...
    `(
      'should use firstDayOfWeek $Name',
      async ({defaultValue, firstDayOfWeek, expectedFirstDay, locale}) => {
  ...
  describe('custom calendar visible range description', () => {
    ...
    it.each([
      ...
      {
        name: '8th month',
        date: new CalendarDate(calendar, 2023, 8, 14),
        expected: 'September 2023'
      },
      {name: '9th month', date: new CalendarDate(calendar, 2023, 9, 14), expected: 'October 2023'},
      {
        name: '10th month',
        date: new CalendarDate(calendar, 2023, 10, 14),
        expected: 'November 2023'
      },
      {
        name: '11th month',
        date: new CalendarDate(calendar, 2023, 11, 14),
        expected: 'December 2023'
      },
      {name: '12th month', date: new CalendarDate(calendar, 2023, 12, 14), expected: 'January 2024'}
    ])(
      'the $name should be formatted as $expected when there is only one month visible',
      async ({date, expected}) => {
    ...
    it.each([
      {
        ...
        date: new CalendarDate(calendar, 2023, 7, 14),
        expected: 'August to October 2023'
      },
      {
        name: 'multiple months across years',
        visibleDuration: {months: 3},
        date: new CalendarDate(calendar, 2023, 10, 14),
        expected: 'November 2023 to January 2024'
      }
