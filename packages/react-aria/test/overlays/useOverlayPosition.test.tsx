...
describe('useOverlayPosition', function () {
  ...
  it('should not flip in RTL when a user maxHeight fits within the available space (regression guard for the #10176 fix)', function () {
  ...
  describe('menu popover flip regression (#10176)', function () {
    ...
    it('fixes #10176: flips to the top and grows toward the requested maxHeight, once a user maxHeight is set', function () {
