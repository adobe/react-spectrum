...
.group\/item:where([data-rac])[data-hovered] .group-hover\/item\:bg-red {
    --tw-bg-opacity: 1;
    background-color: rgb(255 0 0 / var(--tw-bg-opacity))
}
...
.group\/item:where(:not([data-rac])):hover .group-hover\/item\:bg-red {
    --tw-bg-opacity: 1;
    background-color: rgb(255 0 0 / var(--tw-bg-opacity))
}
...
.group\/item[data-hovered] .group-rac-hover\/item\:bg-red {
    --tw-bg-opacity: 1;
    background-color: rgb(255 0 0 / var(--tw-bg-opacity))
}
