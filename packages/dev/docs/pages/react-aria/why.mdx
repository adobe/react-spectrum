...
You can learn more about the architecture that React Aria is a part of on the [architecture](https://github.com/adobe/react-spectrum/blob/main/rfcs/2019-v3-architecture.md) rfc.
