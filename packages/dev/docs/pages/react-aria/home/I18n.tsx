...
export function I18n() {
  ...
  return (
    <div className="grid items-center justify-items-center max-w-4xl py-10 px-0 md:p-10 lg:p-0 gap-10 lg:gap-0 lg:grid-cols-[auto_1fr_1fr] mt-10 card-shadow rounded-2xl bg-white dark:bg-gray-800 overflow-hidden">
