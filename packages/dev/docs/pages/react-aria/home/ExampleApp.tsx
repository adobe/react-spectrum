...
export function ExampleApp() {
  ...
  return (
    <div className="h-full flex flex-col gap-4 p-4">
      ...
      {!isSmall && <ResizableTableContainer className="flex-1 w-full overflow-auto relative border dark:border-zinc-700 rounded-lg scroll-pt-[2.281rem]" onScroll={onScroll}>
