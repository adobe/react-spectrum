...
<Highlights items={[
  {
    title: 'Accessible',
    description: <>React Aria provides accessibility and behavior according to <a href="https://www.w3.org/WAI/ARIA/apg/" target="_blank">ARIA Authoring Practices</a>, including full screen reader and keyboard navigation support. All components have been tested across a wide variety of screen readers and devices to ensure the best experience possible for all users.</>
  },
  {
    title: 'Adaptive',
