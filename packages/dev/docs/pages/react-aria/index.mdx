...
<Pagination carouselRef={{current: document.getElementById('interactions-carousel')}} className="md:hidden" />
```
...
<Pagination carouselRef={{current: document.getElementById('customizable-carousel')}} className="max-w-3xl lg:hidden" />
```
