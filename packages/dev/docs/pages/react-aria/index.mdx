...
<header className="header-background">
  ...
  <section className="max-w-6xl mx-auto pt-32 px-4 sm:px-8 md:px-20 pb-48 sm:pb-60 rounded-3xl">
    ...
    <div className="flex flex-col md:flex-row items-center gap-4 my-10 justify-center">
      <a href="getting-started.html" className="bg-gradient-to-r from-blue-600 to-indigo-600 border border-blue-700 shadow-[inset_0_1px_0_rgba(255,255,255,0.1)] text-base md:text-lg font-bold text-white px-8 py-3 rounded-full transition focus-ring  dark:outline-white outline-offset-2 active:scale-95">Get Started</a>
...
```
    ...
    <Card className="md:w-80">
      ...
      <CardDescription>All components are extensively tested across <a href="accessibility.html#testing" target="_blank">screen readers and devices</a>. React Aria normalizes and works around many <a href="https://github.com/adobe/react-spectrum/wiki/Tracker-for-External-Browser-Bugs,-Library-Bugs,-and-Features" target="_blank">browser and assistive technology bugs</a> to ensure all users have equal access.</CardDescription>
    </Card>
  </div>
</section>
