...
<Section className="pink-gradient-background">
  <h2><GradientText>Bring your own</GradientText> <span className="bg-clip-text bg-gradient-to-t from-fuchsia-600 to-pink-600">styles</span><GradientText>.</GradientText></h2>
  <p>React Aria does not include any styles by default, allowing you to build custom designs to fit your application or design system using any styling and animation solution. Each component is broken down into individual parts with built-in states, render props, and slots that make styling a breeze.</p>
...
<Section className="red-gradient-background">
  <h2><span className="bg-clip-text bg-gradient-to-b from-pink-600 to-rose-600">Advanced features</span> <GradientText>for ambitious apps.</GradientText></h2>
...
<Section className="cyan-gradient-background">
  <h2><GradientText>High quality</GradientText> <span className="bg-clip-text bg-gradient-to-t from-cyan-600 to-green-600">interactions</span> <GradientText>on all devices.</GradientText></h2>
...
<Section className="blue-gradient-background">
  <h2><span className="bg-clip-text bg-gradient-to-b from-sky-500 to-indigo-600">Accessibility</span> <GradientText>that's truly first-class.</GradientText></h2>
...
<Section className="green-gradient-background">
  <h2><span className="bg-clip-text bg-gradient-to-b from-lime-600 to-green-600">Customizable</span> <GradientText>to the max.</GradientText></h2>
