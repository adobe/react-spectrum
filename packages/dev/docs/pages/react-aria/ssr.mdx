...
1. Configure React Aria's build plugin for your framework to exclude all translation strings from the JavaScript bundle at build time.
2. Render React Aria's `LocalizedStringProvider` component in the root component of your app. This includes the strings for the user's language on the page.
