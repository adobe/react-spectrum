...
this logic to be reused across different platforms, e.g. in react-native.
...
The [source code](https://github.com/adobe-private/react-spectrum-v3/tree/master/packages/%40react-spectrum) is a good
