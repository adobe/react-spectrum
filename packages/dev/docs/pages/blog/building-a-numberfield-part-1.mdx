...
import arabicNumberFormatting from 'url:../assets/arabic-number-formatting.mov';
...
<Video src={pinyinIMEentering} loop autoPlay muted />

## Problems with input type number

Formatting controls for numbers are limited when it comes to large number in JavaScript. 

<Video src={arabicNumberFormatting} loop autoPlay muted />
...
In the [next part](building-a-numberfield-part-2.html) of this series, we’ll cover how React Spectrum NumberField handles numbering systems.
