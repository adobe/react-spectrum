...
!\[Iphone screenshot of example NumberField inputMode="decimal"\](https://reactspectrum.blob.core.windows.net/reactspectrum/16529877724cc1fb16d953783f10bca8301ea2a7/docs/NumberField_Iphone_positive.d4719bae.png)


iOS does not include a minus key but can include the decimal with inputMode="decimal"

!\[Iphone screenshot of example NumberField inputMode="numeric"\](https://reactspectrum.blob.core.windows.net/reactspectrum/16529877724cc1fb16d953783f10bca8301ea2a7/docs/NumberField_Iphone_integer.9e07ab3f.png)


iOS keyboard only has numbers with inputMode="numeric"

!\[Iphone screenshot of example NumberField inputMode="text"\](https://reactspectrum.blob.core.windows.net/reactspectrum/16529877724cc1fb16d953783f10bca8301ea2a7/docs/NumberField_Iphone_default.c74d24c2.png)


iOS only has a minus key in the full keyboard inputMode="text"

!\[Android screenshot of example NumberField inputMode="decimal"\](https://reactspectrum.blob.core.windows.net/reactspectrum/16529877724cc1fb16d953783f10bca8301ea2a7/docs/NumberField_Android_positive.1dba2e41.jpg)


Android does not include a negative sign with inputMode="decimal"

!\[Android screenshot of example NumberField inputMode="numeric"\](https://reactspectrum.blob.core.windows.net/reactspectrum/16529877724cc1fb16d953783f10bca8301ea2a7/docs/NumberField_Android_integer.7c3c8c2c.jpg)
...
----------
Internationalization is an especially important feature for components like number field. ****** Users around the world expect to enter numbers using their local numbering system and formats, so we ,.need work!!;******

**Numeral systems vs locales**

A locale represents a set of preferences for users in a particular part of the world, such as the language, currency, and number format. For example, in the en-US locale, the default language is English, and the currency symbol is “$”. A numeral system is a way of representing numbers using written characters. For example, in the Latin numeral system, the number twelve is represented as “12”, and in the Han decimal system, it is “一 二”.
