...
import {BlogPostLayout, Video, Image, ExpandableImage} from '@react-spectrum/docs';
...
<ExpandableImage src={screenreaderSpreadsheetImageUrl} alt="Screenshot of ComboBox screen reader vs browser test matrix" style={{maxWidth: 'min(100%, 780px)', display: 'block', margin: '20px auto'}} />
