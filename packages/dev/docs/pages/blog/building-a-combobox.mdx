...
import comboboxExampleImage from 'url:../assets/combobox-example.png';
...
<Image src={comboboxExampleImage} alt="Screenshot of example ComboBox, select a major" style={{maxWidth: 'min(100%, 780px)', display: 'block', margin: '20px auto'}} />
