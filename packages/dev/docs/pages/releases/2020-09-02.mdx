...
We have some exciting changes in this release. First of all, we now have nightly builds! Thanks to @mischnic, we now release our packages whenever we merge to main under a “nightly” tag. This means you don’t have to wait for our normal release cycle to get a preview of what we are up to.

In this release we also worked on adding support for SSR. This has been an ask from a number of people who are using react-spectrum with popular frameworks such as [Gatsby](https://www.gatsbyjs.com) and [Next.js](https://nextjs.org). For more details on SSR, check out our guides for [react-spectrum](https://react-spectrum.adobe.com/react-spectrum/ssr.html) and [react-aria](https://react-spectrum.adobe.com/react-aria/ssr.html). As always, a huge thank you to all our contributors for the new features, fixes and updates.
...
- `Slider` only fires when value changes - [@xitter](https://github.com/xitter) - [PR](https://github.com/adobe/react-spectrum/pull/999)
