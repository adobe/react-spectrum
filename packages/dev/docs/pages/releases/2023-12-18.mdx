...
In a big year, there are a few accomplishments we wanted to highlight.
 ...
 - React Spectrum new components, DropZone, InlineAlert, TagGroup, ActionBar, Avatar, Table Column Resizing
...
We've also added a new package and starter project to help people get started with RAC. The starter project can be found here /* INSERT LINK HERE */. And we have a new package with a starter theme as based on our docs examples `@react-aria/example-theme`.
