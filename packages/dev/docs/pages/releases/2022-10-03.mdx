...
We have been busy this month with new components and plenty of Drag and Drop updates. This release comes some changes to our existing dnd hooks as well as introducing a new set of higher level drag and drop hooks to make building common experiences even easier. See our [update]() on Drag and Drop below. Our new components are Badge and our new LabeledValue.
