...
We have been busy this month with new components and plenty of drag and drop updates. This release we moved drag and drop to RC which comes  with some changes to our API as well as introducing a new set of higher level drag and drop hooks to make building common experiences even easier. See our [update](#drag-and-drop-updates) on drag and drop below for more information. Our new components are [Badge](https://react-spectrum.adobe.com/react-spectrum/Badge.html) and [LabeledValue](https://react-spectrum.adobe.com/react-spectrum/LabeledValue.html). Badges are handy for showing a small amount of color-categorized metadata and LabeledValue is for displaying a non-editable values with a label such as a properties panel. It also formats numbers, dates, times, and lists according to the user's locale.


## New Components
  Badge
    - `@react-spectrum/badge` - [Docs](https://react-spectrum.adobe.com/react-spectrum/Badge.html)

  LabeledValue
    - `@react-spectrum/labeledvalue` - [Docs](https://react-spectrum.adobe.com/react-spectrum/LabeledValue.html)
...
Check out the new drag and drop documentation for [React Spectrum](https://react-spectrum.adobe.com/react-spectrum/dnd.html) and [React Aria](https://react-spectrum.adobe.com/react-aria/dnd.html) to learn more.
...
* TS Strictmode Textfield and batch of easy components  - [@snowystinger](https://github.com/snowystinger) - [PR](https://github.com/adobe/react-spectrum/pull/3411)
* TS strictmode ActionGroup and ActionBar - [@snowystinger](https://github.com/snowystinger) - [PR](https://github.com/adobe/react-spectrum/pull/3416)
* TS Strictmode color - [@snowystinger](https://github.com/snowystinger) - [PR](https://github.com/adobe/react-spectrum/pull/3417)
* Fix dragging in Android Talkback - [@devongovett](https://github.com/devongovett) - [PR](https://github.com/adobe/react-spectrum/pull/3491)
...
* New overlay hooks - [@devongovett](https://github.com/devongovett) - [PR](https://github.com/adobe/react-spectrum/pull/3561)
* Properly hide invalid drop targets in reorderable only ListViews - [@LFDanLu](https://github.com/LFDanLu) - [PR](https://github.com/adobe/react-spectrum/pull/3565)
* Don't disable ContextualHelp if Field is disabled - [@reidbarber](https://github.com/reidbarber) - [PR](https://github.com/adobe/react-spectrum/pull/3562)
* Types audit for release - [@snowystinger](https://github.com/snowystinger) - [PR](https://github.com/adobe/react-spectrum/pull/3563)
* Revert "DnD: Focus initial drop target when using iOS VO (#3283)" - [@devongovett](https://github.com/devongovett) - [PR](https://github.com/adobe/react-spectrum/pull/3570)
* Prevent scrolling while popovers are open - [@reidbarber](https://github.com/reidbarber) - [PR](https://github.com/adobe/react-spectrum/pull/3475)
* Fixing directory drop for docs low level DnD api example - [@LFDanLu](https://github.com/LFDanLu) - [PR](https://github.com/adobe/react-spectrum/pull/3582)
* Revert "Prevent scrolling while popovers are open (#3475)" - [@devongovett](https://github.com/devongovett) - [PR](https://github.com/adobe/react-spectrum/pull/3583)
