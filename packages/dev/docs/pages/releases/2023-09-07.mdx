...
- Updates to the documentation of every component:
    ...
    - The “Advanced Customization” section has been updated to the public contexts provided and consumed by each component, and how you can use these to create your own higher level patterns.
...
- Remove erroneous accessibility color contrast ignore rule - [@LFDanLu](https://github.com/LFDanLu) - [PR](https://github.com/adobe/react-spectrum/pull/5029)
...
- [Unavailable Menu Items](https://react-spectrum.adobe.com/react-spectrum/Menu.html#unavailable-items) (alpha)
