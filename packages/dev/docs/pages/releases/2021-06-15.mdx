...
---
description: Today we're excited to announce the stable release of Tabs! ActionGroup now has support for collapsing behavior and a new staticColor prop has been added to ActionGroup, ActionButton, and ToggleButton for over displaying over colored backgrounds. We also have support for responsive breakpoints and CSS functions in our style props plus plenty of bug fixes and documentation updates.
date: 2021-06-15
---

# June 15, 2021 Release

Today we're excited to announce the stable release of Tabs! [React Aria](https://react-spectrum.adobe.com/react-aria/useTabList.html) includes hooks for you to build your own tabs that are fully accessible and keyboard friendly, and [React Spectrum](https://react-spectrum.adobe.com/react-spectrum/Tabs.html) includes some advanced behaviors like automatic collapsing when screen space is limited.

Also in this release, React Spectrum's ActionGroup component has gained support for collapsing items that do not fit in the available space. In addition, the text labels of the buttons within an ActionGroup can now be hidden, and automatically displayed in a tooltip. See our [documentation](https://react-spectrum.adobe.com/react-spectrum/ActionGroup.html#collapsing-behavior) for more details about this behavior.
...
Finally, thanks to [@so99ynoodles](https://github.com/so99ynoodles) and [@](https://github.com/tomsontom)[tomsontom](https://github.com/tomsontom), React Spectrum's style props have been upgraded, including support for responsive breakpoints and CSS functions like `calc()`.

Thank you to all our contributors for their support!

## New component
- **Tabs**
    - `@react-``spectrum``/``tabs` - [Docs](https://react-spectrum.adobe.com/react-spectrum/Tabs.html)
    - `@react-aria/``tabs` - [Docs](https://react-spectrum.adobe.com/react-aria/useTabList.html)
    - `@react-stately/``tabs` - [Docs](https://react-spectrum.adobe.com/react-stately/useTabListState.html)

## New features
- Add support for responsive style props - [@so99ynoodles](https://github.com/so99ynoodles) - [PR](https://github.com/adobe/react-spectrum/pull/1684) - [Docs](https://react-spectrum.adobe.com/react-spectrum/layout.html#responsive-layout)
- Add support for CSS functions (e.g. `calc()`) in style props - [@](https://github.com/tomsontom)[tomsontom](https://github.com/tomsontom) - [PR](https://github.com/adobe/react-spectrum/pull/1774) - [Docs](https://react-spectrum.adobe.com/react-spectrum/styling.html#css-functions)
- Add collapse behavior to ActionGroup - [@](https://github.com/devongovett)[devongovett](https://github.com/devongovett) - [PR](https://github.com/adobe/react-spectrum/pull/1919) - [Docs](https://react-spectrum.adobe.com/react-spectrum/ActionGroup.html#collapsing-behavior)
- Add `staticColor` option for ActionButton and ToggleButton - [@](https://github.com/devongovett)[devongovett](https://github.com/devongovett) - [PR](https://github.com/adobe/react-spectrum/pull/1881) - [Docs](https://react-spectrum.adobe.com/react-spectrum/ActionButton.html#static-color)
- Support for `left`/`right`/`start`/`end` directions in MenuTrigger - [@](https://github.com/razvanip)[razvanip](https://github.com/razvanip) - [PR](https://github.com/adobe/react-spectrum/pull/1868) - [Docs](https://react-spectrum.adobe.com/react-spectrum/MenuTrigger.html#align-and-direction)
...
- Add screen reader announcements for selection changes in TableView - [@](https://github.com/devongovett)[devongovett](https://github.com/devongovett) - [PR](https://github.com/adobe/react-spectrum/pull/1929)
...
- ActionButton emphasized focus ring is now more visible - [@](https://github.com/devongovett)[devongovett](https://github.com/devongovett) - [PR](https://github.com/adobe/react-spectrum/pull/1881)
...
- Trigger `onHoverEnd` when element becomes disabled in `useHover` - [@](https://github.com/alpinesnow)[alpinesnow](https://github.com/alpinesnow) - [PR](https://github.com/adobe/react-spectrum/pull/1882)
...
- Fix prop passthrough in TabPanel - [@](https://github.com/MarcelReis)[MarcelReis](https://github.com/MarcelReis) - [PR](https://github.com/adobe/react-spectrum/pull/1894)
- Fix behavior of mobile ComboBox - [@](https://github.com/LFDanLu)[LFDanLu](https://github.com/LFDanLu) - [PR](https://github.com/adobe/react-spectrum/pull/1874)
...
- Stop default closing on select in multi-select menus - [@](https://github.com/devongovett)[devongovett](https://github.com/devongovett) - [PR](https://github.com/adobe/react-spectrum/pull/1969)
- Show all items in `ComboBox` when open on mobile - [@](https://github.com/devongovett)[devongovett](https://github.com/devongovett) - [PR](https://github.com/adobe/react-spectrum/pull/1971)
- Always show clear button with `validationState` in `ComboBox` on mobile - [@](https://github.com/devongovett)[devongovett](https://github.com/devongovett) - [PR](https://github.com/adobe/react-spectrum/pull/1972)
...
- Fix keyboard navigation behavior of ActionGroup - [@](https://github.com/devongovett)[devongovett](https://github.com/devongovett) - [PR](https://github.com/adobe/react-spectrum/pull/1991/)
...
- ComboBox rc
  - [React Spectrum](https://react-spectrum.adobe.com/react-stately/useComboBoxState.html)
  - [React Aria](https://react-spectrum.adobe.com/react-aria/useComboBox.html)
  - [React Stately](https://react-spectrum.adobe.com/react-stately/useComboBoxState.html)
- TableView beta
