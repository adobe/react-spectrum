...
[ActionGroup](https://react-spectrum.adobe.com/react-spectrum/ActionGroup.html#static-color), [ActionButton](https://react-spectrum.adobe.com/react-spectrum/ActionButton.html#static-color), and [ToggleButton](https://react-spectrum.adobe.com/react-spectrum/ToggleButton.html#static-color) now also support a `staticColor` prop, which allows these components to be placed over a color background.

Finally, thanks to [@so99ynoodles](https://github.com/so99ynoodles) and [@tomsontom](https://github.com/tomsontom), React Spectrum's style props have been upgraded, including support for [responsive breakpoints](https://react-spectrum.adobe.com/react-spectrum/layout.html#responsive-layout) and [CSS functions](https://react-spectrum.adobe.com/react-spectrum/styling.html#css-functions) like `calc()`.
...
- **Tabs**
  ...
  - `@react-aria-nutrient/tabs` - [Docs](https://react-spectrum.adobe.com/react-aria/useTabList.html)
...
- Add support for CSS functions (e.g. `calc()`) in style props - [@tomsontom](https://github.com/tomsontom) - [PR](https://github.com/adobe/react-spectrum/pull/1774) - [Docs](https://react-spectrum.adobe.com/react-spectrum/styling.html#css-functions)
- Add collapse behavior to ActionGroup - [@devongovett](https://github.com/devongovett) - [PR](https://github.com/adobe/react-spectrum/pull/1919) - [Docs](https://react-spectrum.adobe.com/react-spectrum/ActionGroup.html#collapsing-behavior)
- Add `staticColor` option for ActionButton and ToggleButton - [@devongovett](https://github.com/devongovett) - [PR](https://github.com/adobe/react-spectrum/pull/1881) - [Docs](https://react-spectrum.adobe.com/react-spectrum/ActionButton.html#static-color)
- Support for `left`/`right`/`start`/`end` directions in MenuTrigger - [@razvanip](https://github.com/razvanip) - [PR](https://github.com/adobe/react-spectrum/pull/1868) - [Docs](https://react-spectrum.adobe.com/react-spectrum/MenuTrigger.html#align-and-direction)
...
- @react-aria-nutrient/actiongroup => 3.2.0
- @react-aria-nutrient/combobox => 3.0.0-rc.0
- @react-aria-nutrient/dnd => 3.0.0-alpha.2
- @react-aria-nutrient/focus => 3.4.0
- @react-aria-nutrient/grid => 3.0.0-beta.0
- @react-aria-nutrient/interactions => 3.5.0
- @react-aria-nutrient/menu => 3.2.2
- @react-aria-nutrient/overlays => 3.7.0
- @react-aria-nutrient/selection => 3.5.0
- @react-aria-nutrient/table => 3.0.0-beta.0
- @react-aria-nutrient/tabs => 3.0.0
- @react-aria-nutrient/utils => 3.8.1
