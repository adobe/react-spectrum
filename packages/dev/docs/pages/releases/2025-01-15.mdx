{/_ Copyright 2025 Adobe. All rights reserved.
...
Overlay components including `Modal`, `Popover`, and `Tooltip` now support CSS transitions for entry and exit animations, in addition to the existing support for keyframe animations. CSS transitions have the benefit of being _interruptible_. If the user opens and closes an overlay quickly, transitions will smoothly animate from their current position rather than jumping to the ending state of the animation before starting the new one. You can use CSS transitions using the existing `[data-entering]` and `[data-exiting]` states. See our [animation guide](../react-aria/styling.html#animation) for more details.
...
- Misc
  ...
  - Fix `@react-aria-nutrient/optimize-locales-plugin` path resolution on Windows - [@ohansFavour](https://github.com/ohansFavour) - [PR](https://github.com/adobe/react-spectrum/pull/7568)
...
```
 ...
 - @react-aria-nutrient/accordion@3.0.0-alpha.37
 - @react-aria-nutrient/actiongroup@3.7.12
 - @react-aria-nutrient/autocomplete@3.0.0-alpha.37
 - @react-aria-nutrient/breadcrumbs@3.5.20
 - @react-aria-nutrient/button@3.11.1
 - @react-aria-nutrient/calendar@3.7.0
 - @react-aria-nutrient/checkbox@3.15.1
 - @react-aria-nutrient/collections@3.0.0-alpha.7
 - @react-aria-nutrient/color@3.0.3
 - @react-aria-nutrient/combobox@3.11.1
 - @react-aria-nutrient/datepicker@3.13.0
 - @react-aria-nutrient/dialog@3.5.21
 - @react-aria-nutrient/disclosure@3.0.1
 - @react-aria-nutrient/dnd@3.8.1
 - @react-aria-nutrient/focus@3.19.1
 - @react-aria-nutrient/form@3.0.12
 - @react-aria-nutrient/grid@3.11.1
 - @react-aria-nutrient/gridlist@3.10.1
 - @react-aria-nutrient/i18n@3.12.5
 - @react-aria-nutrient/interactions@3.23.0
 - @react-aria-nutrient/label@3.7.14
 - @react-aria-nutrient/landmark@3.0.0-beta.18
 - @react-aria-nutrient/link@3.7.8
 - @react-aria-nutrient/listbox@3.14.0
 - @react-aria-nutrient/menu@3.17.0
 - @react-aria-nutrient/meter@3.4.19
 - @react-aria-nutrient/numberfield@3.11.10
 - @react-aria-nutrient/overlays@3.25.0
 - @react-aria-nutrient/progress@3.4.19
 - @react-aria-nutrient/radio@3.10.11
 - @react-aria-nutrient/searchfield@3.8.0
 - @react-aria-nutrient/select@3.15.1
 - @react-aria-nutrient/selection@3.22.0
 - @react-aria-nutrient/separator@3.4.5
 - @react-aria-nutrient/slider@3.7.15
 - @react-aria-nutrient/spinbutton@3.6.11
 - @react-aria-nutrient/steplist@3.0.0-alpha.13
 - @react-aria-nutrient/switch@3.6.11
 - @react-aria-nutrient/table@3.16.1
 - @react-aria-nutrient/tabs@3.9.9
 - @react-aria-nutrient/tag@3.4.9
 - @react-aria-nutrient/test-utils@1.0.0-alpha.4
 - @react-aria-nutrient/textfield@3.16.0
 - @react-aria-nutrient/toast@3.0.0-beta.19
 - @react-aria-nutrient/toggle@3.10.11
 - @react-aria-nutrient/toolbar@3.0.0-beta.12
 - @react-aria-nutrient/tooltip@3.7.11
 - @react-aria-nutrient/tree@3.0.0-beta.3
 - @react-aria-nutrient/utils@3.27.0
 - @react-aria-nutrient/virtualizer@4.1.1
 - @react-aria-nutrient/visually-hidden@3.8.19
 ...
 - @react-aria-nutrient/optimize-locales-plugin@1.1.4
