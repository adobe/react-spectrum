...
We have a huge release today! Its a GA bonanza 🎊 – (Submenu)[/react-spectrum/Menu.html#submenus], (unavailable menu items)[/react-spectrum/Menu.html#unavailable-items], (DropZone)[/react-spectrum/DropZone.html] and (FileTrigger)[] components are now in GA. Check our blog post on the intricacies of the submenu interactions and how we handled them.
