...
Client-side routing has improved blah blah and collections components in React Aria Components now has support for onAction and isDisabled on the Item for a more convenience when using the static API. /react-aria/routing.html#routerprovider
