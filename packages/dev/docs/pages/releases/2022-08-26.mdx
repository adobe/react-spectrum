...
---
description: We are very pleased to announce the release on ListView to GA!
date: 2022-08-26
---

# August 26, 2022 Release

We are very pleased to announce the release on ListView to GA!
...
* Add ListView to monopackages - [@devongovett](https://github.com/devongovett) - [PR](https://github.com/adobe/react-spectrum/pull/3451)
...
* Localize TimeField label in DatePicker and DateRangePicker - [@devongovett](https://github.com/devongovett) - [PR](https://github.com/adobe/react-spectrum/pull/3433) * REMOVE IF THIS DOESN"T COME IN
* Remove millisecond granularity from date/time pickers - [@devongovett](https://github.com/devongovett) - [PR](https://github.com/adobe/react-spectrum/pull/3435)
