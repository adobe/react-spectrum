...
- **ToggleButton** - [@tomsontom](https://github.com/tomsontom) - [PR](https://github.com/adobe/react-spectrum/pull/916)
  ...
  - [useToggleButton](../../react-aria/useToggleButton.html) hook in `@react-aria-nutrient/button`
...
- **Tabs** - [@so99ynoodles](https://github.com/so99ynoodles) - [PR](https://github.com/adobe/react-spectrum/pull/837)
  ...
  - `@react-aria-nutrient/tabs` (alpha)
...
- Added `useVisuallyHidden` hook to `@react-aria-nutrient/visually-hidden` - [@devongovett](https://github.com/devongovett) - [PR](https://github.com/adobe/react-spectrum/pull/917)
- Added `useHiddenSelect` hook to `@react-aria-nutrient/select` - [@devongovett](https://github.com/devongovett) - [PR](https://github.com/adobe/react-spectrum/pull/917)
...
- @react-aria-nutrient/aria-modal-polyfill@3.2.0
- @react-aria-nutrient/button@3.2.0
- @react-aria-nutrient/dialog@3.1.1
- @react-aria-nutrient/focus@3.2.0
- @react-aria-nutrient/interactions@3.2.0
- @react-aria-nutrient/listbox@3.2.0
- @react-aria-nutrient/menu@3.1.1
- @react-aria-nutrient/overlays@3.2.0
- @react-aria-nutrient/select@3.2.0
- @react-aria-nutrient/selection@3.2.0
- @react-aria-nutrient/slider@3.0.0-alpha.0
- @react-aria-nutrient/table@3.0.0-alpha.6
- @react-aria-nutrient/tabs@3.0.0-alpha.0
- @react-aria-nutrient/textfield@3.2.0
- @react-aria-nutrient/tooltip@3.0.0-alpha.0
- @react-aria-nutrient/utils@3.2.0
- @react-aria-nutrient/virtualizer@3.1.1
- @react-aria-nutrient/visually-hidden@3.2.0
