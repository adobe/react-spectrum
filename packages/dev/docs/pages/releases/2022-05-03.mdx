...
# May 3, 2022 Release
We are pleased to announce that the `datepicker` and `calendar` packages have been release into rc! This update comes complete with new documentation for the [DatePicker](https://react-spectrum.adobe.com/react-spectrum/DatePicker.html), [DateRangePicker](https://react-spectrum.adobe.com/react-spectrum/DateRangePicker.html), [DateField](https://react-spectrum.adobe.com/react-spectrum/DateField.html), [TimeField](https://react-spectrum.adobe.com/react-spectrum/TimeField.html), [Calendar](https://react-spectrum.adobe.com/react-spectrum/Calendar.html) and [RangeCalendar](https://react-spectrum.adobe.com/react-spectrum/RangeCalendar.html) React Spectrum components and associated [React-Aria](https://react-spectrum.adobe.com/react-aria/useDatePicker.html) hooks.
