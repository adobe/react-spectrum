...
- Support fragments in collections - [@solimant](https://github.com/solimant) - [PR](https://github.com/adobe/react-spectrum/pull/6430)
...
- Misc
  - Upgrade to Yarn 4 - [@snowystinger](https://github.com/snowystinger) - [PR](https://github.com/adobe/react-spectrum/pull/6215), [PR](https://github.com/adobe/react-spectrum/pull/6767)
...
- Fix Combobox `isQuiet` and `isReadOnly` styling and SearchField padding right specificity - [@LFDanLu](https://github.com/LFDanLu) - [PR](https://github.com/adobe/react-spectrum/pull/6829)
...
- Conditionally render FieldLabel only if label is provided - [@jluyau](https://github.com/jluyau) - [PR](https://github.com/adobe/react-spectrum/pull/6833)
- Fix SelectValue from showing placeholder when selected value is 0 - [@unional](https://github.com/unional) - [PR](https://github.com/adobe/react-spectrum/pull/6968)
...
- TreeView/Tree (Alpha):
  ...
  - Add basic docs for Tree - [@devongovett](https://github.com/devongovett) - [PR](https://github.com/adobe/react-spectrum/pull/7071)
