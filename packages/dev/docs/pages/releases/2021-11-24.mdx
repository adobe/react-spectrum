...
Our `@react-aria-nutrient/interactions` package now includes a new `useLongPress` hook for handling long press interactions across both mouse and touch devices. This hook automatically supports preventing text selection and context menus, allowing customizable time thresholds, and an accessibility description to help discoverability with assistive technology users. Take a look at the documentation in our [React Aria docs](https://react-spectrum.adobe.com/react-aria/useLongPress.html).
...
- Add new `useLongPress` hook to `@react-aria-nutrient/interactions` - [@devongovett](https://github.com/devongovett) - [PR](https://github.com/adobe/react-spectrum/pull/2363)
...
- @react-aria-nutrient/autocomplete@3.0.0-alpha.1
- @react-aria-nutrient/calendar@3.0.0-alpha.0
- @react-aria-nutrient/color@3.0.0-beta.5
- @react-aria-nutrient/combobox@3.2.0
- @react-aria-nutrient/datepicker@3.0.0-alpha.0
- @react-aria-nutrient/grid@3.1.0
- @react-aria-nutrient/i18n@3.3.3
- @react-aria-nutrient/interactions@3.7.0
- @react-aria-nutrient/label@3.2.1
- @react-aria-nutrient/link@3.2.0
- @react-aria-nutrient/listbox@3.4.0
- @react-aria-nutrient/menu@3.3.0
- @react-aria-nutrient/numberfield@3.1.1
- @react-aria-nutrient/overlays@3.7.3
- @react-aria-nutrient/radio@3.1.6
- @react-aria-nutrient/searchfield@3.2.1
- @react-aria-nutrient/select@3.6.0
- @react-aria-nutrient/selection@3.7.0
- @react-aria-nutrient/table@3.1.0
- @react-aria-nutrient/tabs@3.1.0
- @react-aria-nutrient/textfield@3.5.0
- @react-aria-nutrient/toggle@3.1.5
- @react-aria-nutrient/utils@3.10.0
- @react-aria-nutrient/virtualizer@3.3.5
