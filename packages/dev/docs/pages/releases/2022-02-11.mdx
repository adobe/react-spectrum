...
- Update `FocusScope` to restore focus correctly when children change - [@snowystinger](https://github.com/snowystinger) - [PR](https://github.com/adobe/react-spectrum/pull/2791)
