...
A major version bump to our workflow icons package is included in this release, so please check out the changes [here](#icons-update) and upgrade accordingly.
