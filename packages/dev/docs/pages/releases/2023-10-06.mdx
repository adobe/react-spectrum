...
---
description: In this release, we've extended link support across all collection components! Now the Item component supports href and other link-related DOM props. To streamline integration with client-side routers, we've introduced the RouterProvider component which configures all the React Aria components within it to navigate using the client side router you specified. Since its beta release, we have made improvements and bug fixes to React Aria Components. React Spectrum has new additions, including DropZone, isPending prop to Button, and staticColor pop to ProgressCircle and ProgressBar.
...
In this release, we've extended link support across all collection components! Now the `Item` component supports `href` and other link-related DOM props. To streamline integration with client-side routers, we've introduced the `RouterProvider` component which configures all the React Aria components within it to navigate using the client side router you specified ([see docs](../react-aria/routing.html#routerprovider)). Since its beta release, we have made improvements and bug fixes to [React Aria Components](../react-aria/react-aria-components.html). Internal contexts have been refactored to allow for greater customizability ([see docs](../react-aria/advanced.html)), MenuTrigger and DialogTrigger now use PressResponder to work with any pressable component, and documentation has been updated to help improve adoption. React Spectrum also has new additons, including [DropZone](../react-spectrum/DropZone.html), [isPending](../react-spectrum/Button.html#pending) prop to Button, and `staticColor` prop to PrgoressCircle and ProgressBar. 
...
- Fix aria-expanded in useDatePicker and useDateRangePicker - [@ryo-manba](https://github.com/ryo-manba) - [PR](https://github.com/adobe/react-spectrum/pull/5166)
- Fix overlay positioning when the portal container is not the body - [@devongovett](https://github.com/devongovett) - [PR](https://github.com/adobe/react-spectrum/pull/5174)
