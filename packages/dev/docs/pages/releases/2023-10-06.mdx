...
For React Spectrum we have some new additions, including [DropZone](../react-spectrum/DropZone.html), static color support for [ProgressCircle](../react-spectrum/ProgressBar.html#static-color) and [ProgressBar](..react-spectrum/ProgressCircle.html#static-color), and support for [isPending](../react-spectrum/Button.html#pending) in `Button`.
