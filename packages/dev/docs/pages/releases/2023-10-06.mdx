...
---
description: In this release, we've extended link support across all collection components! To streamline integration with client-side routers, we've introduced the RouterProvider component, allowing you to seamlessly incorporate client-side routers without wrapping a router Link component. Since its beta release, we have made improvements and bug fixes to React Aria Components. React Spectrum has new additions, including DropZone and isPending prop to Button.
