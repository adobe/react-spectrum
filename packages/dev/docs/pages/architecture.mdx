...
<figure className={style.float}>
  <Flex direction="column" gap="size-125">
    <View backgroundColor="orange-400" height="size-900">
      <Flex alignItems="center" justifyContent="center" height="100%">
        <span style={{color: 'white', fontSize: 18}}>Component</span>
      </Flex>
    </View>
    <View backgroundColor="chartreuse-400" height="size-900">
      <Flex alignItems="center" justifyContent="center" height="100%">
        <span style={{color: 'white', fontSize: 18}}>Behavior Hook</span>
      </Flex>
    </View>
    <View backgroundColor="blue-400" height="size-900">
      <Flex alignItems="center" justifyContent="center" height="100%">
...
not assumption about the view system it is running on. It also has no
theme or design system specific logic.

The state hook accepts common props from the component and provides
state management. It returns an interface for reading and updating
component state, with methods that implement much of the core logic
for the component.
...
depends on the platform API (e.g. the DOM or react-native). It still has
no theme or design system specific logic in it though. It implements event
...
the state from the state hook to adjust its visual appearance based on the state.
...
[source code](https://github.com/adobe-private/react-spectrum-v3) for
inspiration.
