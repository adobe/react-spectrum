...
In addition, flex layouts are automatically mirrored in right-to-left languages, and can be nested to create 
...
This example shows a simple horizontal stack, with a gap between each item defined using a Spectrum dimension variable.
...
<Picker label="Permission" defaultSelectedKey="read">
  <Item textValue="Read" uniqueKey="read">
    <Book size="S" />
    <Text>Read</Text>
    <Text slot="description">Read only</Text>
  </Item>
  <Item textValue="Write" uniqueKey="write">
    <Draw size="S" />
    <Text>Write</Text>
    <Text slot="description">Read and write only</Text>
  </Item>
  <Item textValue="Admin" uniqueKey="admin">
