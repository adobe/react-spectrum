...
the '@react-spectrum/test-utils` package to handle this width mocking for you:
...
TODO document installMouseEvents and movement? Doublecheck if we can even get it to fire with user event
