...
If you are using Jest with fake timers and don't need to control the specific timings around the long press interaction, use our <TypeLink links={testUtilDocs.links} type={testUtilDocs.exports.triggerLongPress} /> utility as shown below.
