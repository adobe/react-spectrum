...
export function ResourceCard(props) {
  ...
  cardContent = {
    svg: (
      <svg
        className={styles['spectrumImage']}
  ...
  if (type.toLowerCase() === 'github') {
    ...
    cardContent = {
      svg: (
        <svg
          ...
          viewBox="0 0 66 66"
          xmlSpace="preserve">
          <g id="layer1" transform="translate(8.305 24.74)">
            <path
              id="path4951"
              fill="#cb3837"
              d="M13.73 19.26V16.5H0V0h49.39v16.5h-24.7v2.76H13.73z"
            />
            <path id="path4949" fill="#fff" d="M22.02 16.5v-2.77h5.43V2.77H16.51V16.5h5.51z" />
            <path id="path4947" fill="#cb3837" d="M22.02 5.53h2.67v5.43h-2.67V5.53z" />
            <path
              id="path4945"
              fill="#fff"
    ...
    cardContent = {
      svg: (
        <svg viewBox="0 0 52 64" style={{background: '#FF4785'}}>
    ...
    cardContent = {
      svg: (
        <svg fill="none" viewBox="-4 -4 62 41">
  ...
  return (
    <a
      ...
      <div className={clsx(typographyStyles['spectrum-Body4'], styles['cardContent'])}>
        ...
        <div className={styles['cardType']}>{cardContent.type}</div>
      </div>
    </a>
  );
}
