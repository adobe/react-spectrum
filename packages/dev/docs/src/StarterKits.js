  ...
  return (
    <section style={{display: 'flex', columnGap: 16, flexWrap: 'wrap'}}>
      <div style={{display: 'flex', flexDirection: 'column', gap: 4}}>
        ...
        <Link
          variant="secondary"
          href={`../react-aria-starter/index.html${query}`}
          target="_blank"
          UNSAFE_style={{width: 'fit-content'}}>
          Preview
          <LinkOut size="XXS" marginStart="size-75" UNSAFE_style={{verticalAlign: 'middle'}} />
        </Link>
      </div>
      <div style={{display: 'flex', flexDirection: 'column', gap: 4}}>
        <ResourceCard
        ...
        <Link
          variant="secondary"
          href={`../react-aria-tailwind-starter/index.html${tailwindQuery}`}
          target="_blank"
          UNSAFE_style={{width: 'fit-content'}}>
          Preview
          <LinkOut size="XXS" marginStart="size-75" UNSAFE_style={{verticalAlign: 'middle'}} />
