...
module.exports = new Transformer({
  async transform({asset, options}) {
    ...
    let ast = parse(code, {
      ...
      strictMode: false,
      sourceType: 'module',
      plugins: ['classProperties', 'exportDefaultFrom', 'exportNamespaceFrom', 'dynamicImport', 'typescript', 'jsx', 'classPrivateProperties', 'classPrivateMethods', 'importAssertions']
    });
