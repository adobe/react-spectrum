        ...
        {posts.map(post => (
          <article
            ...
            <header className={style({marginBottom: 12})}>
              ...
              {post.exports?.author && (
                <Byline
                  author={post.exports?.author}
                  authorLink={post.exports?.authorLink}
                  date={post.exports?.date}
                />
              )}
              {post.exports?.date && !post.exports.author && <Time date={post.exports.date} />}
            </header>
            <meta itemProp="url" content={post.url} />
            <p itemProp="description" className={style({font: 'body', margin: 0})}>
              {renderHTMLfromMarkdown(post.exports?.description, {
                forceInline: true,
                forceBlock: false
              })}
            </p>
...
function RSSIcon() {
  return (
    <svg
      ...
      <path
        fillRule="evenodd"
        d="M21.983,32.007h-4a.5.5,0,0,1-.5-.489,13.519,13.519,0,0,0-13-13,.5.5,0,0,1-.488-.5l0-4a.5.5,0,0,1,.511-.5A18.525,18.525,0,0,1,22.486,31.5.5.5,0,0,1,21.983,32.007Z"
      />
      <path
        fillRule="evenodd"
        d="M31.985,32.007h-4a.5.5,0,0,1-.5-.493,23.7,23.7,0,0,0-23-23.19.5.5,0,0,1-.493-.5V4.015a.5.5,0,0,1,.51-.5A28.535,28.535,0,0,1,32.489,31.5.5.5,0,0,1,31.985,32.007Z"
      />
    </svg>
  );
}
