...
import { ActionButton, Popover, pressScale, SearchField, Text } from '@react-spectrum/s2';
...
export function IconPicker({value, onChange, label, contextualHelp}) {
  ...
  let valueObject = typeof value === 'string' ? {text: value} : value;
