  ...
  return (
    <>
      ...
      <div className={style({display: {default: 'flex', lg: 'none'}})}>
        <DialogTrigger>
          <Button className="no-underline bg-white/60 border border-black/10 bg-clip-padding text-base md:text-lg font-bold text-slate-800 px-8 py-3 rounded-full backdrop-saturate-150 backdrop-brightness-125 transition hover:bg-white/60 focus-ring  dark:outline-white outline-offset-2 active:scale-95">Explore Components</Button>
