...
function StarterCard({
  ...
  return (
    <div className={style({display: 'flex', flexDirection: 'column', gap: 8})}>
      <Card href={`${zip}.${gitHash}.zip`} download>
...
function VanillaStarterCard() {
  return (
    <StarterCard zip="react-aria-starter" previewHref="react-aria-starter/" title="Vanilla CSS">
      {vanillaIcon}
    </StarterCard>
  );
}

function TailwindStarterCard() {
  return (
    <StarterCard
      zip="react-aria-tailwind-starter"
      previewHref="react-aria-tailwind-starter/"
      title="Tailwind CSS">
      {tailwindIcon}
    </StarterCard>
  );
...
function HooksStarterCard() {
  return (
    <StarterCard
      zip="react-aria-hooks-starter"
      previewHref="react-aria-hooks-starter/"
      title="Vanilla CSS (Hooks)">
      {vanillaIcon}
    </StarterCard>
  );
}

const section = style({display: 'flex', gap: 16, flexWrap: 'wrap'});
...
// Just the hooks starter, for the Hooks guide page.
export function HooksStarterKit() {
  return (
    <section className={section}>
      <HooksStarterCard />
    </section>
