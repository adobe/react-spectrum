...
const negativeBaseSpacingValues = [
  -2, -4, -8, -12, -16, -20, -24, -28, -32, -36, -40, -44, -48, -56, -64, -80, -96
];
...
const shorthandMapping: {
  [key: string]: {values: (string | number)[]; mapping: string[]; category: string};
} = {
  padding: {
...
const mdnPropertyLinks: {[key: string]: {[value: string]: string}} = {
  ...
  textDecoration: {
    ...
    'line-through':
      'https://developer.mozilla.org/en-US/docs/Web/CSS/text-decoration-line#line-through'
  },
  textOverflow: {
  ...
  justifyContent: {
    ...
    'space-between':
      'https://developer.mozilla.org/en-US/docs/Web/CSS/justify-content#space-between',
  ...
  flexDirection: {
    ...
    'column-reverse':
      'https://developer.mozilla.org/en-US/docs/Web/CSS/flex-direction#column-reverse'
  },
  flexWrap: {
  ...
  gridTemplateColumns: {
    ...
    'min-content':
      'https://developer.mozilla.org/en-US/docs/Web/CSS/grid-template-columns#min-content',
    'max-content':
      'https://developer.mozilla.org/en-US/docs/Web/CSS/grid-template-columns#max-content',
  ...
  gridTemplateRows: {
    ...
    'min-content':
      'https://developer.mozilla.org/en-US/docs/Web/CSS/grid-template-rows#min-content',
    'max-content':
      'https://developer.mozilla.org/en-US/docs/Web/CSS/grid-template-rows#max-content',
  ...
  backgroundBlendMode: {
    ...
    'color-dodge':
      'https://developer.mozilla.org/en-US/docs/Web/CSS/background-blend-mode#color-dodge',
    'color-burn':
      'https://developer.mozilla.org/en-US/docs/Web/CSS/background-blend-mode#color-burn',
    'hard-light':
      'https://developer.mozilla.org/en-US/docs/Web/CSS/background-blend-mode#hard-light',
    'soft-light':
      'https://developer.mozilla.org/en-US/docs/Web/CSS/background-blend-mode#soft-light',
  ...
  animationDirection: {
    ...
    'alternate-reverse':
      'https://developer.mozilla.org/en-US/docs/Web/CSS/animation-direction#alternate-reverse'
  },
  animationFillMode: {
  ...
  willChange: {
    ...
    'scroll-position':
      'https://developer.mozilla.org/en-US/docs/Web/CSS/will-change#scroll-position',
  ...
  unicodeBidi: {
    ...
    'isolate-override':
      'https://developer.mozilla.org/en-US/docs/Web/CSS/unicode-bidi#isolate-override',
...
const propertyDescriptions: {[key: string]: string} = {
  ...
  animationShorthand:
    'This shorthand explicitly defines duration as 150 and the timing function as "default".',
  truncateShorthand:
    'Accepts a boolean value. Applying this shorthand will set the required style macro properties to enable text truncation.',
  fontShorthand:
    'Accepts the same values as fontSize. The fontSize provided defines the values this shorthand sets on the mapped values.',
...
export function getPropertyDefinitions(propertyCategory: string): {
  [key: string]: StyleMacroPropertyDefinition;
} {
  ...
  for (let [name, values] of Object.entries(propertiesMapping)) {
    ...
    for (let value of values) {
      ...
      if (
        (value === 'number' && sizingProperties.has(name)) ||
        (value === 'pill' && propertyCategory !== 'dimensions')
      ) {
        continue;
      }
