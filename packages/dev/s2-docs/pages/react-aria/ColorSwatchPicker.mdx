...
<ExampleSwitcher>
  ```tsx render docs={docs.exports.ColorSwatchPicker} links={docs.links} props={['layout']} initialProps={{'aria-label': 'Background color'}} type="vanilla" files={["starters/docs/src/ColorSwatchPicker.tsx", "starters/docs/src/ColorSwatchPicker.css", "starters/docs/src/theme.css"]}
  "use client";
