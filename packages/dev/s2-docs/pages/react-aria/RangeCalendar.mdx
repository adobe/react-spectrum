...
<ExampleSwitcher>
  <VisualExample
    ...
    props={['isDisabled']}
    type="vanilla"
    files={["starters/docs/src/RangeCalendar.tsx", "starters/docs/src/RangeCalendar.css", "starters/docs/src/theme.css"]} />
  <VisualExample
...
Most of this anatomy is shared with [Calendar](Calendar.html), so you can reuse many components between them.
