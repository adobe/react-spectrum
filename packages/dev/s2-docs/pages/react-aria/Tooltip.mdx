...
export const relatedPages = [{'title': 'useTooltipTrigger', 'url': 'https://react-spectrum.adobe.com/react-aria/useTooltipTrigger.html'}];
export const description = 'A tooltip displays a description of an element on hover or focus.';
