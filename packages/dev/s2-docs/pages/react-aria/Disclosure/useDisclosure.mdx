...
function Disclosure(props: AriaDisclosureProps & {title?: React.ReactNode, children?: React.ReactNode}) {
...
<FunctionAPI function={statelyDocs.exports.useDisclosureState} links={statelyDocs.links} />
