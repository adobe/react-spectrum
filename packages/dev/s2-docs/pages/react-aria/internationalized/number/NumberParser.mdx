...
export const section = 'Internationalized';
...
Read our [blog post](../../blog/how-we-internationalized-our-numberfield) for more details on how the number parser is implemented.
