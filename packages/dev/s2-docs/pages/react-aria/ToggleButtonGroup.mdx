...
export const relatedPages = [{'title': 'useToggleButtonGroup', 'url': 'https://react-spectrum.adobe.com/react-aria/useToggleButtonGroup.html'}];
export const description = 'A toggle button group allows a user to toggle multiple options, with single or multiple selection.';
