...
<GroupedPropTable {...docs.exports.PressResult} links={docs.links} />

`usePress` supports the following event handlers:

<GroupedPropTable {...typesDocs.exports.PressEvents} links={typesDocs.links}  defaultExpanded={new Set(['Events'])}/>
...
<GroupedPropTable {...typesDocs.exports.PressEvent} links={typesDocs.links} />
