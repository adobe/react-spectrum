...
<GroupedPropTable {...docs.exports.FocusVisibleResult} links={docs.links} />

`useFocusVisible` supports the following props and event handlers:

<GroupedPropTable {...docs.exports.FocusVisibleProps} links={docs.links} />
