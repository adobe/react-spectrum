...
import demoVideoUrl from 'url:./demo.webm';
...
<html>
  ...
  <body className="m-0">
    <header className="relative header-background pt-32">
      ...
      <section className="p-10 box-border overflow-clip bg-white dark:bg-zinc-800/80 dark:backdrop-saturate-200 card-shadow w-fit max-w-[calc(100%-40px)] mx-auto rounded-xl flex items-center flex-col xl:flex-row gap-8">
        <div>
          <h2 className="text-3xl md:text-4xl my-0 text-balance"><GradientText>Redesigned documentation is here.</GradientText></h2>
          <p className="mt-4 mb-2 md:mb-4 text-balance text-lg md:text-xl max-w-xl text-slate-700 dark:text-slate-400">Re-rewritten content. Improved search. All-new vanilla CSS and Tailwind examples with interactive controls. Editable sandboxes. Install with shadcn. Open with AI. MCP server. And more!</p>
          <LearnMoreLink href="getting-started.html" className="text-green-700 dark:text-green-600 hover:bg-green-400/[15%] mb-0">Check it out</LearnMoreLink>
        </div>
        <div className="flex-1">
          <div className="w-fit rounded-lg overflow-clip justify-self-end">
            <video src={demoVideoUrl.split('?')[0]} autoPlay loop playsInline muted className="block w-full max-w-xl xl:w-auto xl:h-[300px]" />
          </div>
        </div>
      </section>
      ...
      <section className="max-w-6xl mx-auto pt-32 px-4 sm:px-8 md:px-20 pb-48 sm:pb-60">
        ...
        <div className="relative pt-10 md:pt-20 md:mt-20">
          ...
          <div className="max-w-[600px] mx-auto">
            <a href="examples/crud.html" target="_blank" className="flex items-center gap-1 w-fit mt-4 ms-auto text-sm text-gray-900 dark:text-white hover:bg-black/10 hover:dark:bg-white/10 group no-underline rounded-full px-3 -me-3 py-1 transition focus-ring active:scale-95">View example source<ArrowRight aria-hidden className="inline w-4 h-4 will-change-transform group-hover:translate-x-0.5 transition" /></a>
          </div>
        </div>
      </section>
    </header>
    ...
    <Section className="red-gradient-background">
      ...
      <KanbanBoard />
      <a href="examples/kanban.html" target="_blank" className="flex items-center gap-1 w-fit ms-auto text-sm text-gray-900 dark:text-white hover:bg-black/10 hover:dark:bg-white/10 group no-underline rounded-full px-3 -me-3 py-1 transition focus-ring active:scale-95">View example source<ArrowRight aria-hidden className="inline w-4 h-4 will-change-transform group-hover:translate-x-0.5 transition" /></a>
    </Section>
    ...
    <Section className="green-gradient-background">
      ...
      <LearnMoreLink href="customization.html" className="text-green-700 dark:text-green-600 hover:bg-green-400/[15%]" />
