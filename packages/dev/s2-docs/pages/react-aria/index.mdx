  ...
  <body className="m-0">
    ...
    <section className="max-w-6xl mx-auto px-8 md:px-20 pb-20">
      ...
      <div className="grid md:grid-cols-3 gap-6">
        ...
        <a href="components" className="no-underline card-shadow bg-white dark:bg-zinc-800 rounded-xl p-6 transition duration-300 card-shadow-hover hover:scale-[101%]">
