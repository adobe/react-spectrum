...
import {InteractiveReactAriaLogo} from '../../src/icons/InteractiveReactAriaLogo';
  ...
  <body className="m-0">
    <header className="relative header-background">
      ...
      <section className="max-w-6xl mx-auto pt-32 px-4 sm:px-8 md:px-20 pb-48 sm:pb-60">
        <div className="flex flex-col items-center mb-10 md:mb-14 [filter:drop-shadow(0_0_0.25em_var(--page-bg))] dark:filter-none select-none">
          <div className="h-[144px] aspect-[212/198]">
            <InteractiveReactAriaLogo />
          </div>
          <p className="mt-4 text-5xl sm:text-7xl md:text-[92px] font-extrabold text-center text-black dark:text-white m-0 leading-none">React Aria</p>
        </div>
