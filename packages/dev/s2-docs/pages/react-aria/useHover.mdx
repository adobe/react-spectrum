...
<GroupedPropTable {...docs.exports.HoverResult} links={docs.links} />

`useHover` supports the following props:

<GroupedPropTable {...docs.exports.HoverProps} links={docs.links} defaultExpanded={new Set(['Events'])} />
...
<GroupedPropTable {...typesDocs.exports.HoverEvent} links={typesDocs.links} defaultExpanded={new Set(['Links'])} />
