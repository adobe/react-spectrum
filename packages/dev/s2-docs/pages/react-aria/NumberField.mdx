...
export const description = 'A number field allows a user to enter a number, and increment or decrement the value using stepper buttons.';
...
```tsx links={{NumberField: '#numberfield', Group: 'Group.html', Button: 'Button.html'}}
<NumberField>
  <Label />
  <Group>
    <Input />
