...
```tsx render files={["packages/dev/s2-docs/pages/react-aria/useDragExample.css", "packages/dev/s2-docs/pages/react-aria/Draggable.tsx"]}
'use client';
...
<GroupedPropTable {...docs.exports.DropEvent} links={docs.links} />
