...
<GroupedPropTable {...docs.exports.KeyboardResult} links={docs.links} />

`useKeyboard` supports the following props:

<GroupedPropTable {...docs.exports.KeyboardProps} links={docs.links} defaultExpanded={new Set(['Events'])}/>
