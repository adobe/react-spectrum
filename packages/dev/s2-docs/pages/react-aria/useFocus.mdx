...
<GroupedPropTable {...docs.exports.FocusResult} links={docs.links} />

`useFocus` supports the following props and event handlers:

<GroupedPropTable {...docs.exports.FocusProps} links={docs.links} defaultExpanded={new Set(['Events'])}/>
