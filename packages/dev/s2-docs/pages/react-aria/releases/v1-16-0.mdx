...
## Under Construction
* Shadow DOM - behind the feature flag `enableShadowDOM`
  ...
  * Update ariaHideOutside util to work with shadow DOM - [@snowystinger](https://github.com/snowystinger) - [PR](https://github.com/adobe/react-spectrum/pull/9607)
