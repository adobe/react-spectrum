...
The new [NavigationTree](../NavigationTree) component can be used for building hierarchical app navigation.
...
[Menu](../Menu#asynchronous-loading) now supports async loading and empty state.
