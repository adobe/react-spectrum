...
export const description = 'This release includes a range of enhancements and fixes such as improved keyboard accessibility in TagGroup and increased stability for dynamic table updates. It also brings support for React 19\'s ref cleanup behavior, performance improvements for collection updates in React transitions and pressable elements, and TypeScript updates including backwards compatibility with older TypeScript and @types/react versions.';
...
## Github release tag
[Release](https://github.com/adobe/react-spectrum/releases/tag/%40adobe%2Freact-spectrum%403.41.0)
