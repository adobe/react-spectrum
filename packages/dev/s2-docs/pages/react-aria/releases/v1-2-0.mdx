...
We have a huge release today! Its a GA bonanza 🎊 – [Submenu](../Menu#submenus), [unavailable menu items](../Menu#unavailable-items), [DropZone](../DropZone) and [FileTrigger](../FileTrigger) components are now in GA. Check our [blog post](/blog/creating-a-pointer-friendly-submenu-experience) on the intricacies of the submenu interactions and how we handled them.
