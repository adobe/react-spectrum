...
<video src={comboboxVideoUrl} loop autoPlay muted style={{maxWidth: 'min(100%, 700px)', display: 'block', margin: '40px auto'}} />
...
<video src={comboboxAccessibilityUrl} loop autoPlay muted style={{maxWidth: 'min(80%, 700px)', display: 'block', margin: '20px auto'}} />
