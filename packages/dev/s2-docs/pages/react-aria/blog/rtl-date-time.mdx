...
<video src={localeVideoURL} muted controls aria-label="Example of a React Spectrum DateField component in various locales" style={{maxWidth: 'min(100%, 700px)', display: 'block', margin: '40px auto'}} />
...
<video src={placeholderVideoURL} muted controls aria-label="Demo of the date segments shifting when backspacing" style={{maxWidth: 'min(100%, 700px)', display: 'block', margin: '40px auto'}} />
...
<video src={keyboardVideoURL} muted controls aria-label="Demo of keyboard navigation prior to fixes" style={{maxWidth: 'min(100%, 700px)', display: 'block', margin: '40px auto'}} />
