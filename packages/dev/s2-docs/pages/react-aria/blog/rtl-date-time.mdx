...
<video src={localeVideoURL} muted controls aria-label="Example of a React Spectrum DateField component in various locales" />
...
<video src={placeholderVideoURL} muted controls aria-label="Demo of the date segments shifting when backspacing" />
...
<video src={keyboardVideoURL} muted controls aria-label="Demo of keyboard navigation prior to fixes" />
