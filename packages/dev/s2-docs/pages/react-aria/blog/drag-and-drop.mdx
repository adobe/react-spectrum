...
<video src={heroVideo} loop autoPlay muted style={{width: '100%', display: 'block', margin: '40px auto'}} />
...
<video src={dndKeyboard + '#t=0.1'} preload="metadata" controls aria-label="Demo of drag and drop using a keyboard, showing list items being selected and dragged to corresponding drop targets." style={{width: '100%', display: 'block', margin: '40px auto'}} />
...
<video src={dndMobile + '#t=0.1'} preload="metadata" controls aria-label="Demo of drag and drop using VoiceOver on iOS" style={{maxHeight: '600px', width: '100%', display: 'block', margin: '40px auto'}}>
