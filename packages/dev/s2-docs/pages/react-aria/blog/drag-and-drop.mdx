...
<video src={heroVideo} loop autoPlay muted style={{maxWidth: 'min(100%, 700px)', display: 'block', margin: '40px auto'}} />
...
<video src={dndKeyboard} loop autoPlay muted style={{maxWidth: 'min(100%, 700px)', display: 'block', margin: '40px auto'}} />
...
<video src={dndMobile} loop autoPlay muted style={{maxWidth: 'min(100%, 700px)', display: 'block', margin: '40px auto'}}>
