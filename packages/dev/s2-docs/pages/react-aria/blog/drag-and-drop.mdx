...
We are excited to announce the release of drag and drop support in [React Aria](../dnd) and [React Spectrum](s2:dnd)! This includes a suite of hooks for implementing drag and drop interactions, with support for both mouse and touch, as well as full parity for keyboard and screen reader input. We've designed these hooks with the following features in mind:
