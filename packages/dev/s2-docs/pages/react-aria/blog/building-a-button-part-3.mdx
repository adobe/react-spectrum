...
This focus normalization behavior is implemented by the [usePress](../usePress) hook in React Aria, which is used by [useButton](https://react-spectrum.adobe.com/react-aria/useButton.html), [useCheckbox](https://react-spectrum.adobe.com/react-aria/useCheckbox.html), [useRadio](https://react-spectrum.adobe.com/react-aria/useRadioGroup.html), and many other hooks. If you're implementing your own components, I.html'd highly recommend checking them out to ensure the focus behavior is consistent across browsers.
