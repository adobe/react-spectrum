...
<video src={draggingVideoUrl} loop autoPlay muted playsInline style={{width: '100%', display: 'block', margin: '20px auto'}} />
...
<video src={textSelectionVideoUrl} loop autoPlay muted playsInline style={{width: '100%', display: 'block', margin: '20px auto'}} />
...
<video src={buttonVideoUrl} loop autoPlay muted playsInline style={{width: '100%', display: 'block', margin: '20px auto'}} />
