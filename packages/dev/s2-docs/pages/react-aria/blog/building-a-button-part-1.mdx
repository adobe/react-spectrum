...
As you can see, buttons are deceptively complicated once you consider all of the interactions they can support. The [useButton](https://react-spectrum.adobe.com/react-aria/useButton.html) and underlying [usePress](../usePress.html) hooks in React Aria handle all of this complexity, and ensure that everything works as expected across devices. If you are building your own button component, I'd highly recommend checking them out!
