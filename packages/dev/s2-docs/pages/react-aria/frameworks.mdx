...
<Tabs aria-label="Frameworks" density="compact">
  ...
  <TabPanel id="next">
    ...
    <StepList>
      ...
      <Step>
        <Counter />If you are using a [Content Security Policy](https://developer.mozilla.org/en-US/docs/Web/HTTP/Guides/CSP) (CSP), follow the [Next.js CSP](https://nextjs.org/docs/app/building-your-application/configuring/content-security-policy) guide to generate and inject a nonce. React Aria automatically reads the nonce that Next.js injects.
      </Step>
    </StepList>
  </TabPanel>
