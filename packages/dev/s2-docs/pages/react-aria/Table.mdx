...
<ExampleSwitcher>
  ```tsx render docs={docs.exports.Table} links={docs.links} props={['selectionMode']} initialProps={{'aria-label': 'Files', selectionMode: 'multiple', 'treeColumn': 'name'}} type="vanilla" files={["starters/docs/src/Table.tsx", "starters/docs/src/Table.css"]}
  "use client";
...
```tsx render files={["starters/docs/src/Table.tsx", "starters/docs/src/Table.css"]}
"use client";
import {Table, TableHeader, Column, Row, TableBody, Cell} from 'vanilla-starter/Table';
...
```tsx links={{ResizableTableContainer: '#resizabletablecontainer', Table: '#table', TableHeader: '#tableheader', Column: '#column', Checkbox: 'Checkbox', ColumnResizer: '#columnresizer', TableBody: '#tablebody', Row: '#row', Cell: '#cell', TableFooter: '#tablefooter', Button: 'Button', TableLoadMoreItem: '#tableloadmoreitem', SelectionIndicator: 'selection#animated-selectionindicator'}}
<ResizableTableContainer>
  <Table>
    <TableHeader>
      <Column />
...
<PropTable
  ...
  showDescription
  cssVariables={{
    '--table-row-level': "The depth of the row within the table. Useful to calculate indentation."
  }} />
...
<PropTable
  component={docs.exports.TableLoadMoreItem}
  links={docs.links}
  showDescription
  cssVariables={{
    '--table-row-level': "The depth of the row within the table. Useful to calculate indentation."
