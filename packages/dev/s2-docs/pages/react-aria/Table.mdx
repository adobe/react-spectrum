...
<ExampleSwitcher>
  ```tsx render docs={docs.exports.Table} links={docs.links} props={['selectionMode']} initialProps={{'aria-label': 'Files', selectionMode: 'multiple'}} files={["starters/docs/src/Table.tsx", "starters/docs/src/Table.css", "starters/docs/src/theme.css"]}
  "use client";
  ...
  ```tsx render docs={docs.exports.Table} links={docs.links} props={['selectionMode']} initialProps={{'aria-label': 'Files', selectionMode: 'multiple'}} files={["starters/tailwind/src/Table.tsx"]}
  "use client";
