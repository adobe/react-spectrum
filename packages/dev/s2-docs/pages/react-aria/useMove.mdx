...
<GroupedPropTable {...docs.exports.MoveResult} links={docs.links} />

`useMove` supports the following event handlers:

<GroupedPropTable {...typesDocs.exports.MoveEvents} links={typesDocs.links} defaultExpanded={new Set('Events')}/>
...
<GroupedPropTable {...typesDocs.exports.MoveMoveEvent} links={typesDocs.links} />
