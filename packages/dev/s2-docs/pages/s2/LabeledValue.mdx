...
```tsx render docs={types.exports.LabeledValueDateTimeProps} links={types.links} props={['formatOptions']} initialProps={{label: 'Value', formatOptions: {dateStyle: 'short'}}} type="s2"
"use client"
import {LabeledValue} from "@react-spectrum/s2/LabeledValue";

<LabeledValue /* PROPS */ value={new Date(2022, 6, 5)} />
