...
export const description = 'ToggleButtons allow users to toggle a selection on or off, for example switching between two states or modes.';
...
```tsx links={{ToggleButton: '#toggleButton', Avatar: 'Avatar.html'}}
<ToggleButton>
  <Icon /> or <Avatar />
  <Text />
</ToggleButton>
