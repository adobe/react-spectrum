...
```tsx render docs={docs.exports.RadioGroup} links={docs.links} props={['size', 'labelPosition', 'labelAlign', 'necessityIndicator', 'isRequired', 'isDisabled', 'isInvalid']} initialProps={{label: 'Favorite pet'}} expanded type="s2"
import {RadioGroup, Radio} from '@react-spectrum/s2';
...
```tsx render hideImports
"use client";
import {RadioGroup, Radio, ContextualHelp, Heading, Content} from '@react-spectrum/s2';
