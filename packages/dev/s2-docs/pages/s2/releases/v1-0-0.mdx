...
* Miscellaneous
  * Add `get_style_macro_property_values` to Spectrum 2 MCP server - [@reidbarber](https://github.com/reidbarber) - [PR](https://github.com/adobe/react-spectrum/pull/9336)
