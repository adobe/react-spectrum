...
[colors](../style-macro#colors) and [typography](../style-macro#typography) have been added to help clarify
these common use cases. Style macro properties like `width` and `height` now allow for arbitrary pixel size values, please see the [docs](../style-macro#sizing)
