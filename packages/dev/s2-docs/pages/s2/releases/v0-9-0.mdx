...
We strongly discourage using `UNSAFE_className` because it results in inconsistent UIs and hard to maintain code. Instead, use [React Aria Components](https://react-spectrum.adobe.com/react-aria/) with the [S2 style macro](../styling#style-macro) to create custom components. [Safe style properties](../styling#values) can be passed to the `styles` prop of an S2 component.
