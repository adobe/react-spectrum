...
We are excited to announce the first preview of React Spectrum AI components to help build AI-powered experiences! Today, we are releasing our first batch of components and [documentation](../ai-components.mdx) on how to get started. Give it a try by installing through your preferred package manager!

<InstallCommand pkg="@react-spectrum/ai" />

### AI Icon

The new AI icon is now widely available for use and can be imported via:
