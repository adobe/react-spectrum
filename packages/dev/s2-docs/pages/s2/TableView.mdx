...
Will need to mention highlight mode later perhaps...
        ...
        {(column) => (
          <Column
            ...
            menuItems={
              <>
                <MenuSection>
                  <MenuItem onAction={`Filtering "${column.name}" column`}>Filter</MenuItem>
                </MenuSection>
                <MenuSection>
                  <MenuItem onAction={`Hiding "${column.name}" column`}>Hide column</MenuItem>
                  <MenuItem onAction={`Managing the "${column.name}" column`}>Manage columns</MenuItem>
                </MenuSection>
              </>
            }
            ///- end highlight -///
