...
```tsx render docs={docs.exports.CheckboxGroup} links={docs.links} props={['size', 'orientation', 'labelPosition', 'labelAlign', 'necessityIndicator', 'isEmphasized']} initialProps={{label: 'Favorite sports'}} type="s2"
