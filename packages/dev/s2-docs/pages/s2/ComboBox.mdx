...
Use the `prefix` prop to display an additional element before the input in the combo box.
...
function Example() {
  return (
    <ComboBox
      ...
      <ComboBoxItem>example@example.com</ComboBoxItem>
      <ComboBoxItem>test@example.com</ComboBoxItem>
      <ComboBoxItem>info@example.com</ComboBoxItem>
      <ComboBoxItem>support@example.com</ComboBoxItem>
      <ComboBoxItem>sales@example.com</ComboBoxItem>
    </ComboBox>
  );
}
```
