...
Use the `prefix` prop to display a prefix in the combobox.

```tsx render
"use client";
import {ComboBox, ComboBoxItem} from '@react-spectrum/s2/ComboBox';

<ComboBox label="Phone number" placeholder="(000) 000-0000" prefix="#">
  <ComboBoxItem>(123) 456-7890</ComboBoxItem>
  <ComboBoxItem>(123) 456-7891</ComboBoxItem>
  <ComboBoxItem>(123) 456-7892</ComboBoxItem>
  <ComboBoxItem>(123) 456-7893</ComboBoxItem>
  <ComboBoxItem>(123) 456-7894</ComboBoxItem>
  <ComboBoxItem>(123) 456-7895</ComboBoxItem>
</ComboBox>
```
