...
export const description = 'A Card summarizes an object that a user can select or navigate to.';
...
A `UserCard` represents a user profile. It includes an [Avatar](Avatar.html) and a `Content` section with `title` and `description` slots, along with an optional header image and `Footer`.
...
<PropTable component={docs.exports.Card} links={docs.links} />
...
<PropTable component={docs.exports.AssetCard} links={docs.links} />
...
<PropTable component={docs.exports.UserCard} links={docs.links} />
...
<PropTable component={docs.exports.ProductCard} links={docs.links} />
