...
In certain cases a visible label isn't needed. For example, a checkbox used to select a table row. If a visible label isn't specified, an `aria-label` must be provided to the Checkbox for accessibility.
