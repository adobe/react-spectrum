...
export const description = 'Forms allow users to enter data that can be submitted while providing alignment and styling for form fields.';
...
```tsx render docs={docs.exports.Form} links={docs.links} props={['validationBehavior']} type="s2"
"use client";
import {Form, TextField, Button} from '@react-spectrum/s2';
