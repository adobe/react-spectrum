...
```tsx render docs={docs.exports.Picker} links={docs.links} props={['size', 'labelPosition', 'labelAlign', 'necessityIndicator', 'isRequired', 'isQuiet', 'isDisabled', 'isInvalid']}
"use client";
import {Picker, PickerItem} from '@react-spectrum/s2';

<Picker label="Ice cream flavor"/* PROPS */>
