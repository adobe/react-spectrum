...
export function PressAnimation(): ReactNode {
      ...
      let cancel = animate([
        ...
        },
        {
          ...
          perform() {
            mouseRef.current!.animate(
              {
                transform: [translate(-50, 150), translate(10, 10)]
              },
        ...
        },
        {
          ...
          perform() {
            mouseRef.current!.animate(
              {
                transform: [translate(10, 10), translate(200, 10)]
              },
              {duration: 1000, fill: 'forwards', easing: 'ease-in-out'}
            );
          }
        ...
        },
        {
          ...
          perform() {
            mouseRef.current!.animate(
              {
                transform: [translate(200, 10), translate(250, 150)]
              },
              {duration: 1000, fill: 'forwards', easing: 'ease-in-out'}
            );
          }
        },
        {
          time: 100,
          perform() {
            buttonRef.current?.UNSAFE_getDOMNode()!.dispatchEvent(
  ...
  return (
    <div
      ...
      <Checkbox ref={checkboxRef} size="XL" isSelected={isChecked} onChange={setChecked}>
        Accept terms
      </Checkbox>
      <Button ref={buttonRef} variant="accent" size="XL">
        Submit
      </Button>
    </div>
  );
