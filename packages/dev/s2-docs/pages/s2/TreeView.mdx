...
function TreeItemTextWithPicker({label}) {
  return (
    <Text>
      <div
        className={style({
        ...
        {label}
        <PermissionPicker label={`${label} permission`} />
      </div>
    </Text>
  );
}
...
<TreeView
  ...
  <TreeViewItem id="documents" textValue="Documents">
    ...
    <TreeViewItem id="weekly" textValue="Weekly Report.pdf">
      <TreeViewItemContent>
        <TreeItemTextWithPicker label="Weekly Report.pdf" />
      </TreeViewItemContent>
    </TreeViewItem>
    <TreeViewItem id="budget" textValue="Budget.xlsx">
      <TreeViewItemContent>
        <TreeItemTextWithPicker label="Budget.xlsx" />
      </TreeViewItemContent>
    </TreeViewItem>
  </TreeViewItem>
  <TreeViewItem id="photos" textValue="Photos">
    ...
    <TreeViewItem id="sunset" textValue="Sunset.jpg">
      <TreeViewItemContent>
        <TreeItemTextWithPicker label="Sunset.jpg" />
      </TreeViewItemContent>
    </TreeViewItem>
  </TreeViewItem>
</TreeView>
