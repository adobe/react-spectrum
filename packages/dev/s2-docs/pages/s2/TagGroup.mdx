...
Use the `href` prop on a `<Tag>` to create a link. See the [getting started guide](getting-started) to learn how to integrate with your framework.
...
```tsx render type="s2"
"use client";
import {TagGroup} from '@react-spectrum/s2/TagGroup';
