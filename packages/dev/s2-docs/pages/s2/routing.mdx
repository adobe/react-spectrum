...
<PageDescription>Many React Spectrum components support rendering as HTML links. This page discusses how to set up your app to integrate React Spectrum links with your framework or client side router.</PageDescription>
...
function App() {
  ...
  return (
    <Provider router={{navigate, useHref}}>
      {/* ... */}
    </Provider>
  );
}
...
export function ClientProviders({children}) {
  ...
  return (
    <Provider router={{navigate: router.push}}>
      {children}
    </Provider>
  );
}
...
export function ClientProviders({children}) {
  ...
  return (
    <Provider router={{navigate: router.push, useHref}}>
      {children}
    </Provider>
  );
}
