...
<InlineAlert variant="informative">
  ...
  <Content>
    Every interactive custom component should include `focusRing()` or some other visual indicator of focus in order to satisfy [WCAG SC 2.4.7](https://www.w3.org/WAI/WCAG22/Understanding/focus-visible.html)
  </Content>
</InlineAlert>
