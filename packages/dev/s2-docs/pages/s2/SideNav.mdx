...
```tsx links={{SidePanel: '#sidepanel', SidePanelBadge: '#sidepanelbadge', SideNav: '#sidenav', SideNavItem: '#sidenavitem', SideNavItemContent: '#sidenavitemcontent', SideNavItemLink: '#sidenavitemlink', Icon: 'icons', Text: 'https://developer.mozilla.org/en-US/docs/Web/HTML/Element/span'}}
<SidePanel>
  <SideNav>
    <SideNavItem href>
      <SideNavItemContent>
...
<PropTable component={docs.exports.SidePanelBadge} links={docs.links} showDescription />
