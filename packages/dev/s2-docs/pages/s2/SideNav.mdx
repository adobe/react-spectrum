  ...
  {({selectedRoute}) => (
    <SideNav
      ...
      <SideNavItem href="/guidelines" id="guidelines" textValue="Guidelines">
        <SideNavItemContent><SideNavItemLink render={props => <RouterLink {...props} />}>Guidelines</SideNavItemLink></SideNavItemContent>
        <SideNavItem href="/style" id="style" textValue="Style">
          <SideNavItemContent><SideNavItemLink render={props => <RouterLink {...props} />}>Style</SideNavItemLink></SideNavItemContent>
        </SideNavItem>
        <SideNavItem href="/color" id="color" textValue="Color">
          <SideNavItemContent><SideNavItemLink render={props => <RouterLink {...props} />}>Color</SideNavItemLink></SideNavItemContent>
          <SideNavItem href="/background-layers" id="background-layers" textValue="Background Layers">
            <SideNavItemContent><SideNavItemLink render={props => <RouterLink {...props} />}>Background Layers</SideNavItemLink></SideNavItemContent>
          </SideNavItem>
        </SideNavItem>
      </SideNavItem>
      <SideNavItem id="support" textValue="Support">
        ...
        <SideNavItem href="/contact-us" id="contact-us" textValue="Contact Us">
          <SideNavItemContent><SideNavItemLink render={props => <RouterLink {...props} />}>Contact Us</SideNavItemLink></SideNavItemContent>
        </SideNavItem>
      </SideNavItem>
    </SideNav>
  )}
      ...
      {function renderItem(item) {
        return (
          <SideNavItem textValue={item.title} href={item.href}>
            <SideNavItemContent>{item.href ? <SideNavItemLink render={props => <RouterLink {...props} />}>{item.title}</SideNavItemLink> : item.title}</SideNavItemContent>
            {/*- begin highlight -*/}
        ...
        return (
          <SideNavItem textValue={item.title} href={item.href}>
            <SideNavItemContent>
              {/*- begin highlight -*/}
              {
                item.href ? <SideNavItemLink render={props => <RouterLink {...props} />}>
  ...
  {({selectedRoute}) => (
    ...
    {/*- end highlight -*/}
      <SideNavItem href="/files" textValue="Files">
        <SideNavItemContent>
          <SideNavItemLink render={props => <RouterLink {...props} />}>
            <Files />
            <Text>Files</Text>
          </SideNavItemLink>
        </SideNavItemContent>
...
To integrate with a client side router, use the `renderLink` prop on `SideNavItemLink` to delegate to your router's link component. This supports features like prefetching on hover and avoids full page reloads.
...
<ExampleSwitcher type="framework" examples={['Next.js', 'React Router']}>
  ...
  function Sidebar() {
    ...
    return (
      <SideNav aria-label="Files" selectedRoute={selectedRoute}>
        <SideNavItem href="/files" textValue="Files">
          <SideNavItemContent>
            <SideNavItemLink render={props => <NextLink {...props} />}>
              <Text>Files</Text>
            </SideNavItemLink>
          </SideNavItemContent>
        </SideNavItem>
  ...
  function Sidebar() {
    ...
    return (
      <SideNav aria-label="Files" selectedRoute={pathname}>
        <SideNavItem href="/files" textValue="Files">
          <SideNavItemContent>
            <SideNavItemLink render={props => <RouterLink {...props} to={props.href} />}>
              <Text>Files</Text>
            </SideNavItemLink>
          </SideNavItemContent>
        </SideNavItem>
