...
Use the `value` or `defaultValue` prop to set the time value, using objects in the [@internationalized/date](../internationalized/date/) package. `TimeField` accepts plain [Time](../internationalized/date/Time), [CalendarDateTime](../internationalized/date/CalendarDateTime), or [ZonedDateTime](../internationalized/date/ZonedDate), but only displays the time.
