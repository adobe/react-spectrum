...
- Update [style props](https://react-spectrum.adobe.com/react-spectrum/styling#style-props) to use the style macro instead. See the 'Style props' section below
...
React Spectrum v3 supported a limited set of [style props](https://react-spectrum.adobe.com/react-spectrum/styling#style-props) for layout and positioning using Spectrum-defined values. Usage of these should be updated to instead use the style macro.
