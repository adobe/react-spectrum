...
<Command command="npx skills add https://react-spectrum.adobe.com --skill react-spectrum-v3-to-s2-migration --skill react-spectrum-s2" />

Then ask your agent to use the `react-spectrum-v3-to-s2-migration` skill to migrate your project.
