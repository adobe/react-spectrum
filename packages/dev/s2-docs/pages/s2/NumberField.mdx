...
<Provider/* PROPS */>
  <NumberField label="Value" defaultValue={1024} placeholder="Desired value" />
</Provider>
```
...
```tsx render docs={docs.exports.NumberField} links={docs.links} props={['isRequired', 'necessityIndicator']} initialProps={{isRequired: true, placeholder: 'e.g. 10'}} type="s2"
"use client";
