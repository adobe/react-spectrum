...
let messages = [
  ...
  {id: 4, type: 'assistant', text: 'Email drove the most conversions, with social close behind.'}
];
...
```tsx links={{Chat: '#chat', Thread: '#thread', ThreadItem: '#threaditem', ThreadLoadMoreItem: '#threadloadmoreitem', ThreadScrollButton: '#threadscrollbutton', UserMessage: '#usermessage'}}
<Chat>
  <Thread>
    <ThreadItem>
