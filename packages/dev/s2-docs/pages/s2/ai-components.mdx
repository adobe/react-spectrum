...
import {Collection, Content, SubmenuTrigger, Menu, MenuItem, MenuSection, Header, Heading, Text} from '@react-spectrum/s2';
...
function Example(args) {
  ...
  return (
    <div className={style({height: 600, width: 'full', backgroundColor: 'layer-2'})}>
