...
thumbnails within a `UserMessage`. Unlike `PromptFieldAttachmentList`, it is display-only and does
not support selection or removal.

```tsx links={{AttachmentGrid: '#attachmentgrid', AttachmentGridItem: '#attachmentgriditem', AttachmentPreview: '#attachmentpreview'}}
<AttachmentGrid aria-label="Uploaded files">
  <AttachmentGridItem aria-label="file.pdf">
    <AttachmentPreview mimeType="application/pdf" slot="thumbnail" src={src} />
  </AttachmentGridItem>
</AttachmentGrid>
```

<PropTable component={docs.exports.AttachmentGrid} links={docs.links} showDescription />

#### AttachmentGridItem

<PropTable component={docs.exports.AttachmentGridItem} links={docs.links} showDescription />
...
```tsx links={{PromptField: '#promptfield', PromptFieldAttachmentList: '#promptfieldattachmentlist', PromptTokenField: '#prompttokenfield', PromptFieldToolbar: '#promptfieldtoolbar'}}
<PromptField>
  <PromptFieldAttachmentList />
  <PromptTokenField />
  <PromptFieldToolbar />
