...
import {Button as VanillaButton} from 'vanilla-starter/src/Button';
import {Button as TailwindButton} from 'tailwind-starter/src/Button';
import {Button as MacroButton} from './ButtonExample';
import tailwindDocs from 'docs:tailwind-starter/src/Button';
import '../tailwind/tailwind.css';
import 'vanilla-starter/src/Button.css';
...
Each of these handlers receives a <TypeLink links={typesDocs.links} type={typesDocs.exports.PressEvent} />, which exposes information about the target and the type of event that triggered the interaction. 
