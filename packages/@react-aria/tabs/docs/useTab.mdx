...
These hooks handle some aspects of internationalization automatically. For example, keyboard navigation left right is automatically swapped for RTL languages. You are responsible for localizing all tab labels and content.
