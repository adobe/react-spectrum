...
* Contains focus inside the dialog, preventing the user from tabbing outside
* Restores focus to the triggering element on unmount
* May be used within a [modal](useModalOverlay.html), [popover](usePopover.html), or other types of overlays
...
import {useOverlayTrigger, useModalOverlay, OverlayContainer} from '@react-aria/overlays';
