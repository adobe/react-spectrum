...
import {isCtrlKeyPressed, isMetaKeyPressed, isNonContiguousSelectionModifier} from './utils';
...
export function useSelectableItem(options: SelectableItemOptions): SelectableItemAria {
  ...
  let onSelect = (e: PressEvent | LongPressEvent | PointerEvent) => {
    if (e.pointerType === 'keyboard' && isNonContiguousSelectionModifier(e)) {
      ...
      } else if (manager.selectionBehavior === 'toggle' || isCtrlKeyPressed(e) || isMetaKeyPressed(e) || (e && (e.pointerType === 'touch' || e.pointerType === 'virtual'))) {
