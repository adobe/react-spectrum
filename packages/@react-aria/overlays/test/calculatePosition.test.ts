...
describe('calculatePosition', function () {
  ...
  testCases.forEach(function (testCase) {
    ...
    describe(`placement = ${placement}`, function () {
      ...
      describe.only('viewport offset before', function () {
        checkPosition(
  ...
  // describe.skip('flip from left to right', function () {
  //   checkPosition(
