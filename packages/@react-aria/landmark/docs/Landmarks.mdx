...
import Anatomy from './landmarkAnatomy.svg'
...
<TypeContext.Provider value={docs.links}>
  <InterfaceType properties={docs.links[docs.exports.useLandmark.return.id].properties} />
...
<TypeLink links={docs.links} type={docs.exports.useLandmark} />
