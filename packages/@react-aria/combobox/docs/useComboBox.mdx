...
<TypeContext.Provider value={docs.links}>
  <InterfaceType properties={docs.links[docs.exports.useComboBox.return.base.id].properties} />
...
and [useListBox](useListBox.html) that you may already have in your component library. These can be shared with other
...
<details>
  <summary><ChevronRight size="S" /> <strong>Show code</strong></summary>
...
<ExampleCard
  ...
  title="Material UI"
  description="An example combo box built with Material UI and React Aria." />
