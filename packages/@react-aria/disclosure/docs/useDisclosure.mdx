...
* Uses [hidden="until-found"](https://developer.mozilla.org/en-US/docs/Web/HTML/Global_attributes/hidden#the_hidden_until_found_state) in supported browsers
...
See the docs for [useDisclosureGroupState](../react-stately/useDisclosureGroupState.html) in react-stately for an example of a disclosure group.
