...
import Anatomy from './listAnatomy.svg'
...
<TypeContext.Provider value={docs.links}>
  <InterfaceType properties={docs.links[docs.exports.useList.return.id].properties} />
...
<TypeLink links={docs.links} type={docs.exports.useList} />
