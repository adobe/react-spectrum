...
most of the builtin strings are for non-visible things like accessibility labels. All application provided content must be localized
and passed in to components. This can be done with many libraries, e.g. [react-intl](https://formatjs.io/docs/react-intl) or others.
...
Since React Aria provides no rendering, it is up to you to implement RTL support in your design. The documentation for individual components
calls out when you need to be aware of this this, so you can account for it in your CSS using 
