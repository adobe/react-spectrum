...
import {filterDOMProps, FormValidationResult, mergeProps, useDescription, useId, useFormValidationState, chain} from '@react-aria/utils';
// @ts-ignore
...
export interface DatePickerAria extends FormValidationResult {
