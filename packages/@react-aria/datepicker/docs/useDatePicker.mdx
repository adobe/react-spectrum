...
The `Dialog` component is rendered within the `Popover` component. It is built using the [useDialog](../Dialog/useDialog.html) hook, and can be shared with many other components.
