...
interface EventPoint {
  /**
   * [Mouse]{@link https://developer.mozilla.org/en-US/docs/Web/API/MouseEvent/clientX} or [Touch]{@link https://developer.mozilla.org/en-US/docs/Web/API/Touch/clientX} clientX.
   */
  clientX: number,
  /**
   * [Mouse]{@link https://developer.mozilla.org/en-US/docs/Web/API/MouseEvent/clientY} or [Touch]{@link https://developer.mozilla.org/en-US/docs/Web/API/Touch/clientY} clientY.
   */
  clientY: number
}
