    ...
    let pressProps: DOMAttributes = {
      ...
      onClick(e) {
        ...
        if (e && e.button === 0) {
          ...
          // is retargeted from a label node https://developer.mozilla.org/en-US/docs/Web/API/Event/explicitOriginalTarget;
          // treat that similarly as a click (and double check if label is associated with original target)
