...
then we have <TypeLink links={docs.links} type={docs.exports.addWindowFocusTracking} /> which can attach our
event listeners inside the iframe. You should call this function with an element inside the window you wish to add.
We'll retrieve the relevant elements based on that.
