...
import docs from 'docs:@react-aria/cards';
import {HeaderInfo, FunctionAPI, TypeContext, InterfaceType, TypeLink} from '@react-spectrum/docs';
import packageData from '@react-aria/cards/package.json';
import Anatomy from './cardsAnatomy.svg'
...
<FunctionAPI function={docs.exports.useCard} links={docs.links} />
...
<TypeContext.Provider value={docs.links}>
  <InterfaceType properties={docs.links[docs.exports.useCard.return.id].properties} />
...
<TypeLink links={docs.links} type={docs.exports.useCard} />
