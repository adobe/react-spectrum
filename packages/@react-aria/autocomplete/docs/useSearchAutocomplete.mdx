  ...
  return (
    <div style={{display: 'inline-flex', flexDirection: 'column'}}>
      ...
      <div style={{position: 'relative', display: 'inline-block'}}>
        ...
        {state.isOpen &&
          <Popover state={state} triggerRef={inputRef} popoverRef={popoverRef} placement="bottom start">
            <ListBox
              {...listBoxProps}
...
import {usePopover, OverlayContainer, DismissButton} from '@react-aria/overlays';
...
function PopoverInner({children, state, ...props}) {
