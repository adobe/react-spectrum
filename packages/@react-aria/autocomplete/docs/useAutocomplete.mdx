...
import Anatomy from './autocompleteAnatomy.svg'
...
<p>{docs.exports.useAutocomplete.description}</p>
...
<TypeContext.Provider value={docs.links}>
  <InterfaceType properties={docs.links[docs.exports.useAutocomplete.return.id].properties} />
...
<TypeLink links={docs.links} type={docs.exports.useAutocomplete} />
