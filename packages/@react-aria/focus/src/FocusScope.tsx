      ...
      return () => {
        ...
        if (
          (scopeRef === activeScope ||
            isAncestorScope(scopeRef, activeScope)) &&
...
function createFocusManagerForScope(
  scopeRef: React.RefObject<Element[]>
): FocusManager {
  return {
...
function useRestoreFocus(
  ...
  useLayoutEffect(() => {
    ...
    let onKeyDown = (e: KeyboardEvent) => {
      ...
      if (
        (!nextElement || !isElementInScope(nextElement, scopeRef.current)) &&
        nodeToRestore
      ) {
          ...
          if (document.activeElement === document.body) {
            ...
            while (treeNode) {
              if (
                ...
                document.body.contains(treeNode.nodeToRestore)
              ) {
