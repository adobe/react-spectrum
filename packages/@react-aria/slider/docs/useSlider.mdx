...
one or more thumb thumbs showing the current values, and a label.
Thumbs can be dragged to allow a user to change their value. In addition, the
  ...
  return (
    <div
      ...
      <div style={{display: 'flex', alignSelf: 'stretch'}}>
        ...
        <div style={{flex: '1 0 auto', textAlign: 'end'}}>
