...
<Table aria-label="Example static collection table" style={{height: '200px'}}>
  <TableHeader>
    <Column>Name</Column>
    <Column>Type</Column>
...
function Example() {
  ...
  return (
    <Table aria-label="Example dynamic collection table" style={{height: '200px'}}>
...
### Async
// show dynamic
// show single selection, no selection, multiple selection
// show sorting
// show async
