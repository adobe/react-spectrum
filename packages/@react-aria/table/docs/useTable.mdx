...
The various style changes below are to make the table itself scrollable and to support table body/column widths greater than the 300px applied to the table itself.
    ...
    switch (key) {
      ...
      case 'resize':
        ...
        if (resizerRef) {
          ...
          setTimeout(() => resizerRef.current?.focus(), 400);
        }
        break;
    }
  };
  ...
  return (
    <div
      ...
      style={{
        ...
        borderColor: layoutState.resizingColumn === column.key ? 'blue' : 'grey',
        touchAction: 'none',
        flex: '0 0 auto',
        boxSizing: 'border-box',
