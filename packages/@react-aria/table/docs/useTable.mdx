...
import {HeaderInfo, FunctionAPI, TypeContext, InterfaceType, TypeLink, PageDescription, VersionBadge} from '@react-spectrum/docs';
...
## Resizable Columns <VersionBadge version="rc" style={{marginLeft: 4, verticalAlign: 'bottom'}} />
