...
combined with [useMenu](useMeun.html) helps achieve accessible menu components that can be styled as needed.
...
is added at the start end end of the menu to allow screen reader users to dismiss it easily.

This example does not do any advanced popover positioning or portaling to escape its visual container.
See <TypeLink links={overlaysDocs.links} type={overlaysDocs.exports.useOverlayPosition} /> for 
...
function MenuPopup(props) {
  ...
  // <DismissButton> components at the start end end of the list
