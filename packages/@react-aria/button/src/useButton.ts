...
export function useButton(props: AriaButtonOptions<ElementType>, ref: RefObject<any>): ButtonAria<HTMLAttributes<any>> {
  let {
    ...
    preventFocusOnPress: preventFocusOnPressProps,
    // @ts-ignore - undocumented
  ...
  let [clickByUser, setClickByUser] = useState(false);
  let [preventFocusOnPress, setPreventFocusOnPress] = useState(false);
  ...
  let {pressProps, isPressed} = usePress({
    ...
    onPressUp,
    isDisabled,
    preventFocusOnPress: preventFocusOnPressProps !== undefined ? preventFocusOnPressProps : preventFocusOnPress,
    ref
  });
  ...
  useEffect(() => {
    ...
    function onClick(e: MouseEvent) {
      ...
      // this if-statement is to test whether the click event was generated by an implicit form submission triggered by the user pressing `Enter` key
      // more info on this: https://html.spec.whatwg.org/#implicit-submission
      if (button.type === 'submit' && button.form && !clickByUser) {
        setPreventFocusOnPress(true);
      }
      setClickByUser(false);
    }
