...
async function main() {
  console.log(boxen(
    ...
    'This tool will:\n\n' +
    `1. Install the ${chalk.bold('@react/experimental-s2')} package and setup your bundler to use the Spectrum 2 style macro.\n\n` +
  ...
  // Install S2 package
  let isS2PackageInstalled = await installPackage('@react/experimental-s2');
  ...
  let nextSteps = [
    ...
    `${chalk.bold('import \'@react/experimental-s2/page.css\';')}\n\n` +
    'Note that unlike React Spectrum v3, a Provider is not required.'
  ];

  if (!isS2PackageInstalled) {
    nextSteps.unshift(`Install the ${chalk.bold('@react/experimental-s2')} package manually.`);
  }
  ...
  if (!isMacroSupportEnabled) {
    nextSteps.push(
      ...
      `  - Webpack: ${chalk.underline('https://git.corp.adobe.com/React/experimental-s2/tree/main/examples/webpack-5-example')}\n` +
      `  - Next.js: ${chalk.underline('https://git.corp.adobe.com/React/experimental-s2/tree/main/examples/next-macros')}\n` +
      `  - Vite: ${chalk.underline('https://git.corp.adobe.com/React/experimental-s2/tree/main/examples/vite-project')}\n` +
      `  - Rollup: ${chalk.underline('https://git.corp.adobe.com/React/experimental-s2/tree/main/examples/rollup-starter-app')}\n` +
      `  - ESBuild: ${chalk.underline('https://git.corp.adobe.com/React/experimental-s2/tree/main/examples/esbuild-starter-app')}\n\n` +
  ...
  nextSteps.push(
    ...
    `For additional help, reference the Spectrum 2 Migration Guide: ${chalk.underline('https://git.corp.adobe.com/React/experimental-s2/upgrade-cli/UPGRADE.md')}`
  );
