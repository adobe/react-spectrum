 ...
 */
export const Well:
  React.ForwardRefExoticComponent<SpectrumWellProps & React.RefAttributes<DOMRefValue<HTMLDivElement>>> =
forwardRef(function Well(props: SpectrumWellProps, ref: DOMRef<HTMLDivElement>) {
  let {
    children,
    role,
    ...otherProps
