...
describe('FieldLabel', () => {
  ...
  describe('with label', () => {
    ...
    it.each`
      ...
      ${'v2 FieldLabel no children'}       | ${V2FieldLabel} | ${0}        | ${{necessity: 'required', necessityIndicator: 'icon'}}
      ${'v3 FieldLabel one child'}         | ${FieldLabel}   | ${1}        | ${{isRequired: true, necessityIndicator: 'icon'}}
      ${'v2 FieldLabel one child'}         | ${V2FieldLabel} | ${1}        | ${{necessity: 'required', necessityIndicator: 'icon'}}
