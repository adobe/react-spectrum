...
export const FormTranslatedText = (props) => <TranslateForm {...props} />;

export const FormTranslatedTextSideLabel = () => {
  return (
    <FormTranslatedText labelPosition="side" labelAlign="start" width="500px" />
  );
};
