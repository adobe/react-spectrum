...
//   <Button fillStyle="outline" variant="secondary">Previous</Button>);
//
// export const Indicator = (args: any) => (<CoachIndicator {...args}><div style={{width: 100, height: 100}} /></CoachIndicator>);
export const IndicatorButton = (args: any) => (<CoachIndicator elementType="button" {...args}>
  <Button>
    Apply
  </Button>
</CoachIndicator>);

export const IndicatorActionButton = (args: any) => (<CoachIndicator {...args}>
  <ActionButton>
    <Filter />
  </ActionButton>
</CoachIndicator>);

export const IndicatorToolbar = (args: any) => (<CoachIndicator {...args}>
  <Toolbar orientation="vertical">
    <ActionButton isQuiet>
      <TextIcon />
    </ActionButton>
...
export const IndicatorSlider = (args: any) => (<CoachIndicator offset="L" {...args}>
  <Slider label="Horizontal position" labelPosition="top" />
</CoachIndicator>);

export const IndicatorCheckbox = (args: any) => (<CoachIndicator isActive elementType="checkbox" offset="M" {...args}>
  <Checkbox>Sync with CC</Checkbox>
</CoachIndicator>);
