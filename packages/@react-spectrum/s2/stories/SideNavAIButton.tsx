...
import {
  ...
  defineProperties,
  token
} from '../../ai/src/tokens.macro' with {type: 'macro'};
...
import {mergeStyles} from '../exports';
 ...
 */
export function AIButton({size = 'M', brandColor, children, styles, ...otherProps}: AIButtonProps) {
  let ref = useRef<HTMLButtonElement | null>(null);
  return (
    <Button
      {...otherProps}
      ref={ref}
      className={renderProps => bg + mergeStyles(button({size, ...renderProps}), styles)}
