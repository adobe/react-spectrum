...
export const TextFieldWithAddons: StoryTextField = {
  render: (args) => (
    <Form>
      ...
      <TextField {...args} label="User" prefix={<Avatar size={20} src="https://i.imgur.com/xIe7Wlb.png" />} placeholder="username" />
      <TextField {...args} label="Color" prefix={<ColorSwatch size="XS" color="rgb(255, 0, 255)" />} placeholder="#FF00FF" />
      <Button type="submit" variant="primary">Submit</Button>
    </Form>
  ),
  args: {
