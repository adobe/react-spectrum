...
import {Button, ButtonGroup, Checkbox, Content, DialogContainer, DialogTrigger, Footer, Header, Heading, Image, Provider, StandardDialog} from '../src';
import type {Meta} from '@storybook/react';
import {style} from '../style/spectrum-theme' with {type: 'macro'};
import {useState} from 'react';

const meta: Meta<typeof StandardDialog> = {
  component: StandardDialog as any,
  parameters: {
    layout: 'centered',
    docs: {
