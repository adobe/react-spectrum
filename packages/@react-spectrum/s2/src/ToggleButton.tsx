...
export const ToggleButtonContext: Context<ContextValue<Partial<ToggleButtonProps>, FocusableRefValue<HTMLButtonElement>>> = createContext<ContextValue<Partial<ToggleButtonProps>, FocusableRefValue<HTMLButtonElement>>>(null);
