...
export function Divider(props: SeparatorProps): ReactElement {
  return (
    <Separator
      {...props}
...
export function MenuSection<T extends object>(props: MenuSectionProps<T>): ReactElement {
 ...
 */
function MenuTrigger(props: MenuTriggerProps): ReactElement {
...
export function CombinedMenu<T extends object>(props: ICombined<T>): ReactElement {
  return <div />;
}
