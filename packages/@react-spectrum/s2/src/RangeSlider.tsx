...
import { ContextValue, SliderThumb, SliderTrack } from "react-aria-components";
...
export interface RangeSliderProps
  extends Omit<SliderBaseProps<RangeValue<number>>, "children"> {
  /**
...
export const RangeSliderContext =
  createContext<
    ContextValue<Partial<RangeSliderProps>, FocusableRefValue<HTMLDivElement>>
  >(null);
