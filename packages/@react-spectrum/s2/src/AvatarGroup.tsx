...
import {Context, createContext, CSSProperties, forwardRef, ForwardRefExoticComponent, RefAttributes, ReactNode} from 'react';
...
export const AvatarGroupContext: Context<ContextValue<Partial<AvatarGroupProps>, DOMRefValue<HTMLDivElement>>> = createContext<ContextValue<Partial<AvatarGroupProps>, DOMRefValue<HTMLDivElement>>>(null);
