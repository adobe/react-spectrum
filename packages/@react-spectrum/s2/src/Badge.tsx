...
import React, {Context, createContext, forwardRef, ForwardRefExoticComponent, ReactNode, RefAttributes} from 'react';
...
export const BadgeContext: Context<ContextValue<Partial<BadgeProps>, DOMRefValue<HTMLDivElement>>> = createContext<ContextValue<Partial<BadgeProps>, DOMRefValue<HTMLDivElement>>>(null);
 ...
 */
export const Badge:
  ForwardRefExoticComponent<BadgeProps & RefAttributes<DOMRefValue<HTMLDivElement>>> =
