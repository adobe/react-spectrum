...
export const AccordionContext: Context<ContextValue<Partial<AccordionProps>, DOMRefValue<HTMLDivElement>>> = createContext<ContextValue<Partial<AccordionProps>, DOMRefValue<HTMLDivElement>>>(null);
