...
export const ToggleButtonGroupContext: Context<ContextValue<Partial<ToggleButtonGroupProps>, HTMLDivElement>> = createContext<ContextValue<Partial<ToggleButtonGroupProps>, HTMLDivElement>>(null);
