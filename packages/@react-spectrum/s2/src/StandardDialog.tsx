...
export interface StandardDialogProps extends Omit<RACDialogProps, 'className' | 'style'>, StyleProps {
  /**
...
function StandardDialog(props: StandardDialogProps, ref: DOMRef) {
 ...
 */
let _StandardDialog = forwardRef(StandardDialog);
export {_StandardDialog as StandardDialog};
