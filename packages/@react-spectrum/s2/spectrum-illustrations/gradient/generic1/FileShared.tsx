...
export default function FileShared(props: IconProps & {size?: 'L' | 'S' | 'M'}) {
  [props] = useContextProps(props, null, IllustrationContext);
  let {size = 'M', ...otherProps} = props;
  switch (size) {
    case 'L':
      return <FileShared_L {...otherProps} />;
    case 'S':
      return <FileShared_S {...otherProps} />;
    case 'M':
      return <FileShared_M {...otherProps} />;
  }
}
