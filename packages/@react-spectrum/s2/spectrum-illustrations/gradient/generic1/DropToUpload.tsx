...
export default function DropToUpload(props: IconProps & {size?: 'L' | 'S' | 'M'}) {
  [props] = useContextProps(props, null, IllustrationContext);
  let {size = 'M', ...otherProps} = props;
  switch (size) {
    case 'L':
      return <DropToUpload_L {...otherProps} />;
    case 'S':
      return <DropToUpload_S {...otherProps} />;
    case 'M':
      return <DropToUpload_M {...otherProps} />;
  }
}
