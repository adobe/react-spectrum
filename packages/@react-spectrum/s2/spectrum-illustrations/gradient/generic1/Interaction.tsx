...
export default function Interaction(props: IconProps & {size?: 'L' | 'S' | 'M'}) {
  [props] = useContextProps(props, null, IllustrationContext);
  let {size = 'M', ...otherProps} = props;
  switch (size) {
    case 'L':
      return <Interaction_L {...otherProps} />;
    case 'S':
      return <Interaction_S {...otherProps} />;
    case 'M':
      return <Interaction_M {...otherProps} />;
  }
}
