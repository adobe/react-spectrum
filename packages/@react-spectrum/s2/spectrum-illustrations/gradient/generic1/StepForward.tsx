...
export default function StepForward(props: IconProps & {size?: 'L' | 'S' | 'M'}) {
  [props] = useContextProps(props, null, IllustrationContext);
  let {size = 'M', ...otherProps} = props;
  switch (size) {
    case 'L':
      return <StepForward_L {...otherProps} />;
    case 'S':
      return <StepForward_S {...otherProps} />;
    case 'M':
      return <StepForward_M {...otherProps} />;
  }
}
