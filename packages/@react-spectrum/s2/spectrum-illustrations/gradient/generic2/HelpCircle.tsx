...
export default function HelpCircle(props: IconProps & {size?: 'L' | 'S' | 'M'}) {
  [props] = useContextProps(props, null, IllustrationContext);
  let {size = 'M', ...otherProps} = props;
  switch (size) {
    case 'L':
      return <HelpCircle_L {...otherProps} />;
    case 'S':
      return <HelpCircle_S {...otherProps} />;
    case 'M':
      return <HelpCircle_M {...otherProps} />;
  }
}
