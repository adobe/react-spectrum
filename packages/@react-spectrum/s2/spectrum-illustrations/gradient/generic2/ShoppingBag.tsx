...
export default function ShoppingBag(props: IconProps & {size?: 'L' | 'S' | 'M'}) {
  [props] = useContextProps(props, null, IllustrationContext);
  let {size = 'M', ...otherProps} = props;
  switch (size) {
    case 'L':
      return <ShoppingBag_L {...otherProps} />;
    case 'S':
      return <ShoppingBag_S {...otherProps} />;
    case 'M':
      return <ShoppingBag_M {...otherProps} />;
  }
}
