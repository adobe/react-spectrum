...
export default function GraphBarChart(props: IconProps & {size?: 'L' | 'S' | 'M'}) {
  [props] = useContextProps(props, null, IllustrationContext);
  let {size = 'M', ...otherProps} = props;
  switch (size) {
    case 'L':
      return <GraphBarChart_L {...otherProps} />;
    case 'S':
      return <GraphBarChart_S {...otherProps} />;
    case 'M':
      return <GraphBarChart_M {...otherProps} />;
  }
}
