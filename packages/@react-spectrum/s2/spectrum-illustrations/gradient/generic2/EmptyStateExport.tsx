...
export default function EmptyStateExport(props: IconProps & {size?: 'L' | 'S' | 'M'}) {
  [props] = useContextProps(props, null, IllustrationContext);
  let {size = 'M', ...otherProps} = props;
  switch (size) {
    case 'L':
      return <EmptyStateExport_L {...otherProps} />;
    case 'S':
      return <EmptyStateExport_S {...otherProps} />;
    case 'M':
      return <EmptyStateExport_M {...otherProps} />;
  }
}
