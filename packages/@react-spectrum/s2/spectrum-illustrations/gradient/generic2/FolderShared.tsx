...
export default function FolderShared(props: IconProps & {size?: 'L' | 'S' | 'M'}) {
  [props] = useContextProps(props, null, IllustrationContext);
  let {size = 'M', ...otherProps} = props;
  switch (size) {
    case 'L':
      return <FolderShared_L {...otherProps} />;
    case 'S':
      return <FolderShared_S {...otherProps} />;
    case 'M':
      return <FolderShared_M {...otherProps} />;
  }
}
