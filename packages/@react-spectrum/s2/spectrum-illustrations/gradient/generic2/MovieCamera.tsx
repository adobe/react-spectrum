...
export default function MovieCamera(props: IconProps & {size?: 'L' | 'S' | 'M'}) {
  [props] = useContextProps(props, null, IllustrationContext);
  let {size = 'M', ...otherProps} = props;
  switch (size) {
    case 'L':
      return <MovieCamera_L {...otherProps} />;
    case 'S':
      return <MovieCamera_S {...otherProps} />;
    case 'M':
      return <MovieCamera_M {...otherProps} />;
  }
}
