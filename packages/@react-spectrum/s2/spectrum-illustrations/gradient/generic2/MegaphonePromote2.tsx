...
export default function MegaphonePromote2(props: IconProps & {size?: 'L' | 'S' | 'M'}) {
  [props] = useContextProps(props, null, IllustrationContext);
  let {size = 'M', ...otherProps} = props;
  switch (size) {
    case 'L':
      return <MegaphonePromote2_L {...otherProps} />;
    case 'S':
      return <MegaphonePromote2_S {...otherProps} />;
    case 'M':
      return <MegaphonePromote2_M {...otherProps} />;
  }
}
