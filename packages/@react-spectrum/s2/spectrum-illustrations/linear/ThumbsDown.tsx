...
export default function ThumbsDown(props: IconProps & {size?: 'L' | 'S' | 'M'}) {
  [props] = useContextProps(props, null, IllustrationContext);
  let {size = 'M', ...otherProps} = props;
  switch (size) {
    case 'L':
      return <ThumbsDown_L {...otherProps} />;
    case 'S':
      return <ThumbsDown_S {...otherProps} />;
    case 'M':
      return <ThumbsDown_M {...otherProps} />;
  }
}
