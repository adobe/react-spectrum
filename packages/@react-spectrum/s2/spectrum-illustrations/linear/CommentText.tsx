...
export default function CommentText(props: IconProps & {size?: 'L' | 'S' | 'M'}) {
  [props] = useContextProps(props, null, IllustrationContext);
  let {size = 'M', ...otherProps} = props;
  switch (size) {
    case 'L':
      return <CommentText_L {...otherProps} />;
    case 'S':
      return <CommentText_S {...otherProps} />;
    case 'M':
      return <CommentText_M {...otherProps} />;
  }
}
