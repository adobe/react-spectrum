...
export default function NoSharedFile(props: IconProps & {size?: 'L' | 'S' | 'M'}) {
  [props] = useContextProps(props, null, IllustrationContext);
  let {size = 'M', ...otherProps} = props;
  switch (size) {
    case 'L':
      return <NoSharedFile_L {...otherProps} />;
    case 'S':
      return <NoSharedFile_S {...otherProps} />;
    case 'M':
      return <NoSharedFile_M {...otherProps} />;
  }
}
