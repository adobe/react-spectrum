...
export default function CloudStateDisconnected(
  ...
  switch (size) {
    case 'L':
      return <CloudStateDisconnected_L {...otherProps} />;
    case 'S':
      return <CloudStateDisconnected_S {...otherProps} />;
    case 'M':
      return <CloudStateDisconnected_M {...otherProps} />;
  }
}
