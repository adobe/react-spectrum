...
export default function ReportAbuse(props: IconProps & {size?: 'L' | 'S' | 'M'}) {
  [props] = useContextProps(props, null, IllustrationContext);
  let {size = 'M', ...otherProps} = props;
  switch (size) {
    case 'L':
      return <ReportAbuse_L {...otherProps} />;
    case 'S':
      return <ReportAbuse_S {...otherProps} />;
    case 'M':
      return <ReportAbuse_M {...otherProps} />;
  }
}
