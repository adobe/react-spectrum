...
export default function NoLibraries(props: IconProps & {size?: 'L' | 'S' | 'M'}) {
  [props] = useContextProps(props, null, IllustrationContext);
  let {size = 'M', ...otherProps} = props;
  switch (size) {
    case 'L':
      return <NoLibraries_L {...otherProps} />;
    case 'S':
      return <NoLibraries_S {...otherProps} />;
    case 'M':
      return <NoLibraries_M {...otherProps} />;
  }
}
