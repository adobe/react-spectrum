...
export default function InfiniteLooping(props: IconProps & {size?: 'L' | 'S' | 'M'}) {
  [props] = useContextProps(props, null, IllustrationContext);
  let {size = 'M', ...otherProps} = props;
  switch (size) {
    case 'L':
      return <InfiniteLooping_L {...otherProps} />;
    case 'S':
      return <InfiniteLooping_S {...otherProps} />;
    case 'M':
      return <InfiniteLooping_M {...otherProps} />;
  }
}
