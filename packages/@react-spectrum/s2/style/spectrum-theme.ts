...
export const {spacing: baseSpacing, padding: basePadding} = generateSpacing([
  0,
  2, // spacing-50
  4, // spacing-75
  8, // spacing-100
...
export const {spacing: negativeSpacing, padding: negativePadding} = generateSpacing([
  -2, // spacing-50
  -4, // spacing-75
  -8, // spacing-100
  -12, // spacing-200
...
export const style = createTheme(themeProperties as any);
