...
export const style = createTheme({
  properties: {
    ...
    fill: new SpectrumColorProperty('fill', {
      ...
      'bg-neutral': colorToken('neutral-background-color-default'),
      'bg-negative': weirdColorToken('negative-background-color-default'),
      'bg-informative': weirdColorToken('informative-background-color-default'),
