...
function CustomLayout(props) {
  ...
  return (
    <CardView items={items} layout={layout} width="800px" height="500px" aria-label="CardView with modified GridLayout" {...otherProps}>
      {item => (
...
// TODO add example for multiple selection mode
...
// TODO add example for disallowEmptySelection selection mode
...
// TODO add example for disabled cards
...
### Quiet
Talk about which Card layouts allow quiet
