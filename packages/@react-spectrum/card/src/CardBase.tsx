...
export const CardBase = React.forwardRef(function CardBase<T extends object>(
  ...
  let hasPreviewImage = useHasChild(
    `.${styles["spectrum-Card-image"]}`,
    gridRef
  );
  let hasPreviewIllustration = useHasChild(
    `.${styles["spectrum-Card-illustration"]}`,
    gridRef
  );
  ...
  let slots = useMemo(
    () => ({
      ...
      heading: {
        UNSAFE_className: classNames(styles, "spectrum-Card-heading"),
        ...titleProps,
      },
      content: {
        UNSAFE_className: classNames(styles, "spectrum-Card-content"),
        ...contentProps,
      },
      ...
      >
        <div ref={gridRef} className={classNames(styles, "spectrum-Card-grid")}>
          {manager && manager.selectionMode !== "none" && (
            <div
              className={classNames(styles, "spectrum-Card-checkboxWrapper")}
            >
              <Checkbox
                ref={checkboxRef}
