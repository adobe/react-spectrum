...
export const CardGrid: CardStory = {
  ...
  args: { layout: "grid" },
  decorators: [
    (Story, context) => <CardGridDecorator Story={Story} context={context} />,
  ],
};
...
export const CardWaterfall: CardStory = {
  ...
  decorators: [
    (Story, context) => (
      <CardWaterfallDecorator Story={Story} context={context} />
    ),
  ],
};
...
export const CardFloat: CardStory = {
  render: (args, context) => <Card {...args} {...context} id={null} />,
  decorators: [
    (Story, context) => <CardFloatDecorator Story={Story} context={context} />,
  ],
};
...
export const CardGridMessyText: CardStory = {
  ...
  decorators: [
    (Story, context) => (
      <CardGridMessyTextDecorator Story={Story} context={context} />
    ),
  ],
};
        ...
        return (
          ...
          >
            <Story {...args}>
              <Image src={url} />
              <Heading>
                {index} Rechtsschutzversicherungsgesellschaften
...
export const CardWaterfallMessyText: CardStory = {
  ...
  decorators: [
    (Story, context) => (
      <CardWaterfallMessyTextDecorator Story={Story} context={context} />
    ),
  ],
};
...
export const CardGridNoPreview: CardStory = {
  ...
  decorators: [
    (Story, context) => (
      <CardGridNoPreviewDecorator Story={Story} context={context} />
    ),
  ],
};
...
export const CardWaterfallNoPreview: CardStory = {
  ...
  decorators: [
    (Story, context) => (
      <CardWaterfallNoPreviewDecorator Story={Story} context={context} />
    ),
  ],
};
