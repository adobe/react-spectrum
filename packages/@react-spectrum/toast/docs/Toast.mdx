...
Toasts can accept a `content` option as a ReactNode to display custom content. This can be used to display more complex content, such as a bold/italic text, or a link.
