...
function Multiple(
  options: SpectrumToastOptions & { placement: ToastPlacement }
) {
  ...
  return (
    ...
    >
      <UNSTABLE_PortalProvider getContainer={() => ref.current}>
        ...
        {isFullscreen && (
          <ToastContainer key="miniapp" placement={props.placement} />
        )}
      </UNSTABLE_PortalProvider>
      {!isFullscreen && (
        <ToastContainer key="app" placement={props.placement} />
      )}
    </div>
  );
}
