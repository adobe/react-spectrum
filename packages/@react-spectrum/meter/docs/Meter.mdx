...
```tsx example
<Flex flexDirection="column" maxWidth="size-3000">
  <Meter label="Label" marginBottom="size-300" value={25} variant="warning" />
  <Meter label="Label" marginBottom="size-300" labelPosition="side" value={25} variant="warning" />
...
<Flex flexDirection="column">
  <Meter label="Space used" marginBottom="size-300" size="S" value={90} variant="critical" />
...
```tsx example
<Flex flexDirection="column">
  <Meter label="Space used" marginBottom="size-300" value={25} variant="positive" />
  <Meter label="Space used" marginBottom="size-300" value={90} variant="critical" />
