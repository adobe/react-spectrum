...
<Flex>
  ...
  <Meter label="1 of 4" labelPosition="side" value={25} variant="warning" />
...
```tsx example
<Flex>
  <Meter label="Meter" size="S" value={90} variant="critical" />
...
```tsx example
<Flex>
  <Meter label="1 of 4" value={25} variant="positive" />
  <Meter label="1 of 4" value={25} variant="critical" />
  <Meter label="1 of 4" value={25} variant="warning" />
</Flex>
```
