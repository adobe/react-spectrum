...
<Flex flexDirection="column" maxWidth="275px">
  <Meter label="1 of 4" marginBottom="25px" value={25} variant="warning" />
  <Meter label="1 of 4" marginBottom="25px" labelPosition="side" value={25} variant="warning" />
  <Meter aria-label="1 of 4" showValueLabel={false} value={25} variant="warning" />
</Flex>
```
...
```tsx example
<Flex flexDirection="column">
  <Meter label="1 of 4" marginBottom="25px" value={25} variant="positive" />
  <Meter label="1 of 4" marginBottom="25px" value={25} variant="critical" />
  <Meter label="1 of 4" value={25} variant="warning" />
</Flex>
```
