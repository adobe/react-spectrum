...
The TooltipTrigger accepts exactly two children: the Tooltip and the element which triggers the display of the Tooltip. The trigger element must be the first child passed into the TooltipTrigger. All content should be internationalized.
