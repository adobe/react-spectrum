...
### Delay
The default delay time for a Tooltip can be adjusted. Setting `delay` to `0` will show the Tooltip instantly on hover. However when focusing, the Tooltip will always be shown instantly.
```tsx example
