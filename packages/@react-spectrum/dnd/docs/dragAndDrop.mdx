...
TODO: move this to an accessibility section, perhaps in the example section?
...
* drag types: standard mime types, custom application-specific types, providing data in multiple formats
* dragging multiple items at once
* drag previews
* drop operations: move, copy, link, cancel
* drop positions: on, between, root
* overall, at a very brief high level, how these all work across traditional dnd surfaces, keyboards, and screen readers
...
### Accessibility
The example above illustrates the drag and drop experience in React Spectrum. TODO talk about screen reader and keyboard accessiblity
