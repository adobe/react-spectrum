...
TODO: update below example with two ListViews once we support drop as well. Have it be drag from one into the other
A custom droppable input element is used in the example below.
<details>
