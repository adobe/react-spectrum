...
import DragPreview from '/packages/@react-aria/dnd/docs/DragPreview.svg';
import BetweenDropPosition from '/packages/@react-aria/dnd/docs/BetweenDropPosition.svg';
import OnDropPosition from '/packages/@react-aria/dnd/docs/OnDropPosition.svg';
import RootDropPosition from '/packages/@react-aria/dnd/docs/RootDropPosition.svg';
import DragAffordance from '/packages/@react-aria/dnd/docs/DragAffordance.svg';
import Anatomy from '/packages/@react-aria/dnd/docs/Anatomy.svg';
