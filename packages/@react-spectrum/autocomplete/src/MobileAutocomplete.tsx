...
export const MobileAutocomplete = React.forwardRef(function MobileAutocomplete<T extends object>(props: SpectrumAutocompleteProps<T>, ref: FocusableRef<HTMLElement>) {
...
interface AutocompleteButtonProps extends AriaButtonProps {
  isQuiet?: boolean,
  isDisabled?: boolean,
  isReadOnly?: boolean,
...
const AutocompleteButton = React.forwardRef(function AutocompleteButton(props: AutocompleteButtonProps, ref: RefObject<HTMLElement>) {
  let {
    isQuiet,
    isDisabled,
    isReadOnly,
...
interface AutocompleteTrayProps extends SpectrumAutocompleteProps<unknown> {
...
function AutocompleteTray(props: AutocompleteTrayProps) {
  let {
    state,
    isDisabled,
    validationState,
      ...
      <div
        ...
        <ListBoxBase
          ...
          renderEmptyState={() => loadingState !== 'loading' && (
            <span className={classNames(autocompleteStyles, 'no-results')}>
