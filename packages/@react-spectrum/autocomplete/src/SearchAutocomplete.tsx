...
let SearchAutocompleteBase = React.forwardRef(
...
function ForwardSearchAutocompleteInput<T>(
...
let SearchAutocompleteInput = React.forwardRef(
  ForwardSearchAutocompleteInput
) as <T>(
