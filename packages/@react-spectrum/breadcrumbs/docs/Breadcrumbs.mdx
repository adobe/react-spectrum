...
---
category: Navigation
keywords: [breadcrumbs, react-spectrum, collections]
---
...
To use `Breadcrumbs` as a heading, render a [Heading](Heading.html) component inside your `Item`. You may set the heading level by providing the `level` prop.
