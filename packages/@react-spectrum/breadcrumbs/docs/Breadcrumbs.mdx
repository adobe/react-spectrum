...
```tsx example
<Breadcrumbs>
  <Item uniqueKey="home">Home</Item>
  <Item uniqueKey="trendy">Trendy</Item>
  <Item uniqueKey="march 2020 assets">March 2020 Assets</Item>
</Breadcrumbs>
```
...
The `uniqueKey` prop from the pressed item will be passed to the callback.
...
<View overflow="hidden" width="200px">
  <Breadcrumbs showRoot maxVisibleItems="auto">
    <Item uniqueKey="home">Home</Item>
    <Item uniqueKey="trendy">Trendy</Item>
    <Item uniqueKey="2020 assets">March 2020 Assets</Item>
    <Item uniqueKey="winter">Winter</Item>
    <Item uniqueKey="holiday">Holiday</Item>
  </Breadcrumbs>
</View>
```
