          ...
          <Section title={strings.format("actions")}>
            <Item key="queue" textValue={strings.format("addToQueue")}>
              ...
              <Text slot="description">
                {strings.format("addToCurrentWatchQueue")}
              </Text>
            </Item>
            <Item key="review" textValue={strings.format("addReview")}>
              ...
              <Text slot="description">
                {strings.format("postAReviewForTheEpisode")}
              </Text>
            </Item>
            <Item
              key="subscribe"
              textValue={strings.format("subscribeToSeries")}
            >
              <Bell />
              <Text>{strings.format("subscribeToSeries")}</Text>
              <Text slot="description">
                {strings.format("addSeriesToSubscription")}
              </Text>
            </Item>
