...
```tsx example
<SearchField label="Search" labelAlign="start" marginEnd="size-300" />
<SearchField label="Search" labelAlign="end" />
```

### Label position

```tsx example
<SearchField label="Search" labelPosition="top" marginEnd="size-300" />
<SearchField label="Search" labelPosition="side" />
```

### Custom width

```tsx example
<SearchField label="Search" width="400px" />
```
