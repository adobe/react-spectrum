...
const labelStyles = tv({
  base: 'flex items-baseline text-neutral-subdued group-disabled:text-disabled',
  variants: {
    size: {
      S: 'text-75 gap-50',
      M: 'text-75 gap-50',
...
function Label(props: SpectrumLabelProps, ref: DOMRef<HTMLLabelElement>) {
  ...
  let icon = (
    <Asterisk
      ...
      UNSAFE_className="center-baseline shrink-0"
  ...
  return (
    <RACLabel
      ...
      onClick={onClick}
      ref={domRef}
      className={labelStyles({size, labelAlign})}
