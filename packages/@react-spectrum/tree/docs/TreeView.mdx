...
<strong>
  Note: Asynchronous tree loading (i.e, loading by level or infinite scrolling)
  is not yet supported in TreeView.
</strong>
...
let items: MyItem[] = [
  ...
  },
  {
    ...
    name: "Reports",
    icon: <Folder />,
    childItems: [{ id: "report-1", name: "Reports 1", icon: <FileTxt /> }],
  },
];
...
<PropTable
  component={docs.exports.TreeView}
  links={docs.links}
...
<PropTable
  component={docs.exports.TreeViewItemContent}
  links={docs.links}
  style={{ marginBottom: "40px" }}
/>
...
<PropTable
  component={docs.exports.TreeViewItem}
  links={docs.links}
  style={{ marginBottom: "40px" }}
/>
