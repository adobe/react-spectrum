...
```tsx example
<TextArea label="Address" marginEnd="size-300" />
<TextArea label="Address" isRequired necessityIndicator="icon" marginEnd="size-300" />
<TextArea label="Address" isRequired necessityIndicator="label" marginEnd="size-300" />
...
```tsx example
<TextArea label="Email" labelAlign="start" marginEnd="size-300" />
...
```tsx example
<TextArea label="Email" labelPosition="top" marginEnd="size-300" />
