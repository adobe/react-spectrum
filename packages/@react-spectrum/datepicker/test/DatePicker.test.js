  ...
  describe('forms', () => {
    ...
    it('supports native validation', async () => {
      ...
      let {getByTestId, getByRole, getAllByRole} = render(
        <form data-testid="form">
          <DatePicker label="Value" name="date" validationBehavior="native" isRequired onValidationChange={onValidationChange} />
        </form>
      );
      let group = getByRole('group');
    ...
    it('supports native custom validation message', async () => {
      let tree = (validationState, errorMessage) => (
        <form data-testid="form">
          <DatePicker label="Value" name="date" validationBehavior="native" validationState={validationState} errorMessage={errorMessage} />
        </form>
      );
    ...
    it('should set native input invalid when outside min/max range', () => {
      ...
      let {getAllByRole} = render(
        <form data-testid="form">
          <DatePicker label="Value" name="date" validationBehavior="native" minValue={today(getLocalTimeZone())} defaultValue={today(getLocalTimeZone())} onValidationChange={onValidationChange} />
        </form>
      );
      let spinbuttons = getAllByRole('spinbutton');
      let input = document.querySelector('input[name=date]');
    ...
    it('should not set native validation message when validationBehavior=aria', async () => {
      let {getByRole, getAllByRole} = render(
        <form data-testid="form">
          <DatePicker label="Value" name="date" validationState="invalid" errorMessage="custom" />
        </form>
      );
      let group = getByRole('group');
      let spinbuttons = getAllByRole('spinbutton');
