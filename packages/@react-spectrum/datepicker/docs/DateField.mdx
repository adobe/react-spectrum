...
Most likely, your data will come from and be sent to a server as an ISO 8601 formatted string. `@internationalized/date` includes functions for parsing strings in multiple formats into <TypeLink links={i18nDocs.links} type={i18nDocs.exports.ZonedDateTime} /> objects. Which format you use will depend on what information you need to store.
