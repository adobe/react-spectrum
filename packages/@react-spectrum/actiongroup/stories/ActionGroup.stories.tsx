...
import Brush from '@spectrum-icons/workflow/Brush.js';
...
import DuplicateIcon from '@spectrum-icons/workflow/Duplicate.js';
import {Flex} from '@react-spectrum/layout';
import Heal from '@spectrum-icons/workflow/Heal.js';
import InfoIcon from '@spectrum-icons/workflow/Info.js';
import {Item} from '@react-stately/collections';
import MoveIcon from '@spectrum-icons/workflow/MoveTo.js';
import PropertiesIcon from '@spectrum-icons/workflow/Properties.js';
import React from 'react';
import Sampler from '@spectrum-icons/workflow/Sampler.js';
import Select from '@spectrum-icons/workflow/Select.js';
import SettingsIcon from '@spectrum-icons/workflow/Settings.js';
import {storiesOf} from '@storybook/react';
import TagBold from '@spectrum-icons/workflow/TagBold.js';
import TagItalic from '@spectrum-icons/workflow/TagItalic.js';
import TagUnderline from '@spectrum-icons/workflow/TagUnderline.js';
import {Text} from '@react-spectrum/text';
import TextAlignCenter from '@spectrum-icons/workflow/TextAlignCenter.js';
import TextAlignJustify from '@spectrum-icons/workflow/TextAlignJustify.js';
import TextAlignLeft from '@spectrum-icons/workflow/TextAlignLeft.js';
import TextAlignRight from '@spectrum-icons/workflow/TextAlignRight.js';
import TextIcon from '@spectrum-icons/workflow/Text.js';
import TextStrikethrough from '@spectrum-icons/workflow/TextStrikethrough.js';
import TextStyle from '@spectrum-icons/workflow/TextStyle.js';
import {Tooltip, TooltipTrigger} from '@react-spectrum/tooltip';
import VectorDraw from '@spectrum-icons/workflow/VectorDraw.js';
