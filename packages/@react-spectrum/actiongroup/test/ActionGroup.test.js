...
describe('ActionGroup', function () {
  ...
  it('ActionGroup calls onSelectionChange when selecting the same button if disallowEmptySelection is true', function () {
    let onSelectionChange = jest.fn();
    let {getAllByRole} = renderComponent({selectionMode: 'single', disallowEmptySelection: true, onSelectionChange});
