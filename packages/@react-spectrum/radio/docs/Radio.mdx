...
function Example() {
  ...
  return (
    <Flex>
      <RadioGroup label="Are you a wizard? (uncontrolled)" defaultValue="yes" marginEnd="size-300">
...
```tsx example
<Flex>
  <RadioGroup label="Favorite avatar" marginEnd="size-300">
    <Radio value="wizard">Wizard</Radio>
    <Radio value="dragon">Dragon</Radio>
  </RadioGroup>

  <RadioGroup label="Favorite avatar" isRequired necessityIndicator="icon" marginEnd="size-300">
    <Radio value="wizard">Wizard</Radio>
    <Radio value="dragon">Dragon</Radio>
  </RadioGroup>

  <RadioGroup label="Favorite avatar" isRequired necessityIndicator="label" marginEnd="size-300">
    <Radio value="wizard">Wizard</Radio>
    <Radio value="dragon">Dragon</Radio>
  </RadioGroup>
...
If a visible label isn't specified, an `aria-label` must be provided to the RadioGroup for accessibility. If the field is labeled by a separate element, an `aria-labelledby` prop must be provided using the id of the labeling element instead.
...
function Example() {
  ...
  return (
    <>
      <RadioGroup label="Favorite avatar" onChange={setSelected}>
        <Radio value="wizard">Wizard</Radio>
        <Radio value="dragon">Dragon</Radio>
      </RadioGroup>
