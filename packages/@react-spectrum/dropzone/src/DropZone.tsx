...
export interface SpectrumDropZoneProps extends Omit<DropZoneProps, 'onHoverStart' | 'onHoverChange' | 'onHoverEnd' | 'className' | 'style'>, DOMProps, StyleProps, AriaLabelingProps {
