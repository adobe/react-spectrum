...
## Example
```tsx example
<ListView aria-label="List example" maxWidth="size-6000">
...
<ListView items={items} maxWidth="size-6000" height="250px" aria-label="List example">
  {(item) => (
...
```tsx example
<ListView maxWidth="size-6000" aria-label="List example with complex items">
...
```tsx example
<ListView isQuiet aria-label="Quiet list example" maxWidth="size-6000">
...
<Flex direction="column" gap="size-300">
    <Text>Compact:</Text>
    <ListView density="compact" aria-label="Compact list example" maxWidth="size-6000">
      <Item textValue="row 1">row 1</Item>
      <Item textValue="row 2">row 2</Item>
      <Item textValue="row 3">row 3</Item>
    </ListView>
    <Text>Spacious:</Text>
    <ListView density="spacious" aria-label="Spacious list example" maxWidth="size-6000">
      <Item textValue="row 1">row 1</Item>
      <Item textValue="row 2">row 2</Item>
      <Item textValue="row 3">row 3</Item>
    </ListView>
