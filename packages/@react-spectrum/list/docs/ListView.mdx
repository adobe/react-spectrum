...
## Example
```tsx example
<ListView width="500px" aria-label="List example">
...
<ListView items={rows} width="300px" height="250px" aria-label="List example">
  {(item) => (
...
```tsx example
<ListView width="250px" selectionMode="multiple" defaultSelectedKeys={["row1", "row3"]} aria-label="List seletion example">
  <Item key="folder1" textValue="folder 1" hasChildItems>
...
By default, ListView uses the checkbox selection style, which includes a column of checkboxes in each row for selection. When the `selectionStyle` prop is set to `"highlight"`, the checkboxes are hidden, and the selected rows are displayed with a highlighted background instead.
...
ListView may be used in use cases where users can perform actions on rows, such as navigating into items to open them or get more details. In the default checkbox selection style, it is recommended to use a [Link](Link.html) component in the first column for navigation.
...
```tsx example
<ListView isQuiet width="500px" aria-label="Quiet list example">
  <Item textValue="row 1">row 1</Item>
  <Item textValue="row 2">row 2</Item>
  <Item textValue="row 3">row 3</Item>
</ListView>
...
<Flex direction="column" gap="size-300">
  <ListView density="compact" width="500px" aria-label="Compact list example">
    <Item textValue="row 1">row 1</Item>
    <Item textValue="row 2">row 2</Item>
    <Item textValue="row 3">row 3</Item>
  </ListView>
  <ListView density="spacious" width="500px" aria-label="Spacious list example">
    <Item textValue="row 1">row 1</Item>
    <Item textValue="row 2">row 2</Item>
    <Item textValue="row 3">row 3</Item>
  </ListView>
