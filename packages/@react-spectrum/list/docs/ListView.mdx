...
Each item has a unique key defined by the data. In the example below, the `key` of each row element is implicitly defined by the id property of the row object. See [collections](../react-stately/collections.html#unique-keys) to learn more keys in dynamic collections.
...
<ListView maxWidth="size-6000" selectionMode="multiple" defaultSelectedKeys={["Charizard", "Venusaur"]} aria-label="List selection example">
  <Item key="Charizard" textValue="Charizard">
    <Content>Charizard</Content>
  </Item>
  <Item key="Blastoise" textValue="Blastoise">
    <Content>Blastoise</Content>
  </Item>
  <Item key="Venusaur" textValue="Venusaur">
    <Content>Venusaur</Content>
  </Item>
  <Item key="Pikachu" textValue="Pikachu">
...
```tsx example
<ListView isQuiet selectionMode="multiple" aria-label="Quiet list example" maxWidth="size-6000">
...
<Flex direction="column" gap="size-300">
    <Text>Compact:</Text>
    <ListView density="compact" selectionMode="multiple" aria-label="Compact list example" maxWidth="size-6000">
      <Item textValue="row 1">row 1</Item>
      <Item textValue="row 2">row 2</Item>
      <Item textValue="row 3">row 3</Item>
    </ListView>
    <Text>Spacious:</Text>
    <ListView density="spacious" selectionMode="multiple" aria-label="Spacious list example" maxWidth="size-6000">
      <Item textValue="row 1">row 1</Item>
      <Item textValue="row 2">row 2</Item>
      <Item textValue="row 3">row 3</Item>
    </ListView>
