...
<ListView items={items} height="250px" aria-label="List example">
  {(item) => (
...
```tsx example
<ListView selectionMode="multiple" defaultSelectedKeys={["Charizard", "Venusaur"]} aria-label="List selection example">
