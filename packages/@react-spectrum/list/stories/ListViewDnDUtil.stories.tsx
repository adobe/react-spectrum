...
import {DnDSections, DragBetweenListsComplex, DragBetweenListsOverride, DragExampleUtilHandlers, FinderDropUtilHandlers, InsertExampleUtilHandlers, ItemDropExampleUtilHandlers, ReorderExampleUtilHandlers, RootDropExampleUtilHandlers} from './ListViewDnDUtilExamples';
...
export const SectionsDnD: ListViewStory = {
  render: (args) => (
    <DnDSections
      listViewProps={args}
      firstListDnDOptions={{
  ...
  name: 'complex drag between lists (sections)',
  parameters: {
    description: {data: 'The first list should allow dragging and drops into its folder, but disallow reorder operations. External root drops should be placed into the first section. The second list should allow all operations and root drops should be placed at the top of the list. Move and copy operations are allowed.'}
  }
};
