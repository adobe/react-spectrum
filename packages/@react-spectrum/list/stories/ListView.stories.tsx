...
export const StaticSections: ListViewStory = {
  render: (args) => (
    <ListView width="250px" aria-label="static sections ListView" {...args}>
  ...
  name: 'with static sections'
};

export const MixedSections: ListViewStory = {
  render: (args) => (
    <ListView width="250px" aria-label="mixed sections ListView" {...args}>
  ...
  name: 'with sections and non section items'
};
...
export const DynamicSections: ListViewStory = {
  render: (args) => (
    <ListView aria-label="Dynamic sections" disabledKeys={['Kangaroo']} items={withSection} width="300px" height="250px" {...args}>
      {(item: any) => (
