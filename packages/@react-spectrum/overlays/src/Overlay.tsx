...
function Overlay(props: OverlayProps, ref: DOMRef<HTMLDivElement>) {
  let {children, isOpen, shouldContainFocus, shouldRestoreFocus, container, onEnter, onEntering, onEntered, onExit, onExiting, onExited, nodeRef} = props;
  ...
  return (
    <ReactAriaOverlay portalContainer={container} shouldContainFocus={shouldContainFocus} shouldRestoreFocus={shouldRestoreFocus}>
