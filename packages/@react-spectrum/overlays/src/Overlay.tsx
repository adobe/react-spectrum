...
function Overlay(props: OverlayProps, ref: DOMRef<HTMLDivElement>) {
  let {children, isOpen, container, onEnter, onEntering, onEntered, onExit, onExiting, onExited, nodeRef, restoreFocus} = props;
  ...
  return (
    <ReactAriaOverlay portalContainer={container} restoreFocus={restoreFocus}>
