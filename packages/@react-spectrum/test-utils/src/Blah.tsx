...
export interface SpectrumBlahProps extends DOMProps, StyleProps {
  onChange?: any
}

function Blah(props: SpectrumBlahProps, ref: DOMRef<HTMLDivElement>) {
 ...
 */
const _Blah = React.forwardRef(Blah);
export {_Blah as Blah};
