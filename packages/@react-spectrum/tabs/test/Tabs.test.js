...
describe('Tabs', function () {
  ...
  it('not select via left / right keys if keyboardActivation is manual, select on enter / spacebar', function () {
    ...
    fireEvent.keyUp(firstItem, {key: 'ArrowRight', code: 39, charCode: 39});
    ...
    fireEvent.keyUp(secondItem, {key: 'ArrowRight', code: 39, charCode: 39});
    ...
    fireEvent.keyUp(thirdItem, {key: 'Enter', code: 13, charCode: 13});
