...
function Example() {
  let unauthorizedPage = (props) => (
    <Content marginTop="size-250">
      <Heading marginStart="size-125">{props.heading}</Heading>
      <IllustratedMessage>
        {props.errorMessage}
        {props.illustratedMessage}
      </IllustratedMessage>
    </Content>
  );
  ...
  let tabs = [
    {
      ...
      children: unauthorizedPage({
        heading: 'Files',
        illustratedMessage: <Unauthorized />,
        errorMessage: (
          <>
    ...
    },
    {
      ...
      children: unauthorizedPage({
        ...
        illustratedMessage: <NoSearchResults />,
        errorMessage: (
    ...
    },
    {
      ...
      icon: <Book />,
      children: unauthorizedPage({
        heading: 'Available Libraries',
        illustratedMessage: <Unavailable />,
        errorMessage: (
          <>
