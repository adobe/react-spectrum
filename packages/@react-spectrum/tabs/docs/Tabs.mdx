...
## Content
Tabs expects a TabList and TabPanels as children. In turn, TabList and TabPanels follow the [Collection Components](../react-stately/collections.html) API, accepting both static and dynamic collections. TabList and TabPanel accepts `<Item>` elements as children,
