...
This example shows how you can nest flexboxes to create more complicated layouts.
...
<Flex direction="column" gap="size-100">
  ...
  <Flex direction="row" height="size-3000" gap="size-100">
    ...
    <View backgroundColor="seafoam-600" flex={1} />
  </Flex>
  <View backgroundColor="magenta-600" height="size-800" />
</Flex>
```
...
**NOTE: the default value for `alignItems` is `"stretch"`. This means that if your items do
