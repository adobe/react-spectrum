...
Alternatively, the `isSelected` prop can be used to make the selected state controlled. See [uncontrolled components](https://reactjs.org/docs/uncontrolled-components.html) for more.
