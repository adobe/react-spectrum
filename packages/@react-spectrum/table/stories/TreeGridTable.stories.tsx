...
function DynamicExpandableRows(props: SpectrumTableProps<unknown>) {
  ...
  return (
    <Flex direction="column">
      <ActionButton onPress={() => setExpandedKeys("all")}>
        Expand all
      </ActionButton>
      <ActionButton onPress={() => setExpandedKeys(new Set([]))}>
        Collapse all
      </ActionButton>
      ...
      <TableView
        ...
        UNSTABLE_onExpandedChange={chain(
          setExpandedKeys,
...
export const DynamicExpandableRowsStory: TableStory = {
  ...
  render: (args) => <DynamicExpandableRows {...args} />,
...
export const ManyExpandableRowsStory: TableStory = {
  ...
  render: (args) => <ManyExpandableRows {...args} />,
...
export const LoadingTreeGridStory: TableStory = {
  ...
  render: (args) => <LoadingStateTable {...args} />,
  name: "isLoading",
};
...
export const ResizableColumnsStory: TableStory = {
  args: {
    "aria-label":
      "TableView with many dynamic expandable rows and resizable columns",
    width: 500,
    height: 400,
  },
