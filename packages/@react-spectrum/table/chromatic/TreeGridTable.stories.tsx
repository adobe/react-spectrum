...
const Template = ({combos, columns, items, ...args}) => (
  <Grid columns={repeat(3, '1fr')} autoFlow="row" gap="size-300">
    {combos.map(c => {
      ...
      return (
        <View key={key} flexGrow={1} maxWidth="size-5000" maxHeight={700}>
          <TableView {...args} {...c} width="100%" height="100%" aria-label={key} selectedKeys={['Lvl 1 Foo 1', 'Lvl 3 Foo 1']} disabledKeys={['Lvl 2 Foo 1', 'Lvl 2 Foo 2']} UNSTABLE_allowsExpandableRows>
