...
function TableExample(props) {
  ...
  let nestedRows = [
    {key: '1', name: 'Charizard', type: 'Fire, Flying', level: '67', childRows: [
      {key: '2', name: 'Blastoise', type: 'Water', level: '56', childRows: [
        {key: '3', name: 'Venusaur', type: 'Grass, Poison', level: '83'}
      ]},
      {key: '4', name: 'Pikachu', type: 'Electric', level: '100'}
    ]}
  ];
