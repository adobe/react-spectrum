...
The example below shows how to use a Flex component with to size a TableView, filling the remainder of the available space.
...
// Table data hidden for example
// Display table in flex with actiongroup above. without height
<Flex height="size-2000" width="100%" direction="column">
  <div>sdghsfgiudsfglibdfilbfg</div>
  <TableView
    flex
    minHeight={0}
    aria-label="Example table with dynamic content">
