  ...
  let { dragAndDropHooks } = useDragAndDrop({
    ...
    onInsert: async (e) => {
      ...
      let processedItems = await Promise.all(
        items.map(async (item) => ({
          ...JSON.parse(
            await (item as TextDropItem).getText("custom-app-type-copy-default")
          ),
...
<PropTable
  component={docs.exports.TableView}
  links={docs.links}
  ...
  component={{
    props: {
      properties: Object.fromEntries(
        Object.entries(tableTypes.exports.TableHeaderProps.properties)
      ),
    },
  }}
...
<PropTable
  component={{
    props: {
      properties: Object.fromEntries(
        Object.entries(tableTypes.exports.SpectrumColumnProps.properties)
      ),
    },
  }}
  links={tableTypes.links}
...
<PropTable
  component={{
    props: {
      properties: Object.fromEntries(
        Object.entries(tableTypes.exports.TableBodyProps.properties)
      ),
    },
  }}
  links={tableTypes.links}
...
<PropTable
  component={{
    props: {
      properties: Object.fromEntries(
        Object.entries(tableTypes.exports.RowProps.properties)
      ),
    },
  }}
  links={tableTypes.links}
...
<PropTable
  component={{
    props: {
      properties: Object.fromEntries(
        Object.entries(tableTypes.exports.CellProps.properties)
      ),
    },
  }}
  links={tableTypes.links}
