...
import docs from 'docs:@react-spectrum/cards';
import {HeaderInfo, PropTable} from '@react-spectrum/docs';
import packageData from '@react-spectrum/cards/package.json';

```jsx import
import {CardView} from '@react-spectrum/cards';
```
