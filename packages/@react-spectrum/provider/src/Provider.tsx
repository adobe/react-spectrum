...
import * as styles from '@adobe/spectrum-css-temp/components/page/vars.css';
import * as typographyStyles from '@adobe/spectrum-css-temp/components/typography/index.css';
