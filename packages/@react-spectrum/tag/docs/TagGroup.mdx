...
```tsx example
<TagGroup actionLabel="Clear" onAction={() => alert('Clear action pressed.')} aria-label="TagGroup with action">
  <Item>Adobe Photoshop</Item>
  <Item>Adobe InDesign</Item>
  <Item>Adobe AfterEffects</Item>
  <Item>Adobe Illustrator</Item>
...
```tsx example
<View maxWidth="size-3400" minHeight="size-3400" padding="size-150" borderWidth="thin" borderColor="dark" borderRadius="medium">
  <TagGroup maxRows={3} aria-label="Static TagGroup items example">
    <Item>Adobe Photoshop</Item>
    <Item>Adobe InDesign</Item>
    <Item>Adobe AfterEffects</Item>
    <Item>Adobe Illustrator</Item>
