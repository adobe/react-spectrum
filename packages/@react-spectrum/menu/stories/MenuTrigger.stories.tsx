...
let withSection = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        name: 'Ross',
        children: [{name: 'Tests', children: [{name: 'blah'}]}]
      }
    ]
  }
];
...
export const MultipleSelectedKeyControlledGenerative = () =>
  render(
    defaultMenu,
    {},
    {selectedKeys: ['Kangaroo', 'Devon'], selectionMode: 'multiple'}
  );
...
export const MenuClosesOnScroll = () => (
  <div style={{height: 100, display: 'flex'}}>
    ...
    <div
      ...
      <div style={{height: 200}}>Scrolling here won't close the Menu</div>
    </div>
  </div>
);

MenuClosesOnScroll.story = {
