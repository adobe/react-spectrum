...
<ActionMenu>
  <Section title="File">
    <Item key="bold">New</Item>
    <Item key="underline">Open...</Item>
  </Section>
  <Section title="Save">
    <Item key="left">Save</Item>
    <Item key="middle">Save As...</Item>
    <Item key="right">Save All</Item>
  </Section>
</ActionMenu>
```
