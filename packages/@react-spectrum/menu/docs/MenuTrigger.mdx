...
## Unavailable Menu Item <VersionBadge version="alpha" style={{marginLeft: 4, verticalAlign: 'bottom'}} />

ContextualHelpTrigger allows the disabling of a Menu Item along with showing a user extra information about the state of that unavailable Menu Item.
It provides context and may point users to more information elsewhere.
...
Setting the `isUnavailable` prop on the ContextualHelpTrigger disables a Menu Item and enables the Dialog with contextual help, allowing for programmatic control.
