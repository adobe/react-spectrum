...
export function StepListItem<T>(
  props: SpectrumStepListItemProps<T>
): ReactNode {
  ...
  let { stepProps, stepStateProps } = useStepListItem(
    { ...props, key },
    state,
    ref
  );
    ...
    <li className={classNames(styles, "spectrum-Steplist-item")}>
      <FocusRing within focusRingClass={classNames(styles, "focus-ring")}>
        ...
        >
          ...
          <div
            aria-hidden="true"
            className={classNames(styles, "spectrum-Steplist-markerWrapper")}
          >
            <div
              id={markerId}
              className={classNames(styles, "spectrum-Steplist-marker")}
            >
