...
<Flex flexDirection="column">
  <ProgressBar label="Loading…" marginBottom="5px" value={30} />
  <ProgressBar label="Loading…" marginBottom="5px" labelPosition="side" value={30} />
  <ProgressBar label="Loading…" marginBottom="5px" showValueLabel={false} value={30} />
</Flex>
```
...
```tsx example
<Flex flexDirection="column">
  <ProgressBar aria-label="Loading…" marginBottom="5px" size="S" value={70} />
  <ProgressBar aria-label="Loading…" marginBottom="5px" size="L" value={70} />
</Flex>
```
