...
```tsx example
<div><ProgressBar label="Loading…" /></div>
<div><ProgressBar label="Loading…" labelPosition="side" /></div>
<div><ProgressBar label="Loading…" showValueLabel={false} /></div>
```
...
```tsx example
<div><ProgressBar aria-label="Loading…" size="S" /></div>
<div><ProgressBar aria-label="Loading…" /></div>
<div><ProgressBar aria-label="Loading…" size="L" /></div>
```
