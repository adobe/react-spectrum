...
<Flex flexDirection="column" maxWidth="size-3000">
  <ProgressBar label="Loading…" marginBottom="size-300" value={30} />
  <ProgressBar label="Loading…" marginBottom="size-300" labelPosition="side" value={30} />
...
```tsx example
<Flex flexDirection="column" maxWidth="size-3000">
  <ProgressBar label="Loading…" marginBottom="size-300" showValueLabel={false} value={30} />
  <ProgressBar label="Loading…" marginBottom="size-300" valueLabel="30 of 60 dogs" value={30} />
...
<Flex flexDirection="column">
  <ProgressBar label="Small" marginBottom="size-300" size="S" value={70} />
