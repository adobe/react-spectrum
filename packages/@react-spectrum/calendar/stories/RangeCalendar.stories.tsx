...
import {Custom454} from './Calendar.stories';
...
function Custom454RangedCalendar(props) {
  return render({...props, createCalendar: () => new Custom454(), visibleMonths: 3, defaultValue: {start: new CalendarDate(2023, 8, 6), end: new CalendarDate(2023, 10, 7)}});
}
