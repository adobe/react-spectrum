...
export const Invalid = () => <RangeCalendar value={value} validationState="invalid" />;
export const ErrorMessage = () => <RangeCalendar value={value} validationState="invalid" errorMessage="Selection invalid." />;
