...
export const TypePopover = (args) =>
  renderPopover({ type: "popover", ...args });
...
export const TypeFullscreenTakeover = (args) =>
...
export const TriggerVisibleThroughUnderlay = (args) =>
  ...
  <div style={{ display: "flex", width: "auto", margin: "100px 0" }}>
    <DialogTrigger isDismissable>
      ...
      <Dialog>
        ...
        <Content>
          <p>
            Pressing escape when Tooltip is open closes Tooltip and not Dialog
            too.
          </p>
          <TooltipTrigger>
    ...
    <Flex gap="size-200">
      <Flex direction="column" width="size-2000" gap="size-100">
        ...
        <Checkbox
          onChange={(isChecked) => {
            isChecked
              ? setHeading(headingStrings[1])
              : setHeading(headingStrings[0]);
          }}
        >
        ...
        <Checkbox onChange={setLongButtonLabels}>
          Show Long Button Labels
        </Checkbox>
      </Flex>
