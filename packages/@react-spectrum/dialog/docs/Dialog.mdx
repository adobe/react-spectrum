...
<DialogTrigger>
  ...
  {(close) => (
    <Dialog>
      <Image slot="hero" decorative src="https://i.imgur.com/Z7AzH2c.png" objectFit="cover" />
...
`onDismiss`. If this event call back is not needed, the dismissiable dialog will behave as normal without passing this callback through.
