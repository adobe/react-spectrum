...
To identify a particular instance of the cancel, secondary, or confirm button, you can use the following data-testid's respectively: `"rsp-AlertDialog-cancelButton"`, `"rsp-AlertDialog-secondaryButton"`, or `"rsp-AlertDialog-confirmButton"`