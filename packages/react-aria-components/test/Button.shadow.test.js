...
import {act, pointerMap, shadowRender as render, getActiveElement, screen, fireEvent} from '@react-spectrum/test-utils-internal';
...
describe('Button', () => {
  ...
  it('should support focus ring', async () => {
    let {getByRole, shadowRoot} = render(<Button className={({isFocusVisible}) => isFocusVisible ? 'focus' : ''}>Test</Button>);
    let button = getByRole('button');
