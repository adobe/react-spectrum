...
it('ComboBox opens by clicking its trigger, keeps focus in the input, and selects an option inside a shadow root', async () => {
...
it('NumberField keeps focus in the input while clicking the stepper inside a shadow root', async () => {
