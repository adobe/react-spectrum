...
function PendingButtonExample(props) {
  ...
  return (
    ...
    >
      {({ isPending }) => (
        <>
          <Text className={isPending ? styles2["pending"] : undefined}>
            {props.children}
          </Text>
          <ProgressBar
            aria-label="loading"
            ...
            className={[
              styles2["spinner"],
              isPending ? styles2["spinner-pending"] : "",
            ].join(" ")}
          >
...
export const RippleButtonExample = () => {
  return <RippleButton data-testid="button-example">Press me</RippleButton>;
};
