...
export const Issue10182 = () => {
  ...
  return (
    <div style={{height: '10000px', paddingTop: '100px'}}>
      <h2>Virtualized Table Window Scroll (Issue #10182)</h2>
      <Virtualizer layout={TableLayout}>
        <Table aria-label="Virtualized Table Window Scroll" selectionMode="multiple">
          <TableHeader>
            {columns.map(c => (
              <Column key={c.id} id={c.id} isRowHeader={c.isRowHeader}>
                {c.name}
              </Column>
            ))}
          </TableHeader>
...
Issue10182.storyName = 'Issue #10182 (Virtualized Table Window Scroll)';

export const BoundedTableStickyScrollPaddingSubIssue = () => {
  let columns = [
    {id: 'id', name: 'ID', isRowHeader: true},
    {id: 'name', name: 'Name'},
    {id: 'type', name: 'Type'},
  ...
  return (
    <div
      ...
      <Table
        aria-label="Bounded Table Sticky Scroll Padding"
        selectionMode="multiple"
        style={{width: '1200px'}}>
        <TableHeader>
          {columns.map(c => (
            <Column
              ...
              style={{position: 'sticky', top: 0, background: 'lightgray', zIndex: 10}}>
              {c.name}
            </Column>
          ))}
        </TableHeader>
...
BoundedTableStickyScrollPaddingSubIssue.storyName = 'Bounded Table Sticky Scroll Padding Sub-Issue';
