...
export interface ListBoxProps<T>
  extends Omit<AriaListBoxProps<T>, "children" | "label">,
    CollectionProps<T>,
...
export const ListBoxContext =
  createContext<ContextValue<ListBoxProps<any>, HTMLDivElement>>(null);
export const ListStateContext = createContext<ListState<any> | null>(null);

/**
 * A listbox displays a list of options and allows a user to select one or more of them.
 */
export const ListBox = /*#__PURE__*/ (forwardRef as forwardRefType)(
      ...
      >
        <Provider
          values={[
            ...
            [
              SectionContext,
              { name: "ListBoxSection", render: ListBoxSectionInner },
            ],
          ]}
        >
          <CollectionRoot
 ...
 */
export const ListBoxSection = /*#__PURE__*/ createBranchComponent(
  "section",
  ListBoxSectionInner
);
...
export interface ListBoxItemProps<T = object>
  extends RenderProps<ListBoxItemRenderProps>,
    LinkDOMProps,
    HoverEvents {
 ...
 */
export const ListBoxItem = /*#__PURE__*/ createLeafComponent(
  "item",
...
function ListBoxDropIndicatorWrapper(
  ...
  let { dropIndicatorProps, isHidden, isDropTarget } = dragAndDropHooks!
    .useDropIndicator!(props, dropState!, ref);
...
function ListBoxDropIndicator(
  props: ListBoxDropIndicatorProps,
  ref: ForwardedRef<HTMLElement>
) {
