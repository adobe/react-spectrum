...
import { useIsHidden } from "@react-aria-nutrient/collections";

export interface PopoverProps
  extends Omit<PositionProps, "isOpen">,
    Omit<
      AriaPopoverProps,
      "popoverRef" | "triggerRef" | "groupRef" | "offset" | "arrowSize"
    >,
    OverlayTriggerProps,
...
const PopoverGroupContext = createContext<RefObject<Element | null> | null>(
  null
);
 ...
 */
export const Popover = /*#__PURE__*/ (forwardRef as forwardRefType)(
...
function PopoverInner({
  ...
  return (
    <Overlay
      ...
      isExiting={isExiting}
      portalContainer={
        UNSTABLE_portalContainer ?? groupCtx?.current ?? undefined
      }
    >
      {overlay}
    </Overlay>
