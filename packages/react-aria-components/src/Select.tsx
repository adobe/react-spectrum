...
export const SelectStateContext = createContext<SelectState<unknown> | null>(
  null
);
 ...
 */
export const Select = /*#__PURE__*/ (forwardRef as forwardRefType)(
  function Select<T extends object = {}>(
    ...
    return (
      <CollectionBuilder content={content}>
        {(collection) => (
          <SelectInner props={props} collection={collection} selectRef={ref} />
        )}
      </CollectionBuilder>
    );
  }
 ...
 */
export const SelectValue = /*#__PURE__*/ (forwardRef as forwardRefType)(
