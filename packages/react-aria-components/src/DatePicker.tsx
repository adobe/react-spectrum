...
export interface DateRangePickerRenderProps
  extends Omit<DatePickerRenderProps, "state"> {
  /**
...
export const DatePickerStateContext = createContext<DatePickerState | null>(
  null
);
export const DateRangePickerStateContext =
  createContext<DateRangePickerState | null>(null);

/**
 * A date picker combines a DateField and a Calendar popover to allow users to enter or select a date and time value.
 */
export const DatePicker = /*#__PURE__*/ (forwardRef as forwardRefType)(
    ...
    return (
      <Provider
        values={[
          ...
          [
            GroupContext,
            { ...groupProps, ref: groupRef, isInvalid: state.isInvalid },
          ],
