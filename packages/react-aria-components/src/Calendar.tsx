...
export interface RangeCalendarRenderProps
  extends Omit<CalendarRenderProps, "state"> {
  /**
...
export interface CalendarProps<T extends DateValue>
  extends Omit<AriaCalendarProps<T>, "errorMessage" | "validationState">,
    RenderProps<CalendarRenderProps>,
    SlotProps {
  /**
...
export interface RangeCalendarProps<T extends DateValue>
  extends Omit<AriaRangeCalendarProps<T>, "errorMessage" | "validationState">,
    RenderProps<RangeCalendarRenderProps>,
    SlotProps {
  /**
   * The amount of days that will be displayed at once. This affects how pagination works.
   * @default {months: 1}
...
export const CalendarContext =
  createContext<ContextValue<CalendarProps<any>, HTMLDivElement>>(null);
...
export const RangeCalendarStateContext =
  createContext<RangeCalendarState | null>(null);

/**
 * A calendar displays one or more date grids and allows users to select a single date.
 */
export const Calendar = /*#__PURE__*/ (forwardRef as forwardRefType)(
      ...
      >
        <Provider
          values={[
            ...
            [
              HeadingContext,
              { "aria-hidden": true, level: 2, children: title },
            ],
 ...
 */
export const RangeCalendar = /*#__PURE__*/ (forwardRef as forwardRefType)(
...
const InternalCalendarGridContext =
  createContext<InternalCalendarGridContextValue | null>(null);

/**
 * A calendar grid displays a single grid of days within a calendar or range calendar which
 * can be keyboard navigated and selected by the user.
 */
export const CalendarGrid = /*#__PURE__*/ (forwardRef as forwardRefType)(
  function CalendarGrid(
    ...
    let firstDayOfWeek =
      calenderProps?.firstDayOfWeek ?? rangeCalenderProps?.firstDayOfWeek;
 ...
 */
const CalendarGridHeaderForwardRef = /*#__PURE__*/ (
 ...
 */
const CalendarGridBodyForwardRef = /*#__PURE__*/ (forwardRef as forwardRefType)(
  CalendarGridBody
);
export { CalendarGridBodyForwardRef as CalendarGridBody };

export interface CalendarCellProps
  extends RenderProps<CalendarCellRenderProps>,
    HoverEvents {
 ...
 */
export const CalendarCell = /*#__PURE__*/ (forwardRef as forwardRefType)(
  function CalendarCell(
    ...
    let rangeCalendarState = useContext(RangeCalendarStateContext);
    let state = calendarState ?? rangeCalendarState!;
    let { startDate: currentMonth } = useContext(
    ...
    return (
      <td {...cellProps} ref={ref}>
        <div
          {...mergeProps(
            filterDOMProps(otherProps as any),
            buttonProps,
            focusProps,
            hoverProps,
            dataAttrs,
