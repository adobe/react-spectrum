...
interface ILayout<O>
  extends Layout<Node<unknown>, O>,
    Partial<DropTargetDelegate>,
...
function renderChildren(
  ...
  return children.map((view) =>
    renderWrapper(parent, view, renderDropIndicator)
  );
}
  ...
  if (
    ...
    rendered = (
      <React.Fragment key={reusableView.key}>
        ...
        {rendered}
        {collection.getKeyAfter(key) == null &&
          renderDropIndicatorWrapper(
            parent,
            reusableView,
            "after",
