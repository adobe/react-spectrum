...
export function useContextProps<T, U extends SlotProps, E extends Element>(props: T & SlotProps, ref: ForwardedRef<E | null>, context: Context<ContextValue<U, E>>): [T, RefObject<E | null>] {
