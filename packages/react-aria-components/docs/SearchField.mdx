...
import Anatomy from "@react-aria-nutrient/searchfield/docs/anatomy.svg";
...
```tsx example
<MySearchField label="Search" defaultValue="Puppies" />
```
...
```jsx
<SearchField className="my-searchfield">{/* ... */}</SearchField>
```
