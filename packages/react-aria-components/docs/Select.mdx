...
infinite scroll to load more data, be sure to include the [`<UNSTABLE_ListBoxLoadingSentinel>`](../react-aria/ListBox.html#listboxloadingsentinel) after the `Listbox`'s items render function as shown in the example below.
