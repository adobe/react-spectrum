...
infinite scroll to load more data, be sure to include the [`<ListBoxLoadMoreItem>`](../react-aria/ListBox.html#listboxloadingsentinel) after the `Listbox`'s items render function as shown in the example below.
