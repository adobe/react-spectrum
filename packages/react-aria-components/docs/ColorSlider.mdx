...
import Anatomy from "@react-aria-nutrient/color/docs/ColorSliderAnatomy.svg";
...
```tsx example
<MyColorSlider defaultValue="#7f0000" channel="red" name="red" />
```
...
```jsx
<ColorSlider className="my-color-slider">{/* ... */}</ColorSlider>
```
