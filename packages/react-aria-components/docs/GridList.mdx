...
.react-aria-GridList {
  ...
  @supports selector(:has(.foo)) {
    ...
    .react-aria-Item[data-selected=true]:has(+ [data-selected=true]),
    .react-aria-Item[data-selected=true]:has(+ .react-aria-DropIndicator + [data-selected=true]) {
      border-end-start-radius: 0;
      border-end-end-radius: 0;
    }

    .react-aria-Item[data-selected=true] + [data-selected=true],
    .react-aria-Item[data-selected=true] + .react-aria-DropIndicator + [data-selected=true] {
