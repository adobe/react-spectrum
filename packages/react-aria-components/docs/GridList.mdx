...
function DraggableGridList() {
  ...
  return (
    <MyGridList aria-label="Draggable list" selectionMode="multiple" items={items} dragAndDropHooks={dragAndDropHooks}>
      {([id, item]) => <MyItem id={id}><item.style>{item.name}</item.style></MyItem>}
    </MyGridList>
  );
}
...
function Example() {
  ...
  return (
    <div style={{display: 'flex', gap: 12, flexWrap: 'wrap'}}>
      {/* see above */}
      <DraggableGridList />
      <MyGridList aria-label="Droppable list" items={items} dragAndDropHooks={dragAndDropHooks}>
        {item => <Item>{item.name}</Item>}
      </MyGridList>
    </div>
  );
...
function DroppableGridList() {
  ...
  return (
    <MyGridList aria-label="Draggable list" items={items} dragAndDropHooks={dragAndDropHooks}>
...
function Example() {
  ...
  return (
    <MyGridList aria-label="Draggable list" items={files} dragAndDropHooks={dragAndDropHooks}>
      {item => (
        <MyItem id={item.name}>
