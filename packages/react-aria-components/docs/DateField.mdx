...
import Anatomy from "@react-aria-nutrient/datepicker/docs/datefield-anatomy.svg";
...
```tsx example
<MyDateField label="Appointment time" granularity="minute" hourCycle={24} />
```
