...
import Anatomy from '/packages/@react-aria/tooltip/docs/anatomy.svg';
...
```tsx example
import {TooltipTrigger, Tooltip, TooltipArrow, Button} from 'react-aria-components';
...
`TooltipArrow` accepts all HTML attributes.
...
A `TooltipArrow` can be targeted with the `.react-aria-TooltipArrow` CSS selector, or by overriding with a custom `className`.
...
<div style={{display: 'flex', gap: 8}}>
  <TooltipTrigger placement="top">
    <Button>⬆️</Button>
    <MyTooltip>This tooltip is above the button.</MyTooltip>
  </TooltipTrigger>

  <TooltipTrigger placement="bottom">
    <Button>⬇️</Button>
    <MyTooltip>This tooltip is below the button.</MyTooltip>
  </TooltipTrigger>

  <TooltipTrigger placement="start">
    <Button>⬅️</Button>
    <MyTooltip>In left-to-right, this is on the left. In right-to-left, this is on the right.</MyTooltip>
  </TooltipTrigger>

  <TooltipTrigger placement="end">
    <Button>➡️</Button>
    <MyTooltip>In left-to-right, this is on the right. In right-to-left, this is on the left.</MyTooltip>
  </TooltipTrigger>
</div>
```
...
<TooltipTrigger offset={50}>
  <Button>☝️</Button>
  <MyTooltip>This will shift up.</MyTooltip>
</TooltipTrigger>
```
...
```tsx example
<TooltipTrigger crossOffset={60} placement="bottom">
  <Button>👉</Button>
  <MyTooltip>This will shift over to the right.</MyTooltip>
</TooltipTrigger>
```
