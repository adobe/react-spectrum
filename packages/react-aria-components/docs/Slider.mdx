...
import Anatomy from "@react-aria-nutrient/slider/docs/anatomy.svg";
...
```tsx example
<MySlider label="Cookies to share" defaultValue={25} isDisabled />
```
...
```jsx
<Slider className="my-slider">{/* ... */}</Slider>
```
