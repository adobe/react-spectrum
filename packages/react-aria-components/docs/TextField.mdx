...
import Anatomy from "@react-aria-nutrient/textfield/docs/anatomy.svg";
...
```tsx example
<MyTextField label="Email" defaultValue="me@email.com" />
```
...
```jsx
<TextField className="my-textfield">{/* ... */}</TextField>
```
