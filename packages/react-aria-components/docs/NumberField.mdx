...
import Anatomy from "@react-aria-nutrient/numberfield/docs/anatomy.svg";
...
```tsx example
<MyNumberField label="Enter your age" minValue={0} />
```
...
```jsx
<NumberField className="my-number-field">{/* ... */}</NumberField>
```
...
<ContextTable
  components={["Label", "Group", "Input", "Button", "Text"]}
  docs={docs}
/>
