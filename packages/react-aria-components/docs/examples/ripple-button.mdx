...
function RippleButton(props) {
  ...
  return (
    <div className="bg-gradient-to-r from-teal-300 to-cyan-500 p-12 rounded-lg flex justify-center">
      ...
      inline-flex items-center justify-center rounded-md bg-black bg-opacity-50 bg-clip-padding border border-white/20 px-3.5 py-2 text-white text-2xl
      ...
      {coords !== null ? (
        <div
          className={`
            absolute h-8 w-8 rounded-full opacity-100 bg-white/60
          `}
          style={{
            transform: 'scale(0)',
