...
function Sheet() {
  ...
  return (
    <>
      <Button
        className="text-blue-600 text-lg font-semibold outline-none rounded bg-transparent border-none data-[pressed]:text-blue-700 data-[focus-visible]:ring"
      ...
      <AnimatePresence>
        {isOpen && (
          <MotionModalOverlay
            ...
            <MotionModal
              className="bg-[--page-background] absolute bottom-0 w-full rounded-t-xl shadow-lg"
              initial={{ y: h }}
              animate={{ y: 0 }}
              exit={{ y: h }}
              ...
              <Dialog className="px-4 pb-4 outline-none">
                <div className="flex justify-end">
                  <Button
                    className="text-blue-600 text-lg font-semibold mb-8 outline-none rounded bg-transparent border-none data-[pressed]:text-blue-700 data-[focus-visible]:ring"
