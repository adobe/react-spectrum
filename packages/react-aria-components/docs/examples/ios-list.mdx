  ...
  return (
    <div className="flex flex-col h-full max-h-[500px] sm:w-[400px] -mx-[14px] sm:mx-0">
      ...
      <div className="flex pb-4 justify-between">
        <Button
          className="text-blue-600 text-lg outline-none bg-transparent border-none transition data-[pressed]:text-blue-700 data-[focus-visible]:ring disabled:text-gray-400"
        ...
        <Button
          className="text-blue-600 text-lg outline-none bg-transparent border-none transition data-[pressed]:text-blue-700 data-[focus-visible]:ring"
          onPress={() => {
...
function ListItem({ id, children, textValue, onRemove }) {
  ...
  return (
    <MotionItem
      id={id}
      textValue={textValue}
      className="outline-none group relative overflow-clip border-t border-0 border-solid last:border-b border-gray-200 dark:border-gray-800 data-[pressed]:bg-gray-200 dark:data-[pressed]:bg-gray-800 data-[selected]:bg-gray-200 dark:data-[selected]:bg-gray-800 data-[focus-visible]:outline data-[focus-visible]:outline-blue-600 data-[focus-visible]:-outline-offset-2"
      layout
    ...
    >
      {({ selectionMode, isSelected }) => (
        ...
        >
          ...
          {selectionMode === "none" && (
            <Button
              className="bg-red-600 data-[pressed]:bg-red-700 cursor-default text-lg outline-none border-none transition-colors text-white flex items-center absolute top-0 left-[100%] py-2 h-full z-0 isolate data-[focus-visible]:outline data-[focus-visible]:outline-blue-600 data-[focus-visible]:-outline-offset-2"
              style={{
