...
function DraggableListBox() {
  ...
  return (
    <ListBox aria-label="Draggable list" selectionMode="multiple" items={items} dragAndDropHooks={dragAndDropHooks}>
      {([id, item]) => <Item id={id} textValue={item.name}><item.style>{item.name}</item.style></Item>}
    </ListBox>
  );
}
...
function DroppableListBox() {
  ...
  return (
    <ListBox aria-label="Draggable list" items={items} dragAndDropHooks={dragAndDropHooks} renderEmptyState={() => "Drop items here"}>
...
function Example() {
  ...
  return (
    <ListBox aria-label="Draggable list" items={files} dragAndDropHooks={dragAndDropHooks} renderEmptyState={() => "Drop items here"}>
      {item => (
        <Item id={item.name}>
