...
@layer listbox {
  .react-aria-ListBox {
    --selectedFilled: slateblue;
    --selectedOutline: white;
  }
    ...
    .react-aria-Item {
      ...
      &[data-selected] {
        ...
        &:after {
          ...
          top: 8px;
          right: 8px;
          background: var(--selectedFilled);
          border: 2px solid var(--selectedOutline);
          color: var(--selectedOutline);
          width: 22px;
          height: 22px;
          border-radius: 22px;
          box-sizing: border-box;
  ...
  @media (forced-colors: active) {
    .react-aria-ListBox {
      --selectedFilled: Highlight;
      --selectedOutline: ButtonText;
    }
  }
}
```
