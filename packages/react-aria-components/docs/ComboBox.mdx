...
<details>
  <summary style={{fontWeight: 'bold'}}><ChevronRight size="S" /> Item</summary>
...
<details>
  <summary style={{fontWeight: 'bold'}}><ChevronRight size="S" /> Button</summary>

<TypeContext.Provider value={docs.links}>
  <InterfaceType properties={docs.exports.ButtonRenderProps.properties} hideType />
</TypeContext.Provider>
