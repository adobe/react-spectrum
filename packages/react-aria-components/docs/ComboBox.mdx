...
import docs from 'docs:../src/ComboBox.tsx';
...
<ComboBox>
  ...
  <Popover>
    <ListBox className="menu">
      <Item className={({isFocused, isSelected}) => clsx('item', {focused: isFocused, selected: isSelected})}>Foo</Item>
      <Item className={({isFocused, isSelected}) => clsx('item', {focused: isFocused, selected: isSelected})}>Bar</Item>
      <Item className={({isFocused, isSelected}) => clsx('item', {focused: isFocused, selected: isSelected})}>Baz</Item>
    </ListBox>
  </Popover>
</ComboBox>
```
...
import {Option} from 'react-aria-components';
    ...
    <ComboBox {...props}>
      ...
      <Popover placement="bottom end">
        <ListBox
          className="menu"
          renderItem={item => (
            <Option item={item} className={({isFocused, isSelected}) => clsx('item', {focused: isFocused, selected: isSelected})}>
