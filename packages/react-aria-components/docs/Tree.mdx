...
interface MyTreeItemProps extends Omit<TreeItemProps, 'textValue' | 'children'>, Partial<Pick<TreeItemProps, 'children'>> {
  title: string
}
        ...
        return (
          <TreeItem
            ...
            <Collection items={item.children}>
              {
                ///- begin highlight -///
                renderItem // same as renderItem function above
                ///- end highlight -///
              }
            </Collection>
          </TreeItem>
...
<Tree aria-label="Tree with onAction applied on the items directly" style={{height: '200px'}} defaultExpandedKeys={['bulbasaur', 'ivysaur']}>
  <TreeItem id="bulbasaur" textValue="Bulbasaur" href="https://pokemondb.net/pokedex/bulbasaur" target="_blank">
    <MyTreeItemContent>
      Bulbasaur
    </MyTreeItemContent>
    <TreeItem id="ivysaur" textValue="Ivysaur" href="https://pokemondb.net/pokedex/ivysaur" target="_blank">
      <MyTreeItemContent>
        Ivysaur
      </MyTreeItemContent>
      <TreeItem id="venisaur" textValue="Venisaur" href="https://pokemondb.net/pokedex/venusaur" target="_blank">
        <MyTreeItemContent>
          Venisaur
        </MyTreeItemContent>
      </TreeItem>
