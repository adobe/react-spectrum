...
```css
@layer checkbox;
@layer checkbox.layout, checkbox.theme, checkbox.selected, checkbox.indeterminate, checkbox.invalid, checkbox.disabled, checkbox.hcm;
@layer checkbox.layout {
  .react-aria-Checkbox {
    display: flex;
    align-items: center;
    gap: 0.571rem;
...
/* this part would move out to a different theme file */
@layer checkbox.theme {
  .react-aria-Checkbox {
