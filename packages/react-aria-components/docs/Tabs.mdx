...
By default, tabs are horizontally oriented. The `orientation` prop can be set to `vertical` to change this. You are responsible for styling your tabs accordingly.
