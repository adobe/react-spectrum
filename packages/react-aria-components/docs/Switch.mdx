...
import Anatomy from "@react-aria-nutrient/switch/docs/anatomy.svg";
...
```tsx example
<MySwitch isSelected isReadOnly>
  Bluetooth
</MySwitch>
```
...
```jsx
<Switch className="my-switch">{/* ... */}</Switch>
```
