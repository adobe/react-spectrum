...
<ClassAPI links={docs.links} class={docs.links[docs.exports.useCalendarState.return.base.id]} />

## Example

See the docs for [useCalendar](useCalendar.html) in react-aria for an example of `useCalendarState`.
