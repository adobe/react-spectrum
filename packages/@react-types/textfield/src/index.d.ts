...
export interface TextFieldProps extends InputBase, Validation, FocusableProps<HTMLInputElement | HTMLTextAreaElement>, TextInputBase, ValueBase<string>, LabelableProps {}
