...
export interface Calendar {
  ...
  /**
   * Returns a date representing the month of the given date
   * in a formattable calendar. This allows changing how month
   * names in a calendar component are formatted.
   */
