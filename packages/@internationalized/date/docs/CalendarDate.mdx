...
### Each month of interval

The <TypeLink links={docs.links} type={docs.exports.eachMonthOfInterval} /> function returns an array of the start dates of each month within the specified date interval. The function ensures that the start date is before the end date and initializes the hours and minutes to 0 for each start date returned within the interval.

```tsx
import {eachMonthOfInterval, CalendarDateTime} from '@internationalized/date';

let start = new CalendarDateTime(2023, 11, 15, 9, 20);
let end = new CalendarDateTime(2024, 2, 10, 9, 0);

eachMonthOfInterval(start, end); 
// => [ 2023-11-01T00:00, 2023-12-01T00:00, 2024-01-01T00:00, 2024-02-01T00:00 ]
```
