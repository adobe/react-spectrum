...
date.add({weeks: 1}); // 2022-02-09T09:45
...
```tsx
let date = new CalendarDate(2022, 2, 3, 9, 22);
...
```tsx
let date = new CalendarDate(2022, 2, 3, 11);
...
isSameMonth(new CalendarDateTime(2021, 4, 16, 9, 45), new CalendarDateTime(2021, 4, 30, 5, 15)); // true
isSameMonth(new CalendarDateTime(2021, 4, 16, 9, 45), new CalendarDateTime(2021, 8, 2, 5, 15)); // false
isSameMonth(new CalendarDateTime(2021, 4, 16, 9, 45), new CalendarDateTime(new IslamicUmalquraCalendar(), 1442, 9, 4, 5, 15)); // false
```
