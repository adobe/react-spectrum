...
import ariaDocs from "docs:@react-aria-nutrient/selection";
...
category: Selection
keywords: [selection manager, collection, state]

---

# SelectionManager

<PageDescription>{docs.exports.SelectionManager.description}</PageDescription>

<HeaderInfo packageData={packageData} componentNames={["SelectionManager"]} />
