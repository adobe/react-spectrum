...
import selectDocs from "docs:@react-aria-nutrient/select";
import {
  HeaderInfo,
  TypeContext,
  InterfaceType,
...
<PageDescription>
  {collectionsDocs.exports.Collection.description}
</PageDescription>
...
<ClassAPI
  links={collectionsDocs.links}
  class={collectionsDocs.exports.Collection}
/>
