...
export interface MenuTriggerWithSubmenuState extends MenuTriggerState {
 ...
 */
export function useMenuTriggerState(props: MenuTriggerProps): MenuTriggerWithSubmenuState  {
