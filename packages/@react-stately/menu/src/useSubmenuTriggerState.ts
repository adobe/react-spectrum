...
import {MenuTriggerWithSubmenuState} from './useMenuTriggerState';
 ...
 */
export function UNSTABLE_useSubmenuTriggerState(props: SubmenuTriggerProps, state: MenuTriggerWithSubmenuState): SubmenuTriggerState  {
