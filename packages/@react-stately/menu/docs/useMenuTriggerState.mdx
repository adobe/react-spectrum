...
---
category: Overlays
keywords: [menu trigger, state]
---

# useMenuTriggerState

<PageDescription>{docs.exports.useMenuTriggerState.description}</PageDescription>
...
See the docs for [useMenu](/react-aria/useMenu.html) in react-aria for an example of `useMenuTriggerState`.
