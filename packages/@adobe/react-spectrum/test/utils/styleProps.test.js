...
import {convertStyleProps, dimensionValue, viewStyleProps} from '../../src/utils/styleProps';
...
describe('styleProps', function () {
  ...
  describe('backgroundColorValue', () => {
    it('falsy', () => {
      let style = convertStyleProps({backgroundColor: {S: 'gray-50'}}, viewStyleProps, 'ltr', [
        'base'
      ]);
  ...
  describe('borderColorValue', () => {
    ...
    it('gray-50, version 5', () => {
      let style = convertStyleProps({borderColor: {S: 'gray-50'}}, viewStyleProps, 'ltr', [
        'base',
        'S'
      ]);
  ...
  describe('borderRadiusValue', () => {
    ...
    it('small', () => {
      let style = convertStyleProps({borderRadius: {S: 'small'}}, viewStyleProps, 'ltr', [
        'base',
        'S'
      ]);
  ...
  describe('borderSizeValue', function () {
    it('should default to 0 if base is undefined', function () {
      ...
      style = convertStyleProps({borderEndWidth: {S: 'thin'}}, viewStyleProps, 'ltr', [
        'S',
        'base'
      ]);
