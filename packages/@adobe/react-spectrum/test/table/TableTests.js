...
import {CRUDExample} from '../../stories/table/CRUDExample';
  ...
  describe('keyboard focus', function () {
    ...
    describe('PageDown', function () {
      it('should focus the cell a page below', function () {
        ...
        focusCell(tree, 'Foo 1');
        moveFocus('PageDown');
        expect(document.activeElement).toBe(getCell(tree, 'Foo 5'));
        moveFocus('PageDown');
        expect(document.activeElement).toBe(getCell(tree, 'Foo 9'));
        moveFocus('PageDown');
        expect(document.activeElement).toBe(getCell(tree, 'Foo 13'));
        moveFocus('PageDown');
        expect(document.activeElement).toBe(getCell(tree, 'Foo 17'));
        moveFocus('PageDown');
        expect(document.activeElement).toBe(getCell(tree, 'Foo 21'));
      });
      ...
      it('should focus the row a page below', function () {
        ...
        moveFocus('PageDown');
        expect(document.activeElement).toBe(tree.getByRole('row', {name: 'Foo 9'}));
        moveFocus('PageDown');
        expect(document.activeElement).toBe(tree.getByRole('row', {name: 'Foo 13'}));
        moveFocus('PageDown');
        expect(document.activeElement).toBe(tree.getByRole('row', {name: 'Foo 17'}));
        moveFocus('PageDown');
        expect(document.activeElement).toBe(tree.getByRole('row', {name: 'Foo 21'}));
      });
    });
    ...
    describe('PageUp', function () {
      it('should focus the cell a page above', function () {
        let tree = renderMany();
        focusCell(tree, 'Foo 5');
        moveFocus('PageUp');
        expect(document.activeElement).toBe(getCell(tree, 'Foo 1'));
        focusCell(tree, 'Foo 3');
        moveFocus('PageUp');
        expect(document.activeElement).toBe(getCell(tree, 'Foo 1'));
      });
  ...
  describe('selection', function () {
    ...
    describe('select all', function () {
      ...
      it('should deselect an item after selecting all', async function () {
        ...
        await user.click(tree.getByTestId('selectAll'));
