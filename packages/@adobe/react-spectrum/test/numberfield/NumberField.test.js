...
describe('NumberField', function () {
  ...
  function renderNumberField(props = {}, providerProps = {}) {
    ...
    let {container, debug, rerender} = render(
      <Provider theme={theme} scale={scale} locale={locale}>
        <NumberField aria-label="labelled" {...props} />
      </Provider>
    );
  ...
  `('$Name has correct aria and props', () => {
    let {container, textField, incrementButton, decrementButton} = renderNumberField();
  ...
  `(
    '$Name uses inputMode=$inputMode on $platform $UA with $props',
    ({props, platform, UA, inputMode}) => {
  ...
  `('$Name switches to numeric for percentages', async () => {
    let {textField} = renderNumberField({onChange: onChangeSpy, formatOptions: {style: 'percent'}});
  ...
  `('$Name fires state change then blur', async () => {
    ...
    expect(onChangeSpy.mock.invocationCallOrder[0]).toBeLessThan(
      onBlurSpy.mock.invocationCallOrder[0]
    );
  });
  ...
  `('$Name will not allow typing of a number less than the min', async () => {
    let {container, textField} = renderNumberField({onChange: onChangeSpy, minValue: 0});
  ...
  it.each`
    ...
    ${'NumberField'}
  `(
    '$Name will allow typing of a number less than the min when value snapping is disabled',
    async () => {
      let {container, textField} = renderNumberField({
        onChange: onChangeSpy,
        minValue: 10,
  ...
  `('$Name will allow typing of a number between min and max', async () => {
    let {textField} = renderNumberField({onChange: onChangeSpy, minValue: 20, maxValue: 50});
  ...
  it.each`
    ...
    ${'NumberField'}
  `(
    '$Name will allow typing of a number greater than the max when value snapping is disabled',
    async () => {
      let {container, textField} = renderNumberField({
        onChange: onChangeSpy,
        maxValue: 1,
  ...
  `('$Name decrement value when scrolling down', () => {
    let {textField} = renderNumberField(
      {defaultValue: 0, onChange: onChangeSpy},
      {locale: 'ar-AE'}
    );
  ...
  `(
    ...
    async () => {
      let {container, decrementButton} = renderNumberField({
        onChange: onChangeSpy,
        minValue: 3,
        value: 3
      });
  ...
  `(
    ...
    async () => {
      let {container, incrementButton} = renderNumberField({
        onChange: onChangeSpy,
        maxValue: 3,
        value: 3
      });
  ...
  `('$Name properly formats percents as a unit', async () => {
    let {textField} = renderNumberField({
      onChange: onChangeSpy,
      value: 10,
      formatOptions: {style: 'unit', unit: 'percent', signDisplay: 'always'}
    });
  ...
  `(
    '$Name pressing up arrow & down arrow keeps focus state formatting',
    ({props, locale, expected}) => {
      let {textField} = renderNumberField(
        {defaultValue: 10, onKeyDown: onKeyDownSpy, onKeyUp: onKeyUpSpy, ...props},
        {locale}
      );
  ...
  `(
    '$Name 10 is rendered and will not change the value in the input for steppers',
    async ({props}) => {
  ...
  it.each`
    ...
    ${'NumberField controlled'} | ${{value: 10, onChange: onChangeSpy}}
  `(
    '$Name 10 is rendered and will not change the value in the input for typed text',
    async ({props}) => {
      let {textField} = renderNumberField(props);
      expect(textField).toHaveAttribute('value', '10');
      act(() => {
    ...
    function NumberFieldControlled(props) {
      ...
      return (
        <Provider theme={theme} scale="medium" locale="en-US">
          <NumberField
            {...props}
            label="you shall not change"
            formatOptions={{style: 'currency', currency: 'EUR'}}
            value={value}
            onChange={chain(setValue, onChange)}
          />
        </Provider>
      );
    }
  ...
  `(
    ...
    async () => {
      let {textField, decrementButton, incrementButton} = renderNumberField({
        onChange: onChangeSpy,
        defaultValue: 1,
        maxValue: 1
      });
  ...
  it.each(locales)('%s can have latin numerals entered', async locale => {
    let {textField} = renderNumberField(
      {onChange: onChangeSpy, formatOptions: {style: 'currency', currency: 'USD'}},
      {locale}
    );
    ...
    let formatter = new Intl.NumberFormat(locale + '-u-nu-latn', {
      style: 'currency',
      currency: 'USD'
    });
  ...
  it.each(locales)('%s can have latin numerals entered with SAR', async locale => {
    let {textField} = renderNumberField(
      {onChange: onChangeSpy, formatOptions: {style: 'currency', currency: 'SAR'}},
      {locale}
    );
    act(() => {
      textField.focus();
  ...
  it.each(locales)('%s can have arabic numerals entered', async locale => {
    ...
    let formatter = new Intl.NumberFormat(locale + '-u-nu-arab', {
      style: 'currency',
      currency: 'USD'
    });
    expect(textField).toHaveAttribute('value', formatter.format(21));
  ...
  it.each(locales)('%s can have hanidec numerals entered', async locale => {
    ...
    let formatter = new Intl.NumberFormat(locale + '-u-nu-hanidec', {
      style: 'currency',
      currency: 'USD'
    });
    expect(textField).toHaveAttribute('value', formatter.format(21));
  ...
  it.each(locales)('%s can have devanagari numerals entered', async locale => {
    ...
    let formatter = new Intl.NumberFormat(locale + '-u-nu-deva', {
      style: 'currency',
      currency: 'USD'
    });
    expect(textField).toHaveAttribute('value', formatter.format(21));
  ...
  it.each(locales)('%s can have bengali numerals entered', async locale => {
    ...
    let formatter = new Intl.NumberFormat(locale + '-u-nu-beng', {
      style: 'currency',
      currency: 'USD'
    });
    expect(textField).toHaveAttribute('value', formatter.format(21));
  ...
  describe('beforeinput', () => {
    ...
    it.each([
      ...
      'deleteByCut',
      'deleteByDrag'
    ])('allows %s of whole currency symbol', async inputType => {
      let {textField} = renderNumberField({
        onChange: onChangeSpy,
    ...
    it.each([
      ...
      'deleteByCut',
      'deleteByDrag'
    ])('prevents %s of partial currency symbol', async inputType => {
      let {textField} = renderNumberField({
        onChange: onChangeSpy,
        formatOptions: {style: 'currency', currency: 'USD', currencyDisplay: 'code'}
      });
    ...
    it.each(['deleteContentBackward', 'deleteContentForward'])(
      'prevents %s inside currency symbol',
      async inputType => {
        let {textField} = renderNumberField({
          onChange: onChangeSpy,
          formatOptions: {style: 'currency', currency: 'USD', currencyDisplay: 'code'}
    ...
    ])('allows %s of number inside number', async inputType => {
      let {textField} = renderNumberField({
        onChange: onChangeSpy,
        formatOptions: {style: 'currency', currency: 'USD', currencyDisplay: 'code'}
      });
    ...
    it.each([
      ...
      'insertFromYank',
      'insertReplacementText'
    ])('allows %s replacing whole number', async inputType => {
      let {textField} = renderNumberField({
        onChange: onChangeSpy,
        formatOptions: {style: 'currency', currency: 'USD', currencyDisplay: 'code'}
      });
    ...
    it.each([
      ...
      'insertFromYank',
      'insertReplacementText'
    ])('prevents %s of number inside currency symbol', async inputType => {
      let {textField} = renderNumberField({
        onChange: onChangeSpy,
        formatOptions: {style: 'currency', currency: 'USD', currencyDisplay: 'code'}
      });
    ...
    function NumberFieldControlled(props) {
      ...
      return (
        <Provider theme={theme} scale="medium" locale="en-US">
          <NumberField
            {...props}
            label="reset to blank using null"
            value={value}
            onChange={value => setValue(value)}
          />
          <Button variant={'primary'} onPress={() => chain(setValue(null), onChange())}>
            Reset
          </Button>
        </Provider>
      );
          ...
          <Provider theme={theme}>
            <Form data-testid="form">
              <NumberField
                ...
                step={2}
                validationBehavior="native"
                validate={v => (v !== 4 ? 'Invalid value' : null)}
              />
            </Form>
          </Provider>
        );
          ...
          <Provider theme={theme}>
            <Form data-testid="form">
              <NumberField
                ...
                label="Value"
                defaultValue={2}
                validate={v => (v === 2 ? 'Invalid value' : null)}
              />
            </Form>
          </Provider>
        );
