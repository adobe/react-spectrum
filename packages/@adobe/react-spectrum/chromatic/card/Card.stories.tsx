...
import {useSlotProps} from '../../src/utils/Slots';
import {useStyleProps} from '../../src/utils/styleProps';
  ...
  args: {
    children: (
      <>
        ...
        <Text slot="detail">PNG</Text>
        <Content>
          This is the description that never ends, it goes on and on my friends. Someone started
          typing without knowing what it was.
        </Content>
      </>
    )
  }
...
export const WithColorfulIllustration: CardStory = {
  ...
  parameters: {
    description: {data: 'ignore the no white background, the svg just has a transparent background'}
  }
};
...
export const WithColorfulIllustratedMessage: CardStory = {
  ...
  parameters: {
    description: {
      data: 'does not work right now, Illustrated Message messes with the styles and has some other interference. We may not even want to support it this way.'
    }
  }
};
  ...
  args: {
    children: (
      <>
        ...
        <Heading>
          This is a long title about how dinosaurs used to rule the earth before a meteor came and
          wiped them all out
        </Heading>
        <Text slot="detail">PNG</Text>
        <Content>Description</Content>
  ...
  args: {
    children: (
      <>
        ...
        <Text slot="detail">PNG</Text>
        <Content>
          This is a long description about the Pterodactyl, a pterosaur of the late Jurassic period,
          with a long slender head and neck and a very short tail.
        </Content>
      </>
    )
  }
  ...
  args: {
    children: (
      <>
        ...
        <Heading>Title</Heading>
        <Text slot="detail">
          Stats: Genus: Pterodactylus; Rafinesque, 1815 Order: Pterosauria Kingdom: Animalia Phylum:
          Chordata
        </Text>
        <Content>Description</Content>
      </>
...
function IllustrationContainer(props) {
  ...
  let {styleProps} = useStyleProps(props);
  return <div {...styleProps}>{props.children}</div>;
}
  ...
  return (
    <svg viewBox="0 0 612 792">
      ...
      <g id="Trace" className="st0">
        <path
          className="st2"
          d="M284,279c-62.23,0-113.75,45.84-122.64,105.59l18.01-3.33c0,0,17.1-40.07,71.34-42.02
        ...
        <g className="st1">
          <path
            d="M254.12,428.65c1.9-4.77,3.97-9.47,6.15-14.13c1.09-2.33,2.21-4.65,3.39-6.94c1.16-2.31,2.59-4.47,4.02-6.65
        ...
        <g className="st1">
          <path
            d="M273.67,476.54l9.84,3.73l-0.24,0.08c1.86-3.18,3.91-6.25,6.27-9.11c1.19-1.42,2.46-2.79,3.95-3.96
        ...
        <g className="st1">
          <path
            d="M195.49,410.09c1.67-2.31,3.44-4.53,5.24-6.74c2.02-1.98,4.03-3.97,6.12-5.9c1.06-0.97,2.08-1.92,3.3-2.83
        ...
        <g className="st1">
          <path
            d="M285.71,397.72l5.31,4.57c1.77,1.52,3.51,3.08,5.27,4.62l-0.71-0.15c1.48-0.63,2.84-1.66,4.12-2.78
        ...
        <path
          className="st3"
          d="M201.84,403.73c0,0-1.95,18.57,18.57,22.48c14.68,2.8,19.54-14.17,19.54-14.17"
        />
        <path
          className="st1"
          d="M227.06,405.91c-3.52-2.29-7.22-4.8-10.25-6.82c-0.63,2.35-0.88,5.33-0.62,8.56
        ...
        <path
          className="st1"
          d="M308.48,396.98c-2.86,2.56-6.55,6.66-10.05,9.01c0.49,5.42,3.37,9.59,6.66,9.44c3.45-0.16,6.03-4.99,5.77-10.8
        ...
        <g className="st1">
          <path
            d="M295.13,493.16c-0.09-1.59-0.04-2.97,0.03-4.43c0.08-1.44,0.23-2.87,0.41-4.29c0.37-2.84,0.93-5.65,1.67-8.41
        ...
        <g className="st1">
          <path
            d="M254.06,449.02c2.54-1.57,5.12-3.07,7.79-4.43c1.34-0.68,2.69-1.34,4.1-1.91c0.72-0.28,1.42-0.56,2.23-0.74
        ...
        <g className="st1">
          <path
            d="M339.52,425.68c0.11-0.16,0.15-0.18,0.21-0.24c0.06-0.06,0.11-0.09,0.16-0.13c0.1-0.08,0.2-0.15,0.29-0.19
        ...
        <g className="st1">
          <path
            d="M341.94,424.24c0.21-0.3,0.45-0.79,0.63-1.23c0.2-0.45,0.36-0.93,0.51-1.42c0.29-0.97,0.49-1.99,0.63-3.01
        ...
        <g className="st1">
          <path
            d="M359.23,408.73c0.16-0.32,0.32-0.87,0.41-1.35c0.11-0.5,0.16-1.02,0.2-1.54c0.07-1.05-0.01-2.12-0.16-3.19
        ...
        <g className="st1">
          <path
            d="M362.94,403.96c1.01,0.16,2.12,0.25,3.2,0.28c1.09,0.03,2.18-0.01,3.27-0.1c1.09-0.09,2.17-0.28,3.24-0.54
        ...
        <path
          className="st4"
          d="M344.03,417.9c-3.42,0.24-5.05-8.94-7.08-19.54c-1.22-6.35-2.44-13.44-1.47-21.01
        c1.47-0.49,10.02,15.64,10.99,20.03C347.45,401.78,347.45,417.66,344.03,417.9z"
        />
        <path
          className="st4"
          d="M359.42,400.56c-6.35-1.47-13.19-32.25-10.99-35.91C352.82,366.11,365.77,395.92,359.42,400.56z"
        />
        <path
          className="st4"
          d="M367.72,404.22c0,0,8.79-13.19,31.76-10.26C398.26,399.83,371.39,414.48,367.72,404.22z"
        />
        <path
          className="st4"
          d="M347.2,425.72c0,0,4.15,9.53,16.12,9.28c11.97-0.24,26.63-7.82,26.87-11.24c-1.71-1.22-15.64,4.4-24.92,2.2
        c-4.57-1.08-16.12-1.22-16.12-1.22L347.2,425.72z"
        />
        <path
          className="st4"
          d="M386.29,355.12c-3.66,2.2-16.86,18.32-18.32,26.14c-1.47,7.82,5.08,8.73,8.79,4.4
        C379.7,382.24,387.02,360.25,386.29,355.12z"
        />
        <g className="st1">
          <path
            d="M292.79,408.06c3.51,2.95,7,5.94,10.38,9.06c1.69,1.56,3.36,3.14,5.02,4.75c1.64,1.64,3.33,3.2,4.69,5.24l-1.01-0.44
      ...
      <g id="Brushes" className="st0">
        <path
          className="st4"
          d="M165.41,383.22c5.62,2.5,12.37,0.01,16.97-4.07c4.61-4.08,7.72-9.53,11.52-14.36
        ...
        <path
          className="st4"
          d="M314.12,384.58c-0.82,4.43,1.18,8.88,3.54,12.71c2.37,3.83,5.19,7.51,6.31,11.87c0.51,1.99,0.57,4.07,0.26,6.1
        ...
        <path
          className="st4"
          d="M256.3,448.41c3.07-3.17,7.78-4.31,12.18-4.01c4.4,0.3,8.61,1.86,12.74,3.4c12.48,4.66,25.71,9.38,38.19,14.04
        ...
        <path
          className="st4"
          d="M274.39,475.98c2.35,1.38,5,2.8,7.66,2.22c2.87-0.64,4.69-3.36,6.56-5.63c5.89-7.14,15.13-11.38,24.38-11.18"
        />
        <path
          className="st4"
          d="M297.62,492.94c-0.68-15.73,4.81-31.66,15.04-43.63c6.24-7.3,14.05-13.06,21.86-18.67
        ...
        <path
          className="st4"
          d="M337.11,390.92c2.9,4.01,5.81,8.03,8.71,12.04c1.15,1.59,2.31,3.2,3.02,5.03c0.71,1.83,0.91,3.93,0.14,5.74
        c-3.43,7.95-8.79-1.72-10.21-5.23c-1.13-2.81-1.85-5.78-2.13-8.8C336.51,398.22,337.73,391.77,337.11,390.92z"
        />
        <path
          className="st4"
          d="M351.13,434.48c1.95,1.64,4.54,2.35,7.09,2.54c7.09,0.54,14.36-2.83,18.53-8.59
        c-4.64,0.65-9.26-0.97-13.82-2.04c-3.9-0.91-8.45-1.47-12.19,0.37C347.25,428.48,348.42,432.2,351.13,434.48z"
        />
        <path
          className="st4"
          d="M349.95,374.81c2.51,3.7,5.86,6.77,8.34,10.49c1.87,2.81,3.62,6.71,2.88,10.17c-0.65,3.02-3.35,5.6-5.92,2.78
        c-2.32-2.54-3.11-7.67-3.84-10.91C350.49,383.23,349.99,379.02,349.95,374.81z"
        />
        <path
          className="st4"
          d="M391.44,395.99c-0.44,0.02-3.68,5.01-4.33,5.64c-1.8,1.78-3.88,3.3-6.13,4.47c-3.03,1.57-8.29,3.38-9.46-1.17
        C368.76,394.27,385.91,396.24,391.44,395.99z"
        />
        <path
          className="st4"
          d="M365.56,376.89c1.6-1.94,4.19-2.67,6.49-3.69c4.9-2.18,8.97-6.17,11.25-11.02c1.16,5.68,1.56,11.51,1.18,17.29
        c-0.19,2.9-0.66,5.98-2.6,8.14C376.04,394.12,359.15,384.67,365.56,376.89z"
        />
        <path
          className="st4"
          d="M249.08,405.11c-2.35,3.54-6.23,6.3-10.48,6.31c-3.85,0.01-7.37-2.19-10.28-4.72s-5.46-5.5-8.71-7.58
      ...
      <g id="Trace_copy" className="st0">
        ...
        <path
          className="st4"
          d="M347.2,425.72c0,0,4.15,9.53,16.12,9.28c11.97-0.24,26.63-7.82,26.87-11.24c-1.71-1.22-15.6,4.23-24.92,2.2
        C355.92,423.93,347.2,425.72,347.2,425.72z"
        />
        <path
          className="st1"
          d="M292.79,408.06c3.51,2.95,7,5.94,10.38,9.06c1.69,1.56,3.36,3.14,5.02,4.75c1.64,1.64,3.33,3.2,4.69,5.24
        ...
        <g className="st1">
          <path
            d="M305.69,456.45c-0.75,1.22-1.48,2.46-2.16,3.71c-2.69,5.01-4.82,10.33-6.29,15.85c-0.73,2.76-1.3,5.57-1.67,8.41
          ...
          />
          <path
            d="M370.06,388.01c-0.84,2.61-1.91,5.18-3.06,7.68c-0.56,1.26-1.22,2.48-1.84,3.71c-0.69,1.19-1.3,2.43-2.06,3.59
        ...
        <path
          className="st1"
          d="M228.47,407.89c-0.01-0.29,0.03-0.94,0-1.22c-3.52-2.29-8.63-5.55-11.66-7.57c-0.63,2.35-1.02,5.35-0.62,8.56
        ...
        <path
          id="SVGID_x5F_1_x5F_"
          className="st5"
          d="M284,519.85c64.43,0,116.85-52.42,116.85-116.85c0-64.43-52.42-116.85-116.85-116.85
        c-64.43,0-116.85,52.42-116.85,116.85C167.15,467.43,219.57,519.85,284,519.85z"
        />
        <text className="st1">
          {' '}
          <textPath startOffset="1165.844%">
            <tspan
              style={{
      ...
      <g id="Colors">
        <path
          className="st6"
          d="M333.93,516.09c0.72-0.32,1.44-0.63,2.15-0.97l-2.63-1.23c-1.86-5.77-8.31-15.7-8.31-15.7
        ...
        <path
          className="st8"
          d="M254.12,428.82c2.44-6.76,15.71-31.95,18.89-32.25c3.18-0.3,34.85,25.73,39.09,36.48
        ...
        <path
          className="st8"
          d="M315.04,462.69c0,0-12.38,0.98-18.57,3.26c-6.19,2.28-13.1,14.67-13.1,14.67s-6.93-3.03-9.7-4.25
        c-2.56-1.13-19.22-27.36-19.22-27.36l14.49-6.88l46.1,18.6V462.69z"
        />
        <path
          className="st9"
          d="M211.78,394.94l-10.42,9.45c0,0,0.63,20.78,21.5,22.48c12.05,0.98,16.29-14.33,16.29-14.33L211.78,394.94z"
        />
        <path
          className="st9"
          d="M312.43,428.16c0,0,11.15-5.23,6.84-22.48c-3.26-13.03-7.49-10.75-7.49-10.75l-15.64,13.03l-1.63,1.95
        L312.43,428.16z"
        />
        <path
          className="st10"
          d="M335.72,378.08c0,0-0.86,5.5-0.73,7.7c0.12,2.2,4.52,24.8,4.52,24.8s2.32,6.6,3.18,7.08
        c0.86,0.49,2.2-0.12,2.2-0.12l1.71-4.89c0,0,0.86-12.09,0.12-14.17C345.98,396.41,339.51,379.79,335.72,378.08z"
        />
        <polygon
          className="st10"
          points="347.94,426.7 350.62,430.49 357.22,434.27 364.67,435 373.59,433.42 383.6,429.39 389.47,425.6
        390.08,423.89 387.76,423.64 377.99,425.6 368.7,426.58 360.03,425.11 350.38,424.99 	"
        />
        <polygon
          className="st10"
          points="367.72,404.34 372.86,399.09 381.04,395.18 387.02,394.08 396.43,393.72 399.48,394.08
        397.65,397.02 392.89,400.68 384.34,405.32 378.6,407.15 372.61,407.89 368.82,406.06 	"
        />
        <polygon
          className="st10"
          points="359.42,400.56 357.22,399.09 354.04,393.72 349.4,378.33 348.06,367.33 348.55,364.65 352.09,368.55
        357.22,378.94 361.13,392.62 361.13,397.87 	"
        />
        <path
          className="st11"
          d="M384.42,360.74c-4.4,7.82-18.08,14.01-20.68,18.73s7.03,8.72,7.03,8.72s7.94,3.47,9.75,1.05
        C386.05,381.82,383.12,373.74,384.42,360.74z M377.09,382.6l-5.21-2.97l6.93-5.27L377.09,382.6z"
        />
        <path
          id="SVGID_x5F_00000080910466905454608670000016559596414473353368_x5F_"
          className="st12"
          d="M284,519.85
      ...
      <g id="Trace_w_x2F_shading">
        ...
        <path
          className="st14"
          d="M384.42,360.74c-4.4,7.82-18.08,14.01-20.68,18.73c-2.61,4.72,7.03,8.72,7.03,8.72s7.94,3.47,9.75,1.05
