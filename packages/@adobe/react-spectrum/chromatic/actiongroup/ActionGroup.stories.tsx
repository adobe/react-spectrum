...
import {ActionGroup, SpectrumActionGroupProps} from '../../src/actiongroup/ActionGroup';
...
export function Render(
  props: Omit<SpectrumActionGroupProps<unknown>, 'children'> & {items: any}
): JSX.Element {
  return (
