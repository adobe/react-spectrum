...
import {ColorArea, SpectrumColorAreaProps} from '../../src/color/ColorArea';
import {ColorField} from '../../src/color/ColorField';
import {ColorSlider} from '../../src/color/ColorSlider';
import {ColorSwatch} from '../../src/color/ColorSwatch';
...
function ColorAreaExample(props: SpectrumColorAreaProps) {
  ...
  return (
    <div
      role="group"
      aria-label={`${ariaLabel ? `${ariaLabel} ` : ''}${colorSpace.toUpperCase()} Color Picker`}>
