...
import {ActionBarContainer} from '../../src/actionbar/ActionBarContainer';
...
export const items: any = [
  ...
  {key: 'e', name: 'Utilities', type: 'folder', children: [{key: 1, name: 'Activity Monitor'}]},
  ...
  render: args => (
    <ListView disabledKeys={['3']} width="250px" aria-label="default ListView" {...args}>
      <Item key="1" textValue="Adobe Photoshop">
        <Badge variant="neutral">2</Badge>Adobe Photoshop
      </Item>
      ...
      <Flex direction="row">
        ...
        <div style={{paddingLeft: '10px'}}>
          <ActionButton
            ...
            onPress={() =>
              setDivProps({
                style: {display: 'flex', flexGrow: 1, minWidth: '200px', maxHeight: '500px'}
              })
            }>
...
function Demo(props: Omit<SpectrumListViewProps<any>, 'children'>): JSX.Element {
  let [items, setItems] = useState<{key: number; label: string}[]>([{key: 1, label: 'utilities'}]);
  let onDelete = key => {
