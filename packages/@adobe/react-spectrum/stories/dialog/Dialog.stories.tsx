          ...
          <Dialog {...props}>
            ...
            <Content>
              <Form>
                ...
                <Button UNSAFE_style={{display: 'none'}} variant="primary">
                  Hidden
                </Button>
                <Button
                  UNSAFE_style={{visibility: 'hidden', position: 'absolute'}}
                  variant="primary">
                  Hidden
                </Button>
  ...
  return (
    <div style={{display: 'flex', width, margin: '100px 0'}}>
      <Button
        variant="primary"
        onPress={() => {
          whichLabels ? setWhichLabels(0) : setWhichLabels(1);
        }}>
        Toggle labels
      </Button>
      <DialogTrigger defaultOpen>
        ...
        {close => (
          <Dialog {...props}>
            ...
            <ButtonGroup>
              <Button variant="secondary" onPress={close}>
                {labels[whichLabels].secondaryButtonLabel}
              </Button>
              <Button variant="primary" onPress={close}>
                {labels[whichLabels].primaryButtonLabel}
              </Button>
              <Button variant="cta" onPress={close} autoFocus>
                CTA
              </Button>
