...
import comboboxUtils from 'docs:@react-aria/test-utils';
...
## Content
ComboBox follows the [Collection Components](collections.html) API, accepting both static and dynamic collections.
