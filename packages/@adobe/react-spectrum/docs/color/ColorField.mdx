...
Alternatively, a controlled value can be provided using the `value` prop.  The value provided to either of these props should be a color string or <TypeLink links={statelyDocs.links} type={statelyDocs.exports.Color} /> object.
