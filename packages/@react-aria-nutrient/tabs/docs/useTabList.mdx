...
import docs from "docs:@react-aria-nutrient/tabs";
...
import packageData from "@react-aria-nutrient/tabs/package.json";
...
<TypeContext.Provider value={docs.links}>
  <InterfaceType
    properties={docs.links[docs.exports.useTabList.return.id].properties}
  />
...
<TypeContext.Provider value={docs.links}>
  <InterfaceType
    properties={docs.links[docs.exports.useTab.return.id].properties}
  />
</TypeContext.Provider>
...
<TypeContext.Provider value={docs.links}>
  <InterfaceType
    properties={docs.links[docs.exports.useTabPanel.return.id].properties}
  />
</TypeContext.Provider>
