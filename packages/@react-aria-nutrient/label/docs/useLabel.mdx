...
import docs from "docs:@react-aria-nutrient/label";
import { FunctionAPI, HeaderInfo, PageDescription } from "@react-spectrum/docs";
import packageData from "@react-aria-nutrient/label/package.json";
...
<HeaderInfo packageData={packageData} componentNames={["useLabel"]} />
