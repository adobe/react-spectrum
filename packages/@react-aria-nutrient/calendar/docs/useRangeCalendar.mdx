...
<HeaderInfo packageData={packageData} componentNames={["useRangeCalendar"]} />
...
<TypeContext.Provider value={docs.links}>
  <InterfaceType
    properties={docs.links[docs.exports.useRangeCalendar.return.id].properties}
  />
...
<TypeLink links={docs.links} type={docs.exports.useRangeCalendar} /> uses the [@internationalized/date](../internationalized/date/)
...
<TypeLink
  ...
  type={statelyDocs.exports.useRangeCalendarState}
