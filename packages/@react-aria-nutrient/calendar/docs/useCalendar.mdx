...
<HeaderInfo packageData={packageData} componentNames={["useCalendar"]} />
...
<TypeContext.Provider value={docs.links}>
  <InterfaceType
    properties={docs.links[docs.exports.useCalendar.return.id].properties}
  />
...
<TypeContext.Provider value={docs.links}>
  <InterfaceType
    properties={docs.links[docs.exports.useCalendarGrid.return.id].properties}
  />
</TypeContext.Provider>
...
<TypeContext.Provider value={docs.links}>
  <InterfaceType
    properties={docs.links[docs.exports.useCalendarCell.return.id].properties}
  />
</TypeContext.Provider>
...
<TypeLink links={docs.links} type={docs.exports.useCalendar} /> uses the [@internationalized/date](../internationalized/date/)
...
<TypeLink
  ...
  type={statelyDocs.exports.useCalendarState}
...
```tsx example render=false export=true
import { useCalendarCell } from "@react-aria-nutrient/calendar";
...
function Example() {
  return (
    <Calendar firstDayOfWeek="sun" createCalendar={() => new Custom454()} />
  );
}
