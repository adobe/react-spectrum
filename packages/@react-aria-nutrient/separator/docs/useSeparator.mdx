...
import docs from "docs:@react-aria-nutrient/separator";
import {
  HeaderInfo,
  FunctionAPI,
  TypeContext,
...
import packageData from "@react-aria-nutrient/separator/package.json";

---

category: Content
keywords: [vertical separator, horizontal separator, separator, hr, aria]
...
<TypeContext.Provider value={docs.links}>
  <InterfaceType
    properties={docs.links[docs.exports.useSeparator.return.id].properties}
  />
