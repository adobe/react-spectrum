...
<FunctionAPI
  function={docs.exports.useToggleButtonGroupItem}
  links={docs.links}
/>
...
<TypeContext.Provider value={docs.links}>
  <InterfaceType
    properties={
      docs.links[docs.exports.useToggleButtonGroup.return.id].properties
    }
  />
...
<TypeContext.Provider value={docs.links}>
  <InterfaceType
    properties={
      docs.links[docs.exports.useToggleButtonGroupItem.return.base.id]
        .properties
    }
  />
</TypeContext.Provider>
...
} from "@react-aria-nutrient/button";
