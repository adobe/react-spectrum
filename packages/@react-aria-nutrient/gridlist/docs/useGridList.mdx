...
import docs from "docs:@react-aria-nutrient/gridlist";
...
import packageData from "@react-aria-nutrient/gridlist/package.json";
...
<PageDescription>
  ...
  with interactive children. A grid list displays data in a single column and
  enables a user to navigate its contents via directional navigation keys.
</PageDescription>
...
<FunctionAPI
  function={docs.exports.useGridListSelectionCheckbox}
  links={docs.links}
/>
...
<Anatomy
  role="img"
  aria-label="Anatomy diagram of a list container, consisting of multiple list items. Each list item contains a selection checkbox, a list item row, and a list item cell."
/>
...
<TypeContext.Provider value={docs.links}>
  <InterfaceType
    properties={docs.links[docs.exports.useGridList.return.id].properties}
  />
...
<TypeContext.Provider value={docs.links}>
  <InterfaceType
    properties={docs.links[docs.exports.useGridListItem.return.id].properties}
  />
</TypeContext.Provider>
...
import { useGridList, useGridListItem } from "@react-aria-nutrient/gridlist";
...
```tsx example export=true render=false
import { useGridListSelectionCheckbox } from "@react-aria-nutrient/gridlist";
