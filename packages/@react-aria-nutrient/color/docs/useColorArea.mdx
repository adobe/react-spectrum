...
import docs from "docs:@react-aria-nutrient/color";
...
import packageData from "@react-aria-nutrient/color/package.json";
...
<TypeContext.Provider value={docs.links}>
  <InterfaceType
    properties={docs.links[docs.exports.useColorArea.return.id].properties}
  />
      ...
      >
        ...
        >
          ...
          >
            ...
            <ColorSwatch
              color={endColor}
              aria-label={`end color swatch with alpha channel: ${endColor.toString(
                "hsba"
              )}`}
            />
          </div>
...
```tsx example export=true render=false
import { useColorSwatch } from "@react-aria-nutrient/color";
...
function Example() {
  let [color, setColor] = React.useState(parseColor("rgb(100, 149, 237)"));
  let [rChannel, gChannel, bChannel] = color.getColorChannels();
  return (
    <>
      <div style={{ display: "inline-flex", flexWrap: "wrap" }}>
        <div style={{ marginRight: "2rem", marginBottom: "2rem" }}>
          ...
          <ColorArea
            ...
            yChannel={bChannel}
          />
          <ColorSlider channel={rChannel} value={color} onChange={setColor} />
        </div>
        <div style={{ marginRight: "2rem", marginBottom: "2rem" }}>
          ...
          <ColorArea
            ...
            yChannel={rChannel}
          />
          <ColorSlider channel={gChannel} value={color} onChange={setColor} />
        </div>
        <div style={{ marginRight: "2rem", marginBottom: "2rem" }}>
          ...
          <ColorArea
            ...
            yChannel={gChannel}
          />
          <ColorSlider channel={bChannel} value={color} onChange={setColor} />
        </div>
      </div>
      <p>
...
function Example() {
  let [color, setColor] = React.useState(parseColor("hsl(219, 79%, 66%)"));
      ...
      <div style={{ display: "inline-flex", flexWrap: "wrap" }}>
        ...
        <div style={{ marginRight: "2rem", marginBottom: "2rem" }}>
          ...
          <ColorArea
            ...
            yChannel={lChannel}
          />
          <ColorSlider channel={sChannel} value={color} onChange={setColor} />
        </div>
        <div style={{ marginRight: "2rem", marginBottom: "2rem" }}>
          ...
          <ColorArea
            ...
            yChannel={sChannel}
          />
          <ColorSlider channel={lChannel} value={color} onChange={setColor} />
        </div>
      </div>
      <p>
...
function Example() {
  let [color, setColor] = React.useState(parseColor("hsb(219, 58%, 93%)"));
