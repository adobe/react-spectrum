...
import docs from "docs:@react-aria-nutrient/numberfield";
...
import packageData from "@react-aria-nutrient/numberfield/package.json";
...
<TypeContext.Provider value={docs.links}>
  <InterfaceType
    properties={docs.links[docs.exports.useNumberField.return.id].properties}
  />
...
function Example() {
  ...
  return (
    <>
      <NumberField label="Controlled value" value={value} onChange={setValue} />
