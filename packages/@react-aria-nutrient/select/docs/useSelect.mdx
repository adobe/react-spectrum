...
import docs from "docs:@react-aria-nutrient/select";
...
import packageData from "@react-aria-nutrient/select/package.json";
...
<TypeContext.Provider value={docs.links}>
  <InterfaceType
    properties={
      docs.links[
        docs.exports.useSelect.return.base?.id ??
          docs.exports.useSelect.return.id
      ].properties
    }
  />
