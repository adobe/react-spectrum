...
import docs from "docs:@react-aria-nutrient/tooltip";
...
import packageData from "@react-aria-nutrient/tooltip/package.json";
...
<TypeContext.Provider value={docs.links}>
  <InterfaceType
    properties={docs.links[docs.exports.useTooltipTrigger.return.id].properties}
  />
...
<TypeContext.Provider value={docs.links}>
  <InterfaceType
    properties={docs.links[docs.exports.useTooltip.return.id].properties}
  />
</TypeContext.Provider>
...
import {useTooltip, useTooltipTrigger} from '@react-aria-nutrient/tooltip';
...
```tsx example
<TooltipButton tooltip="Save" delay={0}>
  💾
</TooltipButton>
```
...
```tsx example
<TooltipButton tooltip="Print" isDisabled>
  🖨
</TooltipButton>
```
