...
import docs from "docs:@react-aria-nutrient/progress";
import {
  HeaderInfo,
  FunctionAPI,
  TypeContext,
...
import packageData from "@react-aria-nutrient/progress/package.json";
...
<TypeContext.Provider value={docs.links}>
  <InterfaceType
    properties={docs.links[docs.exports.useProgressBar.return.id].properties}
  />
