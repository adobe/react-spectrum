...
import docs from "docs:@react-aria-nutrient/meter";
import {
  HeaderInfo,
  FunctionAPI,
  TypeContext,
...
import packageData from "@react-aria-nutrient/meter/package.json";
...
<TypeContext.Provider value={docs.links}>
  <InterfaceType
    properties={docs.links[docs.exports.useMeter.return.id].properties}
  />
...
```tsx example
<Meter label="Space used" valueLabel="54 of 60GB" value={90} />
```
