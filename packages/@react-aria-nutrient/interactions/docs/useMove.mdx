...
<HeaderInfo packageData={packageData} componentNames={["useMove"]} />
...
<TypeContext.Provider value={docs.links}>
  <InterfaceType
    properties={docs.links[docs.exports.useMove.return.id].properties}
  />
...
```tsx example
import { useMove } from "@react-aria-nutrient/interactions";
