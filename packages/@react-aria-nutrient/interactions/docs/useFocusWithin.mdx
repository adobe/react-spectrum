...
<HeaderInfo packageData={packageData} componentNames={["useFocusWithin"]} />
...
<TypeContext.Provider value={docs.links}>
  <InterfaceType
    properties={docs.links[docs.exports.useFocusWithin.return.id].properties}
  />
...
<TypeContext.Provider value={docs.links}>
  <InterfaceType
    properties={Object.fromEntries(
      Object.entries(
        docs.links[docs.exports.useFocusWithin.parameters[0].value.id]
          .properties
      ).filter(([, prop]) => prop.value.type === "function")
    )}
  />
</TypeContext.Provider>
