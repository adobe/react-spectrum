...
import docs from "docs:@react-aria-nutrient/textfield";
import {
  HeaderInfo,
  FunctionAPI,
  TypeContext,
...
import packageData from "@react-aria-nutrient/textfield/package.json";
...
<TypeContext.Provider value={docs.links}>
  <InterfaceType
    properties={
      docs.links[
        docs.exports.useTextField.return.base?.id ??
          docs.exports.useTextField.return.id
      ].properties
    }
  />
...
import type { AriaTextFieldProps } from "@react-aria-nutrient/textfield";
...
```tsx example
<TextField label="Email" defaultValue="me@email.com" />
```
