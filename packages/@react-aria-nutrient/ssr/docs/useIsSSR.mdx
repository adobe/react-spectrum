...
import docs from "docs:@react-aria-nutrient/ssr";
import { HeaderInfo, FunctionAPI, PageDescription } from "@react-spectrum/docs";
import packageData from "@react-aria-nutrient/ssr/package.json";
...
<HeaderInfo packageData={packageData} componentNames={["useIsSSR"]} />
