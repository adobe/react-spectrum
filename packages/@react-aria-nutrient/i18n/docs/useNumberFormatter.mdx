...
keywords: [number, i18n, aria, localization]
...
<HeaderInfo packageData={packageData} componentNames={["useNumberFormatter"]} />
...
```tsx example
import { I18nProvider, useNumberFormatter } from "@react-aria-nutrient/i18n";
