...
import docs from "docs:@react-aria-nutrient/i18n";
import {
  ClassAPI,
  HeaderInfo,
  TypeContext,
...
import packageData from "@react-aria-nutrient/i18n/package.json";

---

category: Internationalization
keywords: [date, time, i18n, aria, localization]

---

# useDateFormatter

<PageDescription>{docs.exports.useDateFormatter.description}</PageDescription>

<HeaderInfo packageData={packageData} componentNames={["useDateFormatter"]} />
...
```tsx example
import { I18nProvider, useDateFormatter } from "@react-aria-nutrient/i18n";
