...
import docs from "docs:@react-aria-nutrient/checkbox";
...
import packageData from "@react-aria-nutrient/checkbox/package.json";
...
<TypeContext.Provider value={docs.links}>
  <InterfaceType
    properties={docs.links[docs.exports.useCheckbox.return.id].properties}
  />
...
hook from `@react-aria-nutrient/focus`. When `isFocusVisible` is true, an extra SVG element is
