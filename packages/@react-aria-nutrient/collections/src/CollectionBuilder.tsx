...
): (props: P & React.RefAttributes<T>) => ReactNode;
export function createLeafComponent<
  T extends object,
  P extends object,
  E extends Element
...
>(
  ...
  let Result = (forwardRef as forwardRefType)(
    (props: P, ref: ForwardedRef<E>) => {
      ...
      return (
        useSSRCollectionNode(type, props, ref, null, children, (node) => (
          <Component node={node} />
        )) ?? <></>
      );
    }
...
const CollectionContext = createContext<CachedChildrenOptions<unknown> | null>(
  null
);
