...
import docs from "docs:@react-aria-nutrient/visually-hidden";
import {
  HeaderInfo,
  PropTable,
  FunctionAPI,
...
import packageData from "@react-aria-nutrient/visually-hidden/package.json";
...
<HeaderInfo packageData={packageData} componentNames={["VisuallyHidden"]} />
