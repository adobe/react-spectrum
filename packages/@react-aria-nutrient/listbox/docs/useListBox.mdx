...
import docs from "docs:@react-aria-nutrient/listbox";
...
import packageData from "@react-aria-nutrient/listbox/package.json";
...
<TypeContext.Provider value={docs.links}>
  <InterfaceType
    properties={docs.links[docs.exports.useListBox.return.id].properties}
  />
...
<TypeContext.Provider value={docs.links}>
  <InterfaceType
    properties={docs.links[docs.exports.useOption.return.id].properties}
  />
</TypeContext.Provider>
...
<TypeContext.Provider value={docs.links}>
  <InterfaceType
    properties={docs.links[docs.exports.useListBoxSection.return.id].properties}
  />
</TypeContext.Provider>
...
import type { AriaListBoxProps } from "@react-aria-nutrient/listbox";
