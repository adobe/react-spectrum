...
<HeaderInfo packageData={packageData} componentNames={["useDateRangePicker"]} />
...
<TypeContext.Provider value={docs.links}>
  <InterfaceType
    properties={
      docs.links[docs.exports.useDateRangePicker.return.id].properties
    }
  />
...
<TypeLink links={docs.links} type={docs.exports.useDateRangePicker} /> uses the [@internationalized/date](../internationalized/date/)
...
```tsx example export=true render=false
import type { AriaDialogProps } from "@react-aria-nutrient/dialog";
