...
<HeaderInfo packageData={packageData} componentNames={["useDatePicker"]} />
...
<TypeContext.Provider value={docs.links}>
  <InterfaceType
    properties={docs.links[docs.exports.useDatePicker.return.id].properties}
  />
...
<TypeLink links={docs.links} type={docs.exports.useDatePicker} /> uses the [@internationalized/date](../internationalized/date/)
