...
import {useLocale, useLocalizedStringDictionary} from '@react-aria-nutrient/i18n';
...
export function useDisplayNames(): DisplayNames {
  ...
  let dictionary = useLocalizedStringDictionary(intlMessages, '@react-aria-nutrient/datepicker');
  return useMemo(() => {
