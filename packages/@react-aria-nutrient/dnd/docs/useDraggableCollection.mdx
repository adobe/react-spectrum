...
<PageDescription>
  {docs.exports.useDraggableCollection.description}
</PageDescription>
...
<FunctionAPI
  function={statelyDocs.exports.useDraggableCollectionState}
  links={statelyDocs.links}
/>
<FunctionAPI
  function={docs.exports.useDraggableCollection}
  links={docs.links}
/>
...
import type { TextDropItem } from "@react-aria-nutrient/dnd";
import { useDrop } from "@react-aria-nutrient/dnd";
...
```tsx example
///- begin highlight -///
import {DragPreview} from '@react-aria-nutrient/dnd';
///- end highlight -///
...
<TypeContext.Provider value={sharedDocs.links}>
  <InterfaceType
    properties={sharedDocs.exports.DraggableCollectionProps.properties}
  />
