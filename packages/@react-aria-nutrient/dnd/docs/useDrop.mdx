...
<HeaderInfo packageData={packageData} componentNames={["useDrop"]} />
...
```tsx example
import type { FileDropItem } from "@react-aria-nutrient/dnd";
...
```tsx example
import type { DirectoryDropItem } from "@react-aria-nutrient/dnd";
...
<TypeContext.Provider value={docs.links}>
  <InterfaceType
    properties={Object.fromEntries(
      Object.entries(
        docs.links[docs.exports.useDrop.parameters[0].value.id].properties
