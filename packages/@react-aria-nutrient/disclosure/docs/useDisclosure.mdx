...
import docs from "docs:@react-aria-nutrient/disclosure";
...
import packageData from "@react-aria-nutrient/disclosure/package.json";
...
<TypeContext.Provider value={docs.links}>
  <InterfaceType
    properties={docs.links[docs.exports.useDisclosure.return.id].properties}
  />
