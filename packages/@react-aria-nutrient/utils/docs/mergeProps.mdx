...
import docs from "docs:@react-aria-nutrient/utils";
import {
  HeaderInfo,
  FunctionAPI,
  TypeContext,
...
import packageData from "@react-aria-nutrient/utils/package.json";
...
<HeaderInfo packageData={packageData} componentNames={["mergeProps"]} />
