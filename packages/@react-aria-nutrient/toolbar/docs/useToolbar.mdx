...
import docs from "docs:@react-aria-nutrient/toolbar";
...
import packageData from "@react-aria-nutrient/toolbar/package.json";
...
<TypeContext.Provider value={docs.links}>
  <InterfaceType
    properties={docs.links[docs.exports.useToolbar.return.id].properties}
  />
