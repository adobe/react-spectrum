...
import docs from "docs:@react-aria-nutrient/menu";
import overlaysDocs from "docs:@react-aria-nutrient/overlays";
import focusDocs from "docs:@react-aria-nutrient/focus";
import menuDocs from "docs:@react-aria-nutrient/menu";
import buttonDocs from "docs:@react-aria-nutrient/button";
...
import packageData from "@react-aria-nutrient/menu/package.json";
...
<TypeContext.Provider value={docs.links}>
  <InterfaceType
    properties={
      docs.links[docs.exports.useMenuTrigger.return.base.id].properties
    }
  />
...
<TypeContext.Provider value={docs.links}>
  <InterfaceType
    properties={docs.links[docs.exports.useMenu.return.id].properties}
  />
</TypeContext.Provider>
...
<TypeContext.Provider value={docs.links}>
  <InterfaceType
    properties={docs.links[docs.exports.useMenuItem.return.id].properties}
  />
</TypeContext.Provider>
...
<TypeContext.Provider value={docs.links}>
  <InterfaceType
    properties={docs.links[docs.exports.useMenuSection.return.id].properties}
  />
</TypeContext.Provider>
...
```tsx example export=true render=false
import type { AriaMenuProps } from "@react-aria-nutrient/menu";
...
function Example() {
  ...
  return (
    <>
      ...
      <MenuButton label="View" isOpen={open} onOpenChange={setOpen}>
