...
import docs from "docs:@react-aria-nutrient/slider";
import {
  HeaderInfo,
  FunctionAPI,
  TypeContext,
...
import packageData from "@react-aria-nutrient/slider/package.json";
...
<TypeContext.Provider value={docs.links}>
  <InterfaceType
    properties={docs.links[docs.exports.useSlider.return.id].properties}
  />
...
<TypeContext.Provider value={docs.links}>
  <InterfaceType
    properties={docs.links[docs.exports.useSliderThumb.return.id].properties}
  />
</TypeContext.Provider>
...
```tsx example
<Slider orientation="vertical" aria-label="Opacity" maxValue={1} step={0.01} />
```
...
function Example() {
  ...
  return (
    <>
      <Slider label="Cookies to buy" value={value} onChange={setValue} />
...
function Example() {
  ...
  return (
    <>
      <RangeSlider label="Range" value={value} onChange={setValue} />
