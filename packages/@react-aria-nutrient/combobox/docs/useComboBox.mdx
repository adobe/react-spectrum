...
import docs from "docs:@react-aria-nutrient/combobox";
...
import listboxDocs from "docs:@react-aria-nutrient/listbox";
import overlaysDocs from "docs:@react-aria-nutrient/overlays";
import packageData from "@react-aria-nutrient/combobox/package.json";
...
<TypeContext.Provider value={docs.links}>
  <InterfaceType
    properties={
      docs.links[
        docs.exports.useComboBox.return.base?.id ??
          docs.exports.useComboBox.return.id
      ].properties
    }
  />
