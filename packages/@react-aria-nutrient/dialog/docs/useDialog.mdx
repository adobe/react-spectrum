...
import docs from "docs:@react-aria-nutrient/dialog";
...
import packageData from "@react-aria-nutrient/dialog/package.json";
...
<TypeContext.Provider value={docs.links}>
  <InterfaceType
    properties={docs.links[docs.exports.useDialog.return.id].properties}
  />
