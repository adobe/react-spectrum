...
import docs from "docs:@react-aria-nutrient/searchfield";
...
import packageData from "@react-aria-nutrient/searchfield/package.json";
...
<TypeContext.Provider value={docs.links}>
  <InterfaceType
    properties={docs.links[docs.exports.useSearchField.return.id].properties}
  />
...
```tsx example
<SearchField label="Search" defaultValue="Puppies" />
```
