...
import docs from "docs:@react-aria-nutrient/landmark";
import { HeaderInfo, FunctionAPI, PageDescription } from "@react-spectrum/docs";
import { Keyboard } from "@react-spectrum/text";
import packageData from "@react-aria-nutrient/landmark/package.json";
...
- <Keyboard>F6</Keyboard> and <Keyboard>Shift+F6</Keyboard> key navigation between
  landmarks
...
<Keyboard>Alt+F6</Keyboard> will always move focus to the main landmark if it has
been registered.
