...
| `fillStyle` | `"fill" | "outline" | undefined` | 'fill' | The background style of the Button. |
...
| `size` | `"M" | "L" | "S" | "XL" | undefined` | 'M' | The size of the Button. |
...
| `variant` | `"primary" | "secondary" | "accent" | "negative" | "premium" | "genai" | undefined` | 'primary' | The [visual style](https://spectrum.adobe.com/page/button/#Options) of the button. |
