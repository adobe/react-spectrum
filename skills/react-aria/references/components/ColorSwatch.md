...
| `className` | `ClassNameOrFunction<ColorSwatchRenderProps> | undefined` | 'react-aria-ColorSwatch' | The CSS [className](https://developer.mozilla.org/en-US/docs/Web/API/Element/className) for the element. A function may be provided to compute the class based on component state. |
