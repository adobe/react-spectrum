    ...
    <Provider theme={defaultTheme} colorScheme={colorScheme}>
      ...
      <section className="max-w-xl m-auto">
        <section className="mb-300">
          <h2 className="text-2xl font-semibold text-center underline underline-offset-2">Intro</h2>
          ...
          <div className="mb-200">
            ...
            features <Link href="https://spectrum.adobe.com/">Spectrum</Link> styles and values. The
        ...
        <section className="mb-300">
          <h2 className="text-2xl font-semibold text-center underline underline-offset-2">Setup</h2>
          <ol>
            <li>
            ...
            <li>
              ...
              <div className="mb-200">
                ...
                <Link href="https://tailwindcss.com/docs/installation">Tailwind Docs</Link> based on
                your build setup.{' '}
              </div>
            </li>
            <li>
...
`}</pre>
        ...
        <section className="mb-600">
          <h2 className="text-2xl font-semibold text-center underline underline-offset-2">Usage</h2>
          <div>
            <h3 className="text-xl font-semibold">🎨 Add styles</h3>
            <div className="mb-200">You can now use Tailwind classes to style your components.</div>
            <div className="mb-100">Here are some examples:</div>
            <ul className="list-disc mb-200">
              <li>
                Using <code className="p-40 bg-gray-200 rounded">ring</code> will give you a focus
                ring with good default Spectrum styles for it's color, width, and offset.
              </li>
              <li>
                Using <code className="p-40 bg-gray-200 rounded">bg-blue-600</code> will give you a
                background that matches --spectrum-global-color-blue-600.
              </li>
              <li>
                Using <code className="p-40 bg-gray-200 rounded">w-25</code> will give you a width
                of var(--spectrum-global-dimension-size-25).
              </li>
              <li>
                Using <code className="p-40 bg-gray-200 rounded">ease-in duration-100</code> will
                give you a transition that matches Spectrum's motion values.
              </li>
              <li>
                Using <code className="p-40 bg-gray-200 rounded">sm:text-left</code> will give you
                left text alignment for small width devices based on Spectrum's break points.
              </li>
              <li>
                Using <code className="p-40 bg-gray-200 rounded">dark:bg-black</code> will give you
