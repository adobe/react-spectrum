...
CoachMarkPopover components within a Tour are implemented by default using the Dialog design pattern, per [WAI-ARIA 1.1](https://www.w3.org/TR/wai-aria-practices-1.1/#dialog_modal).
