...
function ProviderUpdater(props) {
  let [localeValue, setLocale] = useState(providerValuesFromUrl.locale || 'en-US');
  let [themeValue, setTheme] = useState(providerValuesFromUrl.theme || 'dark');
  let [scaleValue, setScale] = useState(providerValuesFromUrl.scale || 'medium');
