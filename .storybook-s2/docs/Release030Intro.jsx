...
export function Release030Intro() {
  return (
    <>
      <P>
        With this end of summer release we've been busy adding a number of new components such as NumberField, Tabs, AlertDialog, TagGroup, and AvatarGroup.
      ...
      <Pre>{highlight(`import {...} from '@react-spectrum/alertdialog';`)}</Pre>
