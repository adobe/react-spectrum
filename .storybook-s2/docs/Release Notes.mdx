...
S2:
* Icon builder to library - [@snowystinger](https://github.com/snowystinger) - [PR](https://github.com/adobe/react-spectrum/pull/8203)
...
* update bar bellow the tab when text changes - [@andreipavel102222](https://github.com/andreipavel102222) - [PR](https://github.com/adobe/react-spectrum/pull/8311)
...
* fix: Fix S2 button/taggroup coloring so they apply on keyboard focus only - [@LFDanLu](https://github.com/LFDanLu) - [PR](https://github.com/adobe/react-spectrum/pull/8342)
