    ...
    <div className={style({maxWidth: 'lg', marginX: 'auto', fontFamily: 'sans'})}>
      <div className={style({marginX: 48})}>
        ...
        <details>
          ...
          <h2 className={style({marginTop: 8})}>Spectrum 2 Migration Guide</h2>

          <P>Use the following guide to manually upgrade React Spectrum components to use Spectrum 2.</P>
          ...
          <ul className="sb-unstyled">
            ...
            <li className={style({lineHeight: 'body', color: 'body', marginY: 8})}>Update <Link href="https://react-spectrum.adobe.com/react-spectrum/styling.html#style-props">style props</Link> to use style macro instead. See the 'Style props' section below</li>
          </ul>
