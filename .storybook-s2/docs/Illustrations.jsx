...
export function Illustrations() {
  ...
  return (
    <div className={'sb-unstyled ' + style({marginX: 'auto'})}>
      <div className={style({marginX: 48})}>
        <h1 className={style({font: 'heading-2xl', marginBottom: 48})}>Illustrations</h1>
        <P>
          Spectrum 2 offers a collection of illustrations in two styles: gradient and linear. These
          illustrations can be imported from <Code>@react-spectrum/s2/illustrations</Code>. See
          below for a full list of available illustrations. Click the clipboard icon to copy the
          import statement.
        </P>
        <H2>Gradient illustrations</H2>
        <P>
          Gradient illustrations are available in two styles: Generic 1 and Generic 2. These should
          be consistently applied within products. They can be imported using the corresponding
                  ...
                  <ActionButton
                    ...
                    onPress={() =>
                      navigator.clipboard.writeText(
                        `import ${icon} from '@react-spectrum/s2/illustrations/gradient/${gradientStyle}/${icon}';`
                      )
                    }>
                    <Paste />
                  </ActionButton>
              ...
              <div
                ...
                <span
                  ...
                  <ActionButton
                    ...
                    onPress={() =>
                      navigator.clipboard.writeText(
                        `import ${icon} from '@react-spectrum/s2/illustrations/linear/${icon}';`
                      )
                    }>
                    <Paste />
                  </ActionButton>
        ...
        <P>
          To use custom illustrations, you first need to convert your SVGs into compatible
          illustration components. This depends on your bundler.
        </P>
        <H3>Parcel</H3>
        <P>
          If you are using Parcel, the <Code>@react-spectrum/parcel-transformer-s2-icon</Code>{' '}
          plugin can be used to convert SVGs to illustration components. First install it into your
  ...
  "transformers": {
    "illustration:*.svg": ["@react-spectrum/parcel-transformer-s2-icon"]
        ...
        <P>
          Now you can import illustration SVGs using the <Code>illustration:</Code>{' '}
          <Link href="https://parceljs.org/features/plugins/#named-pipelines">pipeline</Link>:
        </P>
        <Pre>
        ...
        <P>
          The <Code>@react-spectrum/s2-icon-builder</Code> CLI tool can be used to pre-process a
          folder of SVG illustrations into TSX files.
        </P>
        <Pre>
        ...
        <P>
          This outputs a folder of TSX files with names corresponding to the input SVG files. You
          may rename them as you wish. To use them in your application, import them like normal
          components.
        </P>
