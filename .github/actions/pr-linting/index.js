...
async function run() {
  ...
  if ((/^\[?\(?wip\]?\)?/i).test(title)) {
    ...
    core.info('PR title validation failed. Please read our PR naming guide on our github wiki to see how to correctly name your PR: https://github.com/adobe/react-spectrum/wiki/Pull-Request-Naming-Guide');
    core.setFailed();
  }
}