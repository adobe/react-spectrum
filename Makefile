...
build:
	lerna exec --parallel --ignore "@adobe/*" --no-private 'BUILD_ENV=production NODE_ENV=production babel --root-mode upward src --out-dir dist --extensions .ts,.tsx,.js,.css --no-comments'
