...
for (let line of yarn1Lines) {
  if (line.startsWith('# THIS IS AN AUTOGENERATED FILE. DO NOT EDIT THIS FILE DIRECTLY.') || line.startsWith('# yarn lockfile v1') || line.length <= 2) {
    i++
    continue;
  }
  if (/^(?![\s-])/.test(line)) {
...
console.log(chalk.cyan('removed dependencies'), Object.entries(yarn4Entries).length - Object.entries(yarn1Entries).length);
