...
then
  ...
  # TODO run compareSize once we have a last commit to check
  # move the file generated by compareSize to verdaccio_path as well and update comment.js to comment it
