...
import docs from 'docs:@react-aria/COMPONENT_NAME';
import {HeaderInfo, FunctionAPI, TypeContext, InterfaceType} from '@react-spectrum/docs';
import packageData from '@react-aria/COMPONENT_NAME/package.json';

```jsx import
import {useComponent} from '@react-aria/COMPONENT_NAME';
```
...
<p>{docs.exports.useComponent.description}</p>

<HeaderInfo
  packageData={packageData}
  componentNames={['useComponent']}
  sourceData={[
...
<FunctionAPI function={docs.exports.useComponent} links={docs.links} />
...
<TypeContext.Provider value={docs.links}>
  <InterfaceType properties={docs.links[docs.exports.useComponent.return.id].properties} />
